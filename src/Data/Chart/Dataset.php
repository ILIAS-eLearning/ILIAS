...
class Dataset
{
    ...
    /**
     * @param string $messeaurement_item_label Using the identical label multiple times will overwrite the values
     ...
     * @return $this
     */
    public function withAlternativeInformation(string $messeaurement_item_label, array $values) : self
    {
        $this->checkDimensionCongruenceForValues($values);
        ...
        $clone = clone $this;
        $clone->alternative_information[$messeaurement_item_label] = $values;
    ...
    public function getAlternativeInformationPerDimension() : array
    {
        ...
        foreach ($this->getAlternativeInformation() as $messeaurement_item_label => $alternative_information_for_dimensions) {
            foreach ($alternative_information_for_dimensions as $dimension_name => $alternative_info) {
                $alternative_information_restructured[$dimension_name][$messeaurement_item_label] = $alternative_info;
            }
        }
