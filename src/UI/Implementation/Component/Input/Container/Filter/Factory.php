...
class Factory implements F\Factory {
	 ...
	 * @param Field\Factory $field_factory
	 * @param Container\Factory $container_factory
	 */
	...
	public function standard($toggle_action_on, $toggle_action_off, $expand_action, $collapse_action, $apply_action, $reset_action, array $inputs, array $is_input_rendered, $is_activated = false, $is_expanded = false) {
		return new Standard($this->signal_generator, $this->field_factory, $this->container_factory, $toggle_action_on, $toggle_action_off, $expand_action, $collapse_action, $apply_action, $reset_action, $inputs, $is_input_rendered, $is_activated, $is_expanded);
	}
}