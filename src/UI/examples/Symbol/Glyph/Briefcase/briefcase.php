 ...
 * ---
 * description: >
 *   Example for rendring a briefcase glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome briefcase symbol on a grey background. Moving the cursor above the symbol will darken it's
