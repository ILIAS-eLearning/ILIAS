...
namespace ILIAS\UI\examples\Symbol\Glyph\Tag;

/**
 * ---
 * description: >
 *   Example for rendring a tag glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome tag symbol on a grey background. Moving the cursor above the symbol will darken it's
