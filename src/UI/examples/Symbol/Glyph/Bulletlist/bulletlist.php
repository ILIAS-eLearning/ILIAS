 ...
 * ---
 * description: >
 *   Example for rendring a bulletlist glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome bulletlist symbol on a grey background. Moving the cursor above the symbol will darken it's
