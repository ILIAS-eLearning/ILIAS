...
function base()
{
    ...
    $dataset = $dataset->withPoints("Item 1", ["Dataset" => 80]);
    $dataset = $dataset->withPoints("Item 2", ["Dataset" => 0]);
    $dataset = $dataset->withPoints("Item 3", ["Dataset" => 18]);
    $dataset = $dataset->withPoints("Item 4", ["Dataset" => 55]);
