...
interface Factory
{
     ...
     *       description, main action button, action drop down, audio player element,
     *       properties (name/value), a text, image, icon or avatar lead,
     *       a progress meter chart and a color.
