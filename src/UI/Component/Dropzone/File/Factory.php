...
interface Factory {
	 ...
	 *      the browser window. composition: > Standard dropzones are areas to
	 *      drop files. effect: > All dropzones on the page are highlighted
	 *      when the user is dragging files from outside the browser window
	 *      into one dropzone. rivals: Rival 1: A wrapper dropzone can hold
	 ...
	 *     4: Standard dropzones with the darkened background highlighting MUST
	 *     NOT be used in modals.
	 *     5: Other ILIAS UI components are REQUIRED to handle dropped files
	 ...
	 *      dragged from outside the browser window. composition: > The wrapper
	 *      dropzone uses the darkened background highlighting by default and
	 *      is not visible before the user is dragging files from outside the
	 *      browser window into the browser window. effect: > All dropzones on
	 *      the page are highlighted when the user is dragging files from
	 *      outside the browser window into the browser window. If a page
	 *      contains two or more wrapper dropzones, the setting for the
	 *      darkened background of the last rendered dropzone will be applied
	 *      to all wrapper dropzones. rivals: Rival 1: A standard dropzone can display a message instead of other ILIAS UI components.
	 *
	 * rules:
	 *   usage:
	 ...
	 *     5: Wrapper dropzones with the darkened background highlighting MUST
	 *     NOT be used in modals.
	 *     6: Other ILIAS UI components are REQUIRED to handle dropped files
	 *     further. style:
	 *     1: The height and the width MUST be determined by the components
	 *     inside.
	 *
	 * ---
	 *
