...
interface Factory {
	 ...
	 * ---
	 * description:
	 *   purpose: File Dropzones are used to drop files from outside the browser window.
	 *   composition: >
	 *      File Dropzones are areas to drop files dragging from outside the browser window.
	 *   effect: >
