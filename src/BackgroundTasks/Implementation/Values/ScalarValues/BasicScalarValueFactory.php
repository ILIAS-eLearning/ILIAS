...
trait BasicScalarValueFactory {
	...
	protected function wrapValue($value) {
		...
		throw new InvalidArgumentException("The given parameter is not a Background Task Value and cannot be wrapped in a Background Task Value: " . var_export($value, true) );
	}
	...
	protected function wrapScalar($value) {
		...
		throw new InvalidArgumentException("The given value ".var_export($value, true)." is not a scalar and cannot be wrapped.");
	}
