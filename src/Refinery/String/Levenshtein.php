...
{
    /**
     * Creates an object of the Levenshtein2 class
     ...
     * @param int $maximumDistance maximum allowed distance, limits the calculation of the Levenshtein2 distance. A maximum distance of 0 disables the function
