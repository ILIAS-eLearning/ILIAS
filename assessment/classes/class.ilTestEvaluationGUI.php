...
*/
	...
	*/
	function getStatisticalSettingsOutput()
	{
		...
		include_once "./classes/class.ilTemplate.php";
		$template = new ilTemplate("tpl.il_as_tst_evaluation_specification.html", TRUE, TRUE, TRUE);
...
//			$ilBench->save();
		...
		foreach ($selected_users as $key => $name)
		{
			...
			array_push($evalrow, array(
				"html" => "<a href=\"".$this->ctrl->getLinkTargetByClass("iltestoutputgui", "outStatisticsResultsOverview")."&active_id=$key\">$username</a>",
