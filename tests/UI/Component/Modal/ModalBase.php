...
//		$interruptive = $factory->interruptive('myTitle', $content)->withActionButton($button_factory->primary('Blub', ''));
...
//		$roundTrip = $factory->roundtrip('myTitle', $content)->withButtons(array(
...
//		$content = new \ILIAS\UI\Implementation\Component\Legacy\Legacy('MyContent');
//
//		$modal = $factory->interruptive('MyTitle', $content)->withActionButton($button_factory->primary('Action', ''));
//		$buttons = $modal->getButtons();
//		$cancel_button = array_pop($buttons);
//		$this->assertEquals('Cancel', $cancel_button->getLabel());
//
//		$modal = $factory->roundtrip('myTitle', $content)->withButtons(array(
//			$button_factory->primary('Button 1', ''),
//			$button_factory->standard('Button 2', ''),
