           ...
           <div class="col-sm-8 col-md-9 col-lg-10">
              <div class="il-input-duration" id="id_1">
                 <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-9 col-lg-10">
                       <div class="input-group date il-input-datetime" id="id_2"><input type="date" name="" placeholder="YYYY-MM-DD" class="form-control form-control-sm" /></div>
                    </div>
                 </div>
                 <div class="form-group row">
                    <label for="id_3" class="control-label col-sm-4 col-md-3 col-lg-2">' . $label_end . '</label>
                    <div class="col-sm-8 col-md-9 col-lg-10">
                       <div class="input-group date il-input-datetime" id="id_3"><input type="date" name="" placeholder="YYYY-MM-DD" class="form-control form-control-sm" /></div>
                    </div>
                 </div>
              </div>
