...
class FileInputTest extends ILIAS_UI_TestBase
{
    ...
    public function test_render()
    {
        ...
        $expected
            = "<div class=\"form-group row\">	<label for=\"name_0\" class=\"control-label col-sm-3\">label</label>	<div class=\"col-sm-9\">		<div class=\"il-input-file\" id=\"id_2\">	<div class=\"il-input-file-dropzone\">		<button class=\"btn btn-link\" data-action=\"#\" id=\"id_1\">select_files_from_computer</button>	</div>	<div class=\"il-input-file-filelist\">		<div class=\"il-input-file-template dz-preview dz-file-preview\" style=\"display: none\" data-file-id=\"\">			<div class=\"il-input-file-fileinfo dz-details\">				<div class=\"il-input-file-fileinfo-title\"><span data-dz-name ></span></div>				<div data-dz-size  class=\"il-input-file-fileinfo-size\"></div>				<div class=\"il-input-file-fileinfo-close\">						<button type=\"button\" class=\"close\" data-dz-remove>							<span aria-hidden=\"true\">&times;</span>							<span class=\"sr-only\">Close</span>						</button>				</div>			</div><!--			<div class=\"dz-progress\"><span class=\"dz-upload\" data-dz-uploadprogress></span></div>-->			<!--			<div class=\"dz-success-mark\"><span>✔</span></div>-->			<!--			<div class=\"dz-error-mark\"><span>✘</span></div>-->			<div class=\"dz-error-message\"><span data-dz-errormessage></span></div>		</div>	</div><input class=\"input-template\" type=\"hidden\" name=\"name_0[]\" value=\"\" data-file-id=\"\"></div>		<div class=\"help-block\">byline</div>			</div></div>";
