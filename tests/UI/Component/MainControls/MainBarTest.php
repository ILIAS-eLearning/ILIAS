				...
				<div class="il-mainbar">
					<div class="il-mainbar-triggers">
						<div class="il-mainbar-entries" style="visibility: hidden">
							<button class="btn btn-bulky" data-action="#" id="id_1" ><div class="icon custom small" ><img alt="" src="" /></div><span class="bulky-label">TestEntry</span></button>
							<button class="btn btn-bulky" data-action="#" id="id_2" ><div class="icon custom small" ><img alt="" src="" /></div><span class="bulky-label">TestEntry</span></button>
							<button class="btn btn-bulky" id="id_3" ><div class="icon custom small" ><img alt="" src="" /></div><span class="bulky-label">1</span></button>
				...
				<div class="il-mainbar-slates">
					...
					<div class="il-maincontrols-slate disengaged" id="id_8" data-depth-level="1">
						<div class="il-maincontrols-slate-content" data-replace-marker="content">
							<button class="btn btn-bulky" id="id_4" ><div class="icon custom small" ><img alt="" src="" /></div><span class="bulky-label">1.1</span></button>

							<div class="il-maincontrols-slate disengaged" id="id_7" data-depth-level="2">
								<div class="il-maincontrols-slate-content" data-replace-marker="content">
									<button class="btn btn-bulky" id="id_5" ><div class="icon custom small" ><img alt="" src="" /></div><span class="bulky-label">1.1.1</span></button>
