				...
				<nav class="il-mainbar" aria-label="mainbar_aria_label">
					<div class="il-mainbar-triggers">
						<div class="il-mainbar-entries" role="menubar" style="visibility: hidden">
							...
							<button class="btn btn-bulky" id="id_9" role="menuitem" aria-haspopup="true" ><span class="glyph" aria-label="more"><span class="glyphicon glyphicon-option-horizontal" aria-hidden="true"></span></span><span class="bulky-label">more</span></button>
						</div>
					</div>
				</nav>
