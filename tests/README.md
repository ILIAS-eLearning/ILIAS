...
<?php
	...
	{
		include_once 'components/ILIAS/Membership_/classes/class.ilMemberAgreement.php';
...
class ilRBACTest extends PHPUnit_Framework_TestCase {
		...
		public function testCache()
		{
			...
			include_once './components/ILIAS/AccessControl_/classes/class.ilAccessHandler.php';

			//ilAccessHandler is an interface located in './components/ILIAS/AccessControl_/interfaces/interface.ilAccessHandler.php'
