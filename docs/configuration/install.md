...
For best results we RECOMMEND:
  ...
  * Debian GNU Linux 10 / Red Hat Enterprise Linux 7 / Ubuntu 20.04 LTS
  * MySQL 5.6+
  * MariaDB 10.2
  * PHP 7.4
...
On Debian/Ubuntu 18.04 or 20.04 execute:
```
apt install libapache2-mod-php7.4 php7.4-gd php7.4-mysql php7.4-mbstring php7.4-curl php7.4-dom php7.4-zip php7.4-xml php7.4-soap composer
```
...
On Ubuntu execute:
```
apt install zip unzip imagemagick openjdk-8-jdk
```
