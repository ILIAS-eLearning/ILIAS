...
$tpl->setVariable("LTAB_LN_REF","usr_ingmedia_profile.php");
$tpl->setVariable("LTAB_LN_FRAME","bottom");
$tpl->parseCurrentBlock();

$tpl->setCurrentBlock("ltab_cell_one_frame");
$tpl->setVariable("LTAB_LN_TXT",$lng->txt("chg_password"));
$tpl->setVariable("LTAB_LN_REF","usr_ingmedia_password.php");
$tpl->setVariable("LTAB_LN_FRAME","bottom");
$tpl->parseCurrentBlock();
...
// define second table cells
$tpl->setCurrentBlock("ltab_cell_two_frames");
$tpl->setVariable("LTAB_LN_TXT",$lng->txt("ingmedia_back_to_le"));
$tpl->setVariable("LTAB_LN_REF1","usr_pdesktop_menu.php");
$tpl->setVariable("LTAB_LN_FRAME1","left");
$tpl->setVariable("LTAB_LN_REF2","usr_pdesktop.php?cmd=lvis_le");
