 ...
 */
class ilObjReportDBVListGUI extends ilObjReportBaseListGUI {
	...
	public function getProperties() {
		...
		$this->plugin->includeClass("class.ilObjReportDBVAccess.php");
		if (!ilObjReportDBVAccess::checkOnline($this->obj_id)) {
