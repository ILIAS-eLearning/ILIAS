...
class ilObjSurvey extends ilObject
{
    ...
    * @see $status
    */
    public function setStatus($status = self::STATUS_OFFLINE)
    {
        $result = "";
    ...
    */
    ...
    public function sendNotificationMail($user_id, $anonymize_id, $appr_id)
    {
        include_once "./Services/User/classes/class.ilObjUser.php";
    ...
    */
     ...
     */
    public function set360SkillService($a_val)
    {
     ...
     */
    public function get360SkillService()
    {
