...
class ilSurveyInviteGroupsTableGUI extends ilTable2GUI
{
	/**
	 * Constructor
	 *
	...
	public function __construct($a_parent_obj, $a_parent_cmd)
	{
		...
		$this->setRowTemplate("tpl.il_svy_svy_invite_groups_row.html", "Modules/Survey");

		$this->addMultiCommand('inviteUserGroup', $this->lng->txt('add'));
