...
class ilPortfolioHTMLExport
{
     ...
     * @param
     */
    public function __construct($a_portfolio_gui, $a_object)
    {
            ...
            if (ilPortfolioPage::_exists("prtf", $page["id"])) {
                ...
                if (!$has_index) {
                    if (is_file($this->export_dir . "/prtf_" . $page["id"] . ".html")) {	// #20144
                        copy(
                            $this->export_dir . "/prtf_" . $page["id"] . ".html",
    ...
    public function buildExportTemplate(array $a_js_files = null)
    {
        global $DIC;
    ...
    public function writeExportFile($a_file, $a_content, $a_onload = null, $a_js_files = null)
    {
     ...
     * Export page html
     */
    public function exportPageHTML($a_post_id)
    {
        // page
