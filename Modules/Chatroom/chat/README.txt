...
==== Sub-Directory ====
  ...
  Examples:
     ...
     Your configuration: http(s)://myilias.de/servers/chat
        Value: /servers/chat

     Your configuration: http(s)://myilias.de
        Value:  (empty string)
...
==== Logging ====
    ...
    Example: Chat Server Log = /srv/www/logs/ilias_chat.log
    Example: Chat Server ErrorLog = /srv/www/logs/ilias_error_chat.log
