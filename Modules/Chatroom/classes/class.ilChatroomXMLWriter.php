	...
	public function start()
	{
		...
		if(count($privateRooms) > 0)
		{
			...
			foreach($privateRooms as $privateRoom)
			{
				...
				$this->xmlElement('RoomId',  null, (int)$privateRoom['parent_id']);
		...
		if(count($history) > 0)
		{
			...
			foreach($history as $entry)
			{
				...
				$this->xmlElement('RoomId',  null, (int)$entry['room_id']);
				$this->xmlElement('SubRoomId',  null, (int)$entry['sub_room']);
				$this->xmlElement('Message',  null, json_encode($entry['message']));
