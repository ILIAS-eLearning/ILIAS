...
abstract class ilLPStatusCmiXapiAbstract extends ilLPStatus
{
	...
	public static function _getNotAttempted($a_obj_id)
	{
		return self::getUserIdsByLpStatusNum(
			$a_obj_id, ilLPStatus::LP_STATUS_NOT_ATTEMPTED_NUM
		);
	}
	...
	{
		return self::getUserIdsByLpStatusNum(
			$a_obj_id, ilLPStatus::LP_STATUS_IN_PROGRESS_NUM
		);
	}
	...
	{
		return self::getUserIdsByLpStatusNum(
			$a_obj_id, ilLPStatus::LP_STATUS_COMPLETED_NUM
		);
	}
	...
	{
		return self::getUserIdsByLpStatusNum(
			$a_obj_id, ilLPStatus::LP_STATUS_FAILED_NUM
		);
	}
