...
class ilCmiXapiUser
{
	...
	public function load()
	{
		...
		$res = $DIC->database()->queryF("SELECT * FROM cmix_users WHERE obj_id = %s AND usr_id = %s",
			array('integer', 'integer'), array($this->getObjId(), $this->getUsrId())
		);
	...
	public function save()
	{
		...
		$DIC->database()->replace('cmix_users',
			array(
	...
	public static function getInstanceByObjectIdAndUsrIdent($objId, $usrIdent)
	{
		...
		$res = $DIC->database()->queryF("SELECT * FROM cmix_users WHERE obj_id = %s AND usr_ident = %s",
			array('integer', 'integer'), array($objId, $usrIdent)
		);
	...
	public static function saveProxySuccess($objId, $usrId)
	{
		...
		$DIC->database()->update('cmix_users',
			array(
	...
	public static function getUsersForObject($objId) : array
	{
		...
		$res = $DIC->database()->queryF("SELECT * FROM cmix_users WHERE obj_id = %s",
			array('integer'), array($objId)
		);
	...
	public static function exists($objId, $usrId)
	{
		...
		$res = $DIC->database()->queryF(
			$query, array('integer', 'integer'), array($objId, $usrId)
		);
