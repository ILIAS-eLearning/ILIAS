...
class ilCmiXapiAccess
{
	...
	public function hasWriteAccess()
	{
		...
		return (bool)$DIC->access()->checkAccess('write', '',
			$this->object->getRefId(), $this->object->getType(), $this->object->getId()
		);
	}
	...
	public function hasEditPermissionsAccess()
	{
		...
		$editPermsAccess = $DIC->access()->checkAccess('edit_permissions', '',
			$this->object->getRefId(), $this->object->getType(), $this->object->getId()
		);
	...
	public function hasOutcomesAccess()
	{
		...
		$outcomesAccess = $DIC->access()->checkAccess('read_outcomes', '',
			$this->object->getRefId(), $this->object->getType(), $this->object->getId()
		);
