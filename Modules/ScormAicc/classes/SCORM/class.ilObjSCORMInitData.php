...
//		$slm_obj =& new ilObjSCORMLearningModule($_GET["ref_id"]);
		...
		$s_out='{'
			...
			.'"img":{'
				.'"asset":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/asset.png')).'",'
				.'"browsed":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/browsed.png')).'",'
				.'"completed":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/completed.png')).'",'
				.'"failed":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/failed.png')).'",'
				.'"incomplete":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/incomplete.png')).'",'
				.'"not_attempted":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/not_attempted.png')).'",'
				.'"passed":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/passed.png')).'",'
				.'"running":"'.self::encodeURIComponent(ilUtil::getImagePath('scorm/running.png')).'"'
			.'},'
			.'"statusTxt":{'
