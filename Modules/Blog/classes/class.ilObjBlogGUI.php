...
class ilObjBlogGUI extends ilObject2GUI implements ilDesktopItemHandling
{
    ...
    */
     ...
     * @return string
     */
    public function renderNavigation(array $a_items, $a_list_cmd = "render", $a_posting_cmd = "preview", $a_link_template = null, $a_show_inactive = false)
    {
        $ilCtrl = $this->ctrl;
        $ilSetting = $this->settings;
