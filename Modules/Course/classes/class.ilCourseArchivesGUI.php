...
class ilCourseArchivesGUI
{
    ...
    public function confirmDeleteArchives()
    {
        global $ilAccess,$ilErr;
    ...
    */
    public function selectXMLArchiveItems()
    {
        global $tpl;
        
        include_once("./Services/Export/classes/class.ilSubItemSelectionTableGUI.php");
        $sel_table = new ilSubItemSelectionTableGUI(
            $this,
    ...
    public function selectArchiveLanguage()
    {
        global $ilAccess;
    ...
    public function addHTMLArchive()
    {
        global $ilAccess;
    ...
    public function downloadArchives()
    {
        global $ilAccess;
    ...
    public function __showArchivesMenu()
    {
        if (!$this->is_tutor) {
            return false;
        }
