...
class ilCourseArchives
{
    ...
    public $course_files_obj;
    public $course_xml_writer;
    ...
    public function getArchive($a_id)
    {
        return $this->archives[$a_id];
    }

    public function getPublicArchives()
    {
    ...
    public function setLanguage($a_lang_code)
    {
    ...
    public function getArchiveFile($a_id)
    {
    ...
    */
    public function addXML($a_selection = "")
    {
    ...
    public function initCourseFilesObject()
    {
    ...
    public function initCourseXMLWriter()
    {
    ...
    * @param	array		selection array: key is ref_id, value is "last_file", "omit" or "create"
    */
    public function __addZipFiles($a_parent_id, $a_selection = "")
    {
    ...
    public function __addHTMLFiles($a_parent_id)
    {
        $this->course_obj->initCourseItemObject();
        $this->course_obj->items_obj->setParentId($a_parent_id);
    ...
    public function __addCourseHTML()
    {
        global $tpl,$ilias;
        ...
        $this->course_files_obj->copyFile(
            $tpl->tplPath . '/' . $ilias->account->prefs["style"] . '.css',
    ...
    public function __buildStructure(&$tmp_tpl, $a_parent_id)
    {
        $this->course_obj->initCourseItemObject();
        $this->course_obj->items_obj->setParentId($a_parent_id);
