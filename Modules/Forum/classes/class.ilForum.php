	...
	*/
	...
	public function getAllThreads($a_topic_id, array $params = array(), $limit = 0, $offset = 0)
	{
		...
		if(!$ilUser->isAnonymous())
		{
			...
			$query .= " thr_pk, thr_top_fk, thr_subject, thr_usr_id, thr_usr_alias, thr_num_posts, thr_last_post, thr_date, thr_update, visits, frm_threads.import_name, is_sticky, is_closed
					  {$optional_fields}
					  FROM frm_threads
