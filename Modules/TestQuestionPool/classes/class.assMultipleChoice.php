...
class assMultipleChoice extends assQuestion
{
	...
	*/
	...
	{
		include_once "./Modules/TestQuestionPool/classes/import/qti12/class.importMultipleChoice.php";
		$import = new importMultipleChoice($this);
	...
	*/
	...
	{
		include_once "./Modules/TestQuestionPool/classes/export/qti12/class.exportMultipleChoice.php";
		$export = new exportMultipleChoice($this);
