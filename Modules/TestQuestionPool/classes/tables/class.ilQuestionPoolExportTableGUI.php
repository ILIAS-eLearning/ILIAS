...
class ilQuestionPoolExportTableGUI extends ilTable2GUI
{
	...
	public function __construct($a_parent_obj, $a_parent_cmd, $confirmdelete = false)
	{
		...
		else
		{
			...
			$this->addSelectionButton('exporttype',
				array(
					'xml' => $this->lng->txt('qpl_export_xml'),
					'xls' => $this->lng->txt('qpl_export_excel')
				), 'createExportFile', $this->lng->txt('create')
			);
		}

		$this->setRowTemplate("tpl.il_as_qpl_export_row.html", "Modules/TestQuestionPool");
