...
class ilQuestionPoolSkillAdministrationGUI
{
	...
	public function __construct(ILIAS $ilias, ilCtrl $ctrl, ilAccessHandler $access, ilTabsGUI $tabs, ilGlobalTemplate $tpl, ilLanguage $lng, ilDBInterface $db, ilPluginAdmin $pluginAdmin, ilObjQuestionPool $poolOBJ, $refId)
	{
		$this->ilias = $ilias;
		$this->ctrl = $ctrl;
		$this->access = $access;
