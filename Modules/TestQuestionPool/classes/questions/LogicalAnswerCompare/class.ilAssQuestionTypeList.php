...
class ilAssQuestionTypeList implements Iterator
{
	...
	public function current() { return current($this->types); }
	/** @return ilAssQuestionType */
	public function next() { return next($this->types); }
	/** @return string */
	public function key() { return key($this->types); }
	/** @return bool */
	public function valid() { return key($this->types) !== null; }
	/** @return ilAssQuestionType */
	public function rewind() { return reset($this->types); }
