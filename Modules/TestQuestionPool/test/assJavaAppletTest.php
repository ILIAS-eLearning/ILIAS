...
*/
class assJavaAppletTest extends assBaseTestCase
{
    ...
    {
        // Arrange
        require_once './Modules/TestQuestionPool/classes/class.assJavaApplet.php';

        // Act
        $instance = new assJavaApplet();

        $this->assertInstanceOf('assJavaApplet', $instance);
    }
}
