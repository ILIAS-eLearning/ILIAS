 ...
 */
class ilTestRandomQuestionSelectionTableGUITest extends ilTestBaseTestCase
{
    private ilTestRandomQuestionSelectionTableGUI $tableGui;
    ...
    protected function setUp() : void
    {
        ...
        $this->tableGui = new ilTestRandomQuestionSelectionTableGUI(
            $this->parentObj_mock,
            "",
