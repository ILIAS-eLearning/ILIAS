	...
	function exchangeCertificateVariables($certificate_text, $user_data = array())
	{
		if (count($user_data) == 0)
		{
			...
			$user_data = array(
				...
				"[USER_TITLE]" => $this->lng->txt("certificate_var_user_title"),
				"[USER_INSTITUTION]" => $this->lng->txt("certificate_var_user_institution"),
				"[USER_DEPARTMENT]" => $this->lng->txt("certificate_var_user_department"),
				"[USER_STREET]" => $this->lng->txt("certificate_var_user_street"),
				"[USER_CITY]" => $this->lng->txt("certificate_var_user_city"),
				"[USER_ZIPCODE]" => $this->lng->txt("certificate_var_user_zipcode"),
				"[USER_COUNTRY]" => $this->lng->txt("certificate_var_user_country"),
