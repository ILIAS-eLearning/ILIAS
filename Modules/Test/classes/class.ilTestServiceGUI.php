...
class ilTestServiceGUI
{
    ...
    protected function getUserProcessingTimeMinutesAndSeconds(int $processing_time): array
    {
    ...
    protected function getUserProcessingTimeString(int $starting_time, int $processing_time): string
    {
        ...
        return sprintf(
            ...
            ilDatePresentation::formatDate(new ilDateTime(getdate($starting_time), IL_CAL_FKT_GETDATE)),
            $str_processing_time
        );
    }

    protected function getUserRemainingTimeString(int $starting_time, int $processing_time): string
    {
