...
class ilTestInfoScreenToolbarGUI extends ilToolbarGUI
{
	...
	public function __construct(ilDB $db, ilAccessHandler $access, ilCtrl $ctrl, ilLanguage $lng)
	{
		$this->db = $db;
		$this->access = $access;
		$this->ctrl = $ctrl;
	...
	public function setFormAction($formAction)
	{
		...
		{
			$this->globalToolbar->setFormAction($formAction);
		}
		else
		{
			parent::setFormAction($formAction);
		}
	}
	
	public function addButtonInstance($btnInstance)
	{
		if($this->globalToolbar instanceof parent)
		{
