...
class ilObjTestGUI extends ilObjectGUI
{
    ...
    * @access	public
    */
    public function confirmDeleteAllUserResultsObject()
    {
        global $ilDB, $lng;
    ...
    */
    ...
    /**
       ...
       * @access	public
       */
    public function participantsObject()
    {
        ...
        if ($this->object->getFixedParticipants()) {
            ...
            foreach ($participants as $data) {
                ...
                if ($data['active_id'] == null) { // if no active id is set, user is invitee not participant...
                    ...
                    } elseif ($this->object->getAnonymity()) {
    ...
    public function applyFilterCriteria($in_rows)
    {
        global $ilDB;
    ...
    public function fpSetFilterObject()
    {
        include_once("./Modules/Test/classes/tables/class.ilTestFixedParticipantsTableGUI.php");
    ...
    public function fpResetFilterObject()
    {
        include_once("./Modules/Test/classes/tables/class.ilTestFixedParticipantsTableGUI.php");
        $table_gui = new ilTestFixedParticipantsTableGUI(
            $this,
    ...
    public function npSetFilterObject()
    {
        include_once("./Modules/Test/classes/tables/class.ilTestParticipantsTableGUI.php");
        $table_gui = new ilTestParticipantsTableGUI(
            $this,
    ...
    public function npResetFilterObject()
    {
        include_once("./Modules/Test/classes/tables/class.ilTestParticipantsTableGUI.php");
        $table_gui = new ilTestParticipantsTableGUI(
            $this,
    ...
    /**
       ...
       * @access	public
       */
    public function showDetailedResultsObject()
    {
        if (count($_POST)) {
    ...
    /**
       ...
       * @access	public
       */
    public function showUserAnswersObject()
    {
        if (count($_POST)) {
            $_SESSION["show_user_results"] = $_POST["chbUser"];
        }
    ...
    /**
       ...
       * @access	public
       */
    public function showPassOverviewObject()
    {
        if (count($_POST)) {
            $_SESSION["show_user_results"] = $_POST["chbUser"];
        }
    ...
    /**
       ...
       * @access	public
       */
    public function showUserResults($show_pass_details, $show_answers, $show_reached_points = false)
    {
    ...
    public function removeParticipantObject()
    {
    ...
    public function saveClientIPObject()
    {
        if (is_array($_POST["chbUser"])) {
            foreach ($_POST["chbUser"] as $user_id) {
    ...
    */
    ...
    public function addParticipantsObject($a_user_ids = array())
    {
        $countusers = 0;
        // add users
    ...
    */
    ...
    public function getBrowseForQuestionsTab(&$tabs_gui)
    {
        global $ilAccess;
        if ($ilAccess->checkAccess("write", "", $this->ref_id)) {
    ...
    public function getRandomQuestionsTab(&$tabs_gui)
    {
        global $ilAccess;
        if ($ilAccess->checkAccess("write", "", $this->ref_id)) {
            // edit page
    ...
    */
    ...
    public function getSettingsSubTabs($hiddenTabs = array())
    {
        /**
    ...
    */
    public function getTabs()
    {
        ...
        if (preg_match('/^ass(.*?)gui$/i', $this->ctrl->getNextClass($this))) {
            return;
        } elseif ($this->ctrl->getNextClass($this) == 'ilassquestionpagegui') {
            return;
        }
        ...
        if (strcmp(strtolower(get_class($this->object)), "ilobjtest") == 0) {
            ...
            if ($ilAccess->checkAccess("write", "", $this->ref_id)  && !in_array('manscoring', $hidden_tabs)) {
                ...
                if (count($scoring)) {
                    ...
                    $this->tabs_gui->addTarget(
                        "manscoring",
                        $this->ctrl->getLinkTargetByClass('ilTestScoringByQuestionsGUI', 'showManScoringByQuestionParticipantsTable'),
                        array(
            ...
            if ($ilAccess->checkAccess("write", "", $this->ref_id) && $scoring_adjust_active && !in_array('scoringadjust', $hidden_tabs)) {
                ...
                $this->tabs_gui->addTarget(
                    "scoringadjust",
                    $this->ctrl->getLinkTargetByClass('ilScoringAdjustmentGUI', 'showquestionlist'),
                    array(
                        'showquestionlist',
                        'savescoringfortest',
