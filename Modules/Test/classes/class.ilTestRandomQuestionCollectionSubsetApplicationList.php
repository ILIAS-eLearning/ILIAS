...
class ilTestRandomQuestionCollectionSubsetApplicationList implements Iterator
{
	...
	/* @return ilTestRandomQuestionCollectionSubsetApplication */
	public function current() { return current($this->collectionSubsetApplications); }
	/* @return ilTestRandomQuestionCollectionSubsetApplication */
	public function next() { return next($this->collectionSubsetApplications); }
	/* @return string */
	public function key() { return key($this->collectionSubsetApplications); }
	/* @return bool */
	public function valid() { return key($this->collectionSubsetApplications) !== null; }
	/* @return ilTestRandomQuestionCollectionSubsetApplication */
	public function rewind() { return reset($this->collectionSubsetApplications); }
