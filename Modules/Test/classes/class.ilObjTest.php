...
*/
    ...
    * @access public
    */
    public function evalTotalFinished()
    {
        global $ilDB;
    ...
    * @access public
    */
    public function evalTotalStartedAverageTime()
    {
        global $ilDB;
    ...
    */
    ...
    public function canShowTestResults($testSession)
    {
        ...
        if (($this->endingTimeReached()) || $notimeleft) {
            $result = true;
        }
    ...
    * @access public
    */
    public function saveManualFeedback($active_id, $question_id, $pass, $feedback)
    {
        global $ilDB;
