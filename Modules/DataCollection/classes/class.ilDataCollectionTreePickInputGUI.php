...
class ilDataCollectionTreePickInputGUI extends ilCustomInputGUI {
	...
	public function getHtml() {
		...
		return
			$this->title_input->getToolbarHTML() . "" . $this->search_input->getTableFilterHTML() . $this->hidden_input->getToolbarHTML()
			. " <a href='#' id='search_button_" . $this->getPostVar() . "'>" . $this->lng->txt('search') . "</a>" . $tpl->get();
	}
