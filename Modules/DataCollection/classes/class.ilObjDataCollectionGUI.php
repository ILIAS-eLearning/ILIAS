    ...
    protected function addHeaderAction(): void
    {
        ...
        if ($this->user->getId() != ANONYMOUS_USER_ID and $this->object->getNotification() == 1) {
            if (ilNotification::hasNotification(ilNotification::TYPE_DATA_COLLECTION, $this->user->getId(), $this->obj_id)) {
                ...
                $lg->addHeaderIcon("not_icon", ilUtil::getImagePath("media/notification_on.svg"), $this->lng->txt("dcl_notification_activated"));
            } else {
                ...
                $lg->addHeaderIcon("not_icon", ilUtil::getImagePath("media/notification_off.svg"), $this->lng->txt("dcl_notification_deactivated"));
            }
