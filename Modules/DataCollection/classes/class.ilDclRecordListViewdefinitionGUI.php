...
require_once("./Modules/DataCollection/classes/class.ilDclRecordListViewdefinition.php");
 ...
 */
class ilDclRecordListViewdefinitionGUI
{
	/*
	 * __construct
	 */
	public function __construct($a_parent_obj, $table_id)
	{
		...
		{
			//TODO
			//$this->field_obj = new ilDclBaseFieldModel($field_id);
		}
		else
		{
			$this->view_obj = new ilDclRecordListViewdefinition();
...
//
	...
	public function initForm()
	{
		...
		$arrTables = ilDclTable::getAll($this->obj_id);
		...
		$fields = ilDclBaseFieldModel::getAll($this->table_id);
