...
class ilModulesStudyProgrammeSuite extends TestSuite
{
    public static function suite()
    {
        ...
        require_once("./Modules/StudyProgramme/test/ilStudyProgrammeAccessCtrlByOrguPositionSettingsTest.php");
        ...
        $suite->addTestSuite("ilStudyProgrammeAccessCtrlByOrguPositionSettingsTest");
        return $suite;
    }
}
