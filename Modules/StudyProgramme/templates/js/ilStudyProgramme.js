    ...
    $.fn.extend({
        study_programme_tree: function (options) {
            ...
            var initDndTargetChecking = function (operation, node, node_parent, node_position, more) {
                ...
                /*console.log($parent);
                console.log($node);
                console.log("Target/New Parent is LP object: " + np_lp_object);
                console.log("Current Node is LP object: " + is_lp_object);
                console.log("Target/New Parent has children: " + np_has_lp_children);
                console.log("Target/New Parent has LO object children: " + np_no_children);*/
