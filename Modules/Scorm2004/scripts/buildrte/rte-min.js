...
headers['Accept']='text/javascript';headers['Accept-Charset']='UTF-8';var r=sendAndLoad(url,toJSONString(data),callback,user,password,headers);if((r.status===200&&(/^text\/javascript;?.*/i).test(r.type))||r.status===0)
