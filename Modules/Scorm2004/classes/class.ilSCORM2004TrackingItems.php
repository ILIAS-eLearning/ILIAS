...
class ilSCORM2004TrackingItems extends ilSCORMTrackingItems
{
    ...
    public function exportSelectedCore($a_user = array(), $a_sco = array(), $b_orderBySCO=false, $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
        $lng = $this->lng;
        $lng->loadLanguageModule("scormtrac");
    ...
    public function exportSelectedInteractions($a_user = array(), $a_sco = array(), $b_orderBySCO=false, $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
        $lng = $this->lng;
        $lng->loadLanguageModule("scormtrac");
    ...
    public function exportSelectedObjectives($a_user = array(), $a_sco = array(), $b_orderBySCO=false, $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
        $lng = $this->lng;
        $lng->loadLanguageModule("scormtrac");
    ...
    public function exportObjGlobalToSystem($a_user = array(), $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
        $lng = $this->lng;
        $lng->loadLanguageModule("scormtrac");
    ...
    public function tracInteractionItem($a_user = array(), $a_sco = array(), $b_orderBySCO=false, $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
        $lng = $this->lng;
        $lng->loadLanguageModule("scormtrac");
    ...
    public function tracInteractionUser($a_user = array(), $a_sco = array(), $b_orderBySCO=false, $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
        $lng = $this->lng;
        $lng->loadLanguageModule("scormtrac");
    ...
    public function tracInteractionUserAnswers($a_user = array(), $a_sco = array(), $b_orderBySCO=false, $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
        $lng = $this->lng;
        $lng->loadLanguageModule("scormtrac");
    ...
    public function exportSelectedSuccess($a_user = array(), $allowExportPrivacy=false, $obj_id)
    {
        $ilDB = $this->db;
