...
class ilObjCategoryGUI extends ilContainerGUI
{
    ...
    */
     ...
     */
    public function editTranslationsObject($a_get_post_values = false, $a_add = false)
    {
        $tpl = $this->tpl;
    ...
    */
     ...
     * Edit folder icons
     */
    public function editIconsObject($a_form = null)
    {
        $tpl = $this->tpl;
    ...
    */
    public function updateIconsObject()
    {
        $ilSetting = $this->settings;
