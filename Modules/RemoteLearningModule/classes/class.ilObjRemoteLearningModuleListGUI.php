...
*/
class ilObjRemoteLearningModuleListGUI extends ilObjectListGUI
{
    /**
     * Constructor
     *
    ...
    public function init()
    {
        ...
        include_once('Modules/RemoteLearningModule/classes/class.ilObjRemoteLearningModuleAccess.php');
    ...
    */
    ...
    public function getProperties()
    {
        ...
        if ($org = ilObjRemoteLearningModule::_lookupOrganization($this->obj_id)) {
