--TEST--
PEAR_Registry->getPackage() (failure) (API v1.1)
--SKIPIF--
<?php
...
$ret = $reg->getPackage('foop', 'grob');
$phpunit->assertNull($ret, 'fakeout 1');
$ret = $reg->getPackage('foo');
$phpunit->assertNull($ret, 'fakeout 2');
