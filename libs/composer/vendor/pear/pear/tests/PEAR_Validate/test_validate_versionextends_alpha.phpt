...
$res = $val->validate(PEAR_VALIDATE_PACKAGING);
$phpunit->assertTrue($res, 'attempt 2.4.2a1 alpha');
$phpunit->assertEquals(array (
  'warnings' => 
  array (
    0 => 
...
$res = $val->validate(PEAR_VALIDATE_PACKAGING);
$phpunit->assertTrue($res, 'attempt 2.4.0 alpha');
$phpunit->assertEquals(array (
  'warnings' => 
  array (
    0 => 
...
$res = $val->validate(PEAR_VALIDATE_PACKAGING);
$phpunit->assertTrue($res, 'attempt 2.4.00000 alpha');
$phpunit->assertEquals(array (
  'warnings' => 
  array (
    0 => 
...
$res = $val->validate(PEAR_VALIDATE_PACKAGING);
$phpunit->assertTrue($res, 'attempt 000.2.5 alpha');
$phpunit->assertEquals(array (
  'warnings' => 
  array (
    0 => 
...
$res = $val->validate(PEAR_VALIDATE_PACKAGING);
$phpunit->assertTrue($res, 'attempt 1.5.0 alpha');
$phpunit->assertEquals(array (
  'warnings' => 
  array (
    0 => 
...
$res = $val->validate(PEAR_VALIDATE_PACKAGING);
$phpunit->assertTrue($res, 'attempt 10.5.0 alpha');
$phpunit->assertEquals(array (
  'warnings' => 
  array (
    0 => 
