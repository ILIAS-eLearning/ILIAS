--TEST--
PEAR_PackageFile_Generator_v1->toV2(), filelist 1
--SKIPIF--
<?php
...
$pf = &$parser->parse(implode('', file(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packagefiles' .
    DIRECTORY_SEPARATOR . 'test_filelist.xml')), dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packagefiles' .
    DIRECTORY_SEPARATOR . 'test_filelist.xml');
...
release notes
 ...
 <contents>
  <dir name="/">
   <dir name="sunger">
    <file baseinstalldir="freeb" name="foo.dat" role="data" />
    <file name="foo.doc" role="doc" />
    <file name="foo.tst" role="test" />
   </dir> <!-- //sunger -->
   <file baseinstalldir="freeb" name="foo.php" role="php">
    <tasks:replace from="@pv@" to="version" type="package-info" />
   </file>
   <file name="foo.phpt" role="php" />
  </dir> <!-- / -->
 </contents>
 <dependencies>
  <required>
