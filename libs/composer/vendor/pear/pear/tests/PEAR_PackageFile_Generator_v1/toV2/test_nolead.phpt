--TEST--
PEAR_PackageFile_Generator_v1->toV2(), no lead dev
--SKIPIF--
<?php
...
$pf = &$parser->parse(implode('', file(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packagefiles' .
    DIRECTORY_SEPARATOR . 'test_nolead.xml')), dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packagefiles' .
    DIRECTORY_SEPARATOR . 'test_nolead.xml');
...
hi there
 ...
 <lead>
  <name>unknown</name>
  <user>unknown</user>
  <email>noleadmaintainer@example.com</email>
  <active>no</active>
 </lead>
 <developer>
  <name>person</name>
