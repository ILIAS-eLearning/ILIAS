--TEST--
PEAR_Downloader_Package::analyzeDependencies package.xml 2.0 [ignore-errors/soft]
--SKIPIF--
<?php
...
$mainpackage     = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packages'. DIRECTORY_SEPARATOR . 'main-1.0.tgz';
$requiredpackage = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packages'. DIRECTORY_SEPARATOR . 'required-1.1.tgz';
$sub1package     = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packages'. DIRECTORY_SEPARATOR . 'sub1-1.1.tgz';
$sub2package     = dirname(__FILE__) . DIRECTORY_SEPARATOR .  'packages'. DIRECTORY_SEPARATOR . 'sub2-1.1.tgz';
