--TEST--
PEAR_Downloader_Package::analyzeDependencies package.xml 2.0 [ignore-errors]
--SKIPIF--
<?php
...
$phpunit->assertEquals(array (
  array (
    0 => 0,
    1 => 'pear/main requires PHP (version >= 4.2.0, version <= 6.0.0), installed version is 4.0',
  ),
  array (
    0 => 0,
