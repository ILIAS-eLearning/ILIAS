--TEST--
PEAR_Downloader->download() with downloadable abstract package, channel needs updating
--SKIPIF--
<?php
...
$GLOBALS['pearweb']->addHtmlConfig('http://pear.php.net/channel.xml', $pathtopackagexml, "Last-Modified: 2005-06-04\r\n");
