--TEST--
PEAR_PackageFile_Parser_v2->addSubpackageDepWithChannel
--SKIPIF--
<?php
...
$pf->addSubpackageDepWithChannel('required', 'first', 'test');
$phpunit->assertEquals(array (
  'required' => 
  array (
    'php' => 
...
$pf->addSubpackageDepWithChannel('optional', 'second', 'test');
$phpunit->assertEquals(array (
  'required' => 
  array (
    'php' => 
...
$pf->addSubpackageDepWithChannel('required', 'gronk', 'foo', '1.0', '2.0', '1.3', array('1.5', '2.4'));
$phpunit->assertEquals(array (
  'required' => 
  array (
    'php' => 
...
$pf->addSubpackageDepWithChannel('optional', 'gronko', 'fooo', '1.0', '2.0', '1.3', array('2.4'));
$phpunit->assertEquals(array (
  'required' => 
  array (
    'php' => 
