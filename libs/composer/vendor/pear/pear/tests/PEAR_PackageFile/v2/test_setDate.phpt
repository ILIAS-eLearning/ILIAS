--TEST--
PEAR_PackageFile_Parser_v2->setDate()
--SKIPIF--
<?php
...
$pf->setDate('2004-10-11');
$phpunit->assertEquals('2004-10-11', $pf->getDate(), 'set failed');
...
$phpunit->assertErrors(array(
    array('package' => 'PEAR_PackageFile_v2', 'message' => 'Channel validator warning: field "date" - Release Date "2004-10-11" is not today')
