--TEST--
PEAR_PackageFile_Generator_v2->toPackageFile() phprelease package.xml (uri package.xml)
--SKIPIF--
<?php
...
$pf = $parser->parse(implode('', file(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packagefiles' .
    DIRECTORY_SEPARATOR . 'phprelease2.xml')), dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packagefiles' .
    DIRECTORY_SEPARATOR . 'phprelease2.xml');
