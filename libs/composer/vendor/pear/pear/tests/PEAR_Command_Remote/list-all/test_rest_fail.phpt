--TEST--
list-all command (REST-based channel, fail on invalid xml downloaded)
--SKIPIF--
<?php
...
$pearweb->addRESTConfig("http://pear.php.net/rest/p/packages.xml", '<?xml version="1.0" encoding="iso-8859-1" ?>
