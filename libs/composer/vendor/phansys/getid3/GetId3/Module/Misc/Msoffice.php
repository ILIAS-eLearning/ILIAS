 ...
 */
class GetId3_Module_Misc_Msoffice extends GetId3_Handler_BaseHandler
{
	...
	public function Analyze() {
		...
		if (substr($DOCFILEheader, 0, 8) != $magic) {
			$info['error'][] = 'Expecting "'.GetId3_Lib_Helper::PrintHexBytes($magic).'" at '.$info['avdataoffset'].', found '.GetId3_Lib_Helper::PrintHexBytes(substr($DOCFILEheader, 0, 8)).' instead.';
			return false;
		}
