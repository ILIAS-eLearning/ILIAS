...
class Asf extends BaseHandler
{
    ...
    protected static $GETID3_ASF_Payload_Ext_Syst_Pixel_Aspect_Ratio;
    protected static $GETID3_ASF_Script_Command_Object;
    protected static $GETID3_ASF_No_Error_Correction;
    protected static $GETID3_ASF_Content_Branding_Object;
    protected static $GETID3_ASF_Content_Encryption_Object;
    protected static $GETID3_ASF_Digital_Signature_Object;
    protected static $GETID3_ASF_Extended_Content_Encryption_Object;
    protected static $GETID3_ASF_Simple_Index_Object;
    protected static $GETID3_ASF_Degradable_JPEG_Media;
    protected static $GETID3_ASF_Payload_Extension_System_Timecode;
    protected static $GETID3_ASF_Binary_Media;
    protected static $GETID3_ASF_Timecode_Index_Object;
    protected static $GETID3_ASF_Metadata_Library_Object;
    protected static $GETID3_ASF_Reserved_3;
    protected static $GETID3_ASF_Reserved_4;
    protected static $GETID3_ASF_Command_Media;
    protected static $GETID3_ASF_Header_Extension_Object;
    protected static $GETID3_ASF_Media_Object_Index_Parameters_Obj;
    protected static $GETID3_ASF_Header_Object;
    protected static $GETID3_ASF_Content_Description_Object;
    protected static $GETID3_ASF_Error_Correction_Object;
    protected static $GETID3_ASF_Data_Object;
    protected static $GETID3_ASF_Web_Stream_Media_Subtype;
    protected static $GETID3_ASF_Stream_Bitrate_Properties_Object;
    protected static $GETID3_ASF_Language_List_Object;
    protected static $GETID3_ASF_Codec_List_Object;
    protected static $GETID3_ASF_Reserved_2;
    protected static $GETID3_ASF_File_Properties_Object;
    protected static $GETID3_ASF_File_Transfer_Media;
    protected static $GETID3_ASF_Old_RTP_Extension_Data;
    protected static $GETID3_ASF_Advanced_Mutual_Exclusion_Object;
    protected static $GETID3_ASF_Bandwidth_Sharing_Object;
    protected static $GETID3_ASF_Reserved_1;
    protected static $GETID3_ASF_Bandwidth_Sharing_Exclusive;
    protected static $GETID3_ASF_Bandwidth_Sharing_Partial;
    protected static $GETID3_ASF_JFIF_Media;
    protected static $GETID3_ASF_Stream_Properties_Object;
    protected static $GETID3_ASF_Video_Media;
    protected static $GETID3_ASF_Audio_Spread;
    protected static $GETID3_ASF_Metadata_Object;
    protected static $GETID3_ASF_Payload_Ext_Syst_Sample_Duration;
    protected static $GETID3_ASF_Group_Mutual_Exclusion_Object;
    protected static $GETID3_ASF_Extended_Content_Description_Object;
    protected static $GETID3_ASF_Stream_Prioritization_Object;
    protected static $GETID3_ASF_Payload_Ext_System_Content_Type;
    protected static $GETID3_ASF_Old_File_Properties_Object;
    protected static $GETID3_ASF_Old_ASF_Header_Object;
    protected static $GETID3_ASF_Old_ASF_Data_Object;
    protected static $GETID3_ASF_Index_Object;
    protected static $GETID3_ASF_Old_Stream_Properties_Object;
    protected static $GETID3_ASF_Old_Content_Description_Object;
    protected static $GETID3_ASF_Old_Script_Command_Object;
    protected static $GETID3_ASF_Old_Marker_Object;
    protected static $GETID3_ASF_Old_Component_Download_Object;
    protected static $GETID3_ASF_Old_Stream_Group_Object;
    protected static $GETID3_ASF_Old_Scalable_Object;
    protected static $GETID3_ASF_Old_Prioritization_Object;
    protected static $GETID3_ASF_Bitrate_Mutual_Exclusion_Object;
    protected static $GETID3_ASF_Old_Inter_Media_Dependency_Object;
    protected static $GETID3_ASF_Old_Rating_Object;
    protected static $GETID3_ASF_Index_Parameters_Object;
    protected static $GETID3_ASF_Old_Color_Table_Object;
    protected static $GETID3_ASF_Old_Language_List_Object;
    protected static $GETID3_ASF_Old_Audio_Media;
    protected static $GETID3_ASF_Old_Video_Media;
    protected static $GETID3_ASF_Old_Image_Media;
    protected static $GETID3_ASF_Old_Timecode_Media;
    protected static $GETID3_ASF_Old_Text_Media;
    protected static $GETID3_ASF_Old_MIDI_Media;
    protected static $GETID3_ASF_Old_Command_Media;
    protected static $GETID3_ASF_Old_No_Error_Concealment;
    protected static $GETID3_ASF_Old_Scrambled_Audio;
    protected static $GETID3_ASF_Old_No_Color_Table;
    protected static $GETID3_ASF_Old_SMPTE_Time;
    protected static $GETID3_ASF_Old_ASCII_Text;
    protected static $GETID3_ASF_Old_Unicode_Text;
    protected static $GETID3_ASF_Old_HTML_Text;
    protected static $GETID3_ASF_Old_URL_Command;
    protected static $GETID3_ASF_Old_Filename_Command;
    protected static $GETID3_ASF_Old_ACM_Codec;
    protected static $GETID3_ASF_Old_VCM_Codec;
    protected static $GETID3_ASF_Old_QuickTime_Codec;
    protected static $GETID3_ASF_Old_DirectShow_Transform_Filter;
    protected static $GETID3_ASF_Old_DirectShow_Rendering_Filter;
    protected static $GETID3_ASF_Old_No_Enhancement;
    protected static $GETID3_ASF_Old_Unknown_Enhancement_Type;
    protected static $GETID3_ASF_Old_Temporal_Enhancement;
    protected static $GETID3_ASF_Old_Spatial_Enhancement;
    protected static $GETID3_ASF_Old_Quality_Enhancement;
    protected static $GETID3_ASF_Old_Number_of_Channels_Enhancement;
    protected static $GETID3_ASF_Old_Frequency_Response_Enhancement;
    protected static $GETID3_ASF_Old_Media_Object;
    protected static $GETID3_ASF_Mutex_Language;
    protected static $GETID3_ASF_Mutex_Bitrate;
    protected static $GETID3_ASF_Mutex_Unknown;
    protected static $GETID3_ASF_Old_ASF_Placeholder_Object;
    protected static $GETID3_ASF_Old_Data_Unit_Extension_Object;
    protected static $GETID3_ASF_Web_Stream_Format;
    protected static $GETID3_ASF_Payload_Ext_System_File_Name;
    protected static $GETID3_ASF_Marker_Object;
    protected static $GETID3_ASF_Timecode_Index_Parameters_Object;
    protected static $GETID3_ASF_Audio_Media;
    protected static $GETID3_ASF_Media_Object_Index_Object;
    protected static $GETID3_ASF_Alt_Extended_Content_Encryption_Obj;
    /**
     * @var type
    ...
    public function analyze()
    {
        ...
        $ASFHeaderData = fread($this->getid3->fp,
                               $thisfile_asf_headerobject['objectsize'] - 30);
        $offset = 0;

        for ($HeaderObjectsCounter = 0;
            ...
            switch ($NextObjectGUID) {
                ...
                case self::$GETID3_ASF_File_Properties_Object:
                    ...
                    $thisfile_asf_filepropertiesobject['fileid'] = substr($ASFHeaderData,
                                                                          $offset,
                                                                          16);
                    $offset += 16;
                ...
                case self::$GETID3_ASF_Stream_Properties_Object:
                    ...
                    $StreamPropertiesObjectData['stream_type'] = substr($ASFHeaderData,
                                                                        $offset,
                                                                        16);
                    $offset += 16;
                    $StreamPropertiesObjectData['stream_type_guid'] = self::BytestringToGUID($StreamPropertiesObjectData['stream_type']);
                    $StreamPropertiesObjectData['error_correct_type'] = substr($ASFHeaderData,
                                                                               $offset,
                                                                               16);
                    $offset += 16;
                    ...
                    $StreamPropertiesObjectData['type_specific_data'] = substr($ASFHeaderData,
                                                                               $offset,
                                                                               $StreamPropertiesObjectData['type_data_length']);
                    $offset += $StreamPropertiesObjectData['type_data_length'];
                    $StreamPropertiesObjectData['error_correct_data'] = substr($ASFHeaderData,
                                                                               $offset,
                ...
                case self::$GETID3_ASF_Header_Extension_Object:
                    ...
                    $thisfile_asf_headerextensionobject['reserved_1'] = substr($ASFHeaderData,
                                                                               $offset,
                                                                               16);
                    $offset += 16;
                    ...
                    $thisfile_asf_headerextensionobject['extension_data_size'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                                            ...
                                                                                                                            4));
                    $offset += 4;
                    $thisfile_asf_headerextensionobject['extension_data'] = substr($ASFHeaderData,
                                                                                   $offset,
                                                                                   $thisfile_asf_headerextensionobject['extension_data_size']);
                    $unhandled_sections = 0;
                    $thisfile_asf_headerextensionobject['extension_data_parsed'] = $this->ASF_HeaderExtensionObjectDataParse($thisfile_asf_headerextensionobject['extension_data'],
                                                                                                                             $unhandled_sections);
                ...
                case self::$GETID3_ASF_Codec_List_Object:
                    ...
                    $thisfile_asf_codeclistobject['reserved'] = substr($ASFHeaderData,
                                                                       $offset,
                                                                       16);
                    $offset += 16;
                    ...
                    $thisfile_asf_codeclistobject['codec_entries_count'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                                      ...
                                                                                                                      4));
                    $offset += 4;
                    for ($CodecEntryCounter = 0;
                            $CodecEntryCounter < $thisfile_asf_codeclistobject['codec_entries_count'];
                            $CodecEntryCounter++) {
                        // shortcut
                        ...
                        $offset += 2;
                        $thisfile_asf_codeclistobject_codecentries_current['name'] = substr($ASFHeaderData,
                                                                                            $offset,
                                                                                            $CodecNameLength);
                        ...
                        $CodecDescriptionLength = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                             ...
                                                                                             2)) * 2; // 2 bytes per character
                        $offset += 2;
                        $thisfile_asf_codeclistobject_codecentries_current['description'] = substr($ASFHeaderData,
                                                                                                   $offset,
                        ...
                        $CodecInformationLength = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                             ...
                                                                                             2));
                        $offset += 2;
                        $thisfile_asf_codeclistobject_codecentries_current['information'] = substr($ASFHeaderData,
                                                                                                   $offset,
                        ...
                        if ($thisfile_asf_codeclistobject_codecentries_current['type_raw'] == 2) { // audio codec
                            if (strpos($thisfile_asf_codeclistobject_codecentries_current['description'],
                                       ',') === false) {
                                ...
                                list($AudioCodecBitrate, $AudioCodecFrequency, $AudioCodecChannels) = explode(',',
                                                                                                              self::TrimConvert($thisfile_asf_codeclistobject_codecentries_current['description']));
                                $thisfile_audio['codec'] = self::TrimConvert($thisfile_asf_codeclistobject_codecentries_current['name']);

                                if (!isset($thisfile_audio['bitrate']) && strstr($AudioCodecBitrate,
                                                                                 'kbps')) {
                                    $thisfile_audio['bitrate'] = (int) (trim(str_replace('kbps',
                                                                                         '',
                                ...
                                $AudioCodecFrequency = (int) trim(str_replace('kHz',
                                                                              '',
                                                                              $AudioCodecFrequency));
                ...
                case self::$GETID3_ASF_Script_Command_Object:
                    ...
                    $thisfile_asf_scriptcommandobject['reserved'] = substr($ASFHeaderData,
                                                                           $offset,
                                                                           16);
                    $offset += 16;
                    ...
                    for ($CommandTypesCounter = 0;
                        ...
                        $CommandTypeNameLength = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                            ...
                                                                                            2)) * 2; // 2 bytes per character
                        $offset += 2;
                        $thisfile_asf_scriptcommandobject['command_types'][$CommandTypesCounter]['name'] = substr($ASFHeaderData,
                                                                                                                  $offset,
                    ...
                    for ($CommandsCounter = 0;
                        ...
                        $CommandTypeNameLength = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                            ...
                                                                                            2)) * 2; // 2 bytes per character
                        $offset += 2;
                        $thisfile_asf_scriptcommandobject['commands'][$CommandsCounter]['name'] = substr($ASFHeaderData,
                                                                                                         $offset,
                                                                                                         $CommandTypeNameLength);
                        $offset += $CommandTypeNameLength;
                    }
                ...
                case self::$GETID3_ASF_Marker_Object:
                    ...
                    $thisfile_asf_markerobject['reserved'] = substr($ASFHeaderData,
                                                                    $offset, 16);
                    $offset += 16;
                    ...
                    $thisfile_asf_markerobject['name_length'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                           ...
                                                                                                           2));
                    $offset += 2;
                    $thisfile_asf_markerobject['name'] = substr($ASFHeaderData,
                                                                $offset,
                    ...
                    for ($MarkersCounter = 0;
                        ...
                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['marker_description_length'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                                                                         ...
                                                                                                                                                         4));
                        $offset += 4;
                        $thisfile_asf_markerobject['markers'][$MarkersCounter]['marker_description'] = substr($ASFHeaderData,
                                                                                                              $offset,
                        ...
                        if ($PaddingLength > 0) {
                            $thisfile_asf_markerobject['markers'][$MarkersCounter]['padding'] = substr($ASFHeaderData,
                                                                                                       $offset,
                                                                                                       $PaddingLength);
                ...
                case self::$GETID3_ASF_Bitrate_Mutual_Exclusion_Object:
                    ...
                    $thisfile_asf_bitratemutualexclusionobject['reserved'] = substr($ASFHeaderData,
                                                                                    $offset,
                                                                                    16);
                ...
                case self::$GETID3_ASF_Error_Correction_Object:
                    ...
                    $thisfile_asf_errorcorrectionobject['error_correction_type'] = substr($ASFHeaderData,
                                                                                          $offset,
                                                                                          16);
                    $offset += 16;
                    ...
                    switch ($thisfile_asf_errorcorrectionobject['error_correction_type']) {
                        ...
                        case self::$GETID3_ASF_Audio_Spread:
                            ...
                            $thisfile_asf_errorcorrectionobject['silence_data_length'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                                                    ...
                                                                                                                                    2));
                            $offset += 2;
                            $thisfile_asf_errorcorrectionobject['silence_data'] = substr($ASFHeaderData,
                                                                                         $offset,
                ...
                case self::$GETID3_ASF_Extended_Content_Description_Object:
                    ...
                    $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                                                             ...
                                                                                                                                             2));
                    $offset += 2;
                    for ($ExtendedContentDescriptorsCounter = 0;
                            $ExtendedContentDescriptorsCounter < $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count'];
                        ...
                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name_length'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                                                                             ...
                                                                                                                                                             2));
                        $offset += 2;
                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name'] = substr($ASFHeaderData,
                                                                                                                  $offset,
                        ...
                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_length'] = Helper::LittleEndian2Int(substr($ASFHeaderData,
                                                                                                                                                              ...
                                                                                                                                                              2));
                        $offset += 2;
                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value'] = substr($ASFHeaderData,
                                                                                                                   $offset,
                            ...
                            default:
                                switch ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type']) {
                                    case 0: // Unicode string
                                        if (substr(self::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']),
                                                                      0, 3) == 'WM/') {
                                            $thisfile_asf_comments[str_replace('wm/',
                                                                               '',
                ...
                case self::$GETID3_ASF_Padding_Object:
                    ...
                    $thisfile_asf_paddingobject['padding'] = substr($ASFHeaderData,
                                                                    $offset,
        ...
        if (isset($thisfile_asf_streambitrateproperties['bitrate_records_count'])) {
            ...
            $ASFbitrateVideo = 0;
            for ($BitrateRecordsCounter = 0;
                    $BitrateRecordsCounter < $thisfile_asf_streambitrateproperties['bitrate_records_count'];
                    $BitrateRecordsCounter++) {
        ...
        if (isset($thisfile_asf['stream_properties_object']) && is_array($thisfile_asf['stream_properties_object'])) {
                ...
                switch ($streamdata['stream_type']) {
                    case self::$GETID3_ASF_Audio_Media:
                        ...
                        $thisfile_asf_audiomedia_currentstream['codec_data_size'] = Helper::LittleEndian2Int(substr($streamdata['type_specific_data'],
                                                                                                                               ...
                                                                                                                               2));
                        $audiomediaoffset += 2;
                        $thisfile_asf_audiomedia_currentstream['codec_data'] = substr($streamdata['type_specific_data'],
                                                                                      $audiomediaoffset,
                    ...
                    case self::$GETID3_ASF_Video_Media:
                        ...
                        $thisfile_asf_videomedia_currentstream['format_data']['bits_per_pixel'] = Helper::LittleEndian2Int(substr($streamdata['type_specific_data'],
                                                                                                                                             ...
                                                                                                                                             2));
                        $videomediaoffset += 2;
                        $thisfile_asf_videomedia_currentstream['format_data']['codec_fourcc'] = substr($streamdata['type_specific_data'],
                                                                                                       $videomediaoffset,
                                                                                                       4);
                        $videomediaoffset += 4;
                        ...
                        $thisfile_asf_videomedia_currentstream['format_data']['colors_important'] = Helper::LittleEndian2Int(substr($streamdata['type_specific_data'],
                                                                                                                                               ...
                                                                                                                                               4));
                        $videomediaoffset += 4;
                        $thisfile_asf_videomedia_currentstream['format_data']['codec_data'] = substr($streamdata['type_specific_data'],
                                                                                                     $videomediaoffset);
            ...
            switch ($NextObjectGUID) {
                case self::$GETID3_ASF_Data_Object:
                    ...
                    $DataObjectData = $NextObjectDataHeader . fread($this->getid3->fp,
                                                                    50 - 24);
                    $offset = 24;
                    ...
                    $thisfile_asf_dataobject['fileid'] = substr($DataObjectData,
                                                                $offset, 16);
                    $offset += 16;
                ...
                case self::$GETID3_ASF_Simple_Index_Object:
                    ...
                    $SimpleIndexObjectData = $NextObjectDataHeader . fread($this->getid3->fp,
                                                                           56 - 24);
                    $offset = 24;
                    ...
                    $IndexEntriesData = $SimpleIndexObjectData . fread($this->getid3->fp,
                                                                       6 * $thisfile_asf_simpleindexobject['index_entries_count']);
                ...
                case self::$GETID3_ASF_Index_Object:
                    ...
                    $ASFIndexObjectData = $NextObjectDataHeader . fread($this->getid3->fp,
                                                                        34 - 24);
                    $offset = 24;
                    ...
                    $ASFIndexObjectData .= fread($this->getid3->fp,
                                                 4 * $thisfile_asf_asfindexobject['index_specifiers_count']);
                    ...
                    $ASFIndexObjectData .= fread($this->getid3->fp,
                                                 8 * $thisfile_asf_asfindexobject['index_specifiers_count']);
                    for ($IndexSpecifiersCounter = 0;
                            $IndexSpecifiersCounter < $thisfile_asf_asfindexobject['index_specifiers_count'];
                            $IndexSpecifiersCounter++) {
                    ...
                    for ($IndexEntryCounter = 0;
                            $IndexEntryCounter < $thisfile_asf_asfindexobject['index_entry_count'];
                            $IndexEntryCounter++) {
                        for ($IndexSpecifiersCounter = 0;
                                $IndexSpecifiersCounter < $thisfile_asf_asfindexobject['index_specifiers_count'];
                                $IndexSpecifiersCounter++) {
                                                       ...
                                                       &$unhandled_sections)
    {
        ...
        while ($objectOffset < strlen($asf_header_extension_object_data)) {
            ...
            $thisObject['guid'] = substr($asf_header_extension_object_data,
                                         $offset, 16);
            $offset += 16;
            ...
            switch ($thisObject['guid']) {
                case self::$GETID3_ASF_Extended_Stream_Properties_Object:
                    ...
                    for ($i = 0;
                        ...
                        $payloadExtensionSystem['extension_system_id'] = substr($asf_header_extension_object_data,
                                                                                $offset,
                                                                                16);
                        $offset += 16;
                ...
                case self::$GETID3_ASF_Metadata_Object:
                    ...
                    for ($i = 0; $i < $thisObject['description_record_counts'];
                            $i++) {
                        ...
                        $descriptionRecord['name'] = substr($asf_header_extension_object_data,
                                                            $offset,
                                                            $descriptionRecord['name_length']);
                        $offset += $descriptionRecord['name_length'];

                        $descriptionRecord['data'] = substr($asf_header_extension_object_data,
                                                            $offset,
                ...
                case self::$GETID3_ASF_Language_List_Object:
                    ...
                    for ($i = 0; $i < $thisObject['language_id_record_counts'];
                            $i++) {
                        ...
                        $languageIDrecord['language_id'] = substr($asf_header_extension_object_data,
                                                                  $offset,
                ...
                case self::$GETID3_ASF_Metadata_Library_Object:
                    ...
                    for ($i = 0; $i < $thisObject['description_records_count'];
                            $i++) {
                        $descriptionRecord = array();
                ...
                default:
                    ...
                    if (self::GUIDname($thisObject['guid_text'])) {
                        $this->getid3->info['warning'][] = 'unhandled Header Extension Object GUID "' . self::GUIDname($thisObject['guid_text']) . '" {' . $thisObject['guid_text'] . '} at offset ' . ($offset - 16 - 8);
                    } else {
