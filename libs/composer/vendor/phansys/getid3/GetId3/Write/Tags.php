 ...
 * @uses GetId3_Write_Apetag (optional)
 * @uses GetId3_Write_Id3v1 (optional)
 * @uses GetId3_Write_Vorbiscomment (optional)
 * @uses GetId3_Write_Metaflac (optional)
 * @uses GetId3_Write_Lyrics3 (optional)
 */
class GetId3_Write_Tags
{
	// public
	...
	public function __construct() {
        if (!class_exists('GetId3_GetId3')) {
            throw new Exception('GetId3.php MUST be included before calling GetId3_Write_Tags()');
        }
				...
				default:
					foreach ($valuearray as $key => $value) {
						if (is_string($value) || is_numeric($value)) {
							$ape_tag_data[$tag_key][$key] = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'UTF-8', $value);
						} else {
	...
	public function FormatDataForID3v1() {
		...
		if (!empty($this->tag_data['GENRE'])) {
			foreach ($this->tag_data['GENRE'] as $key => $value) {
				if (GetId3_Module_Tag_Id3v1::LookupGenreID($value) !== false) {
					$tag_data_id3v1['genreid'] = GetId3_Module_Tag_Id3v1::LookupGenreID($value);
					break;
				}
			}
		}
		$tag_data_id3v1['title']   =        GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['TITLE']      ) ? $this->tag_data['TITLE']       : array())));
		$tag_data_id3v1['artist']  =        GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['ARTIST']     ) ? $this->tag_data['ARTIST']      : array())));
		$tag_data_id3v1['album']   =        GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['ALBUM']      ) ? $this->tag_data['ALBUM']       : array())));
		$tag_data_id3v1['year']    =        GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['YEAR']       ) ? $this->tag_data['YEAR']        : array())));
		$tag_data_id3v1['comment'] =        GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['COMMENT']    ) ? $this->tag_data['COMMENT']     : array())));
		$tag_data_id3v1['track']   = intval(GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['TRACKNUMBER']) ? $this->tag_data['TRACKNUMBER'] : array()))));
						...
						if (isset($ID3v2_text_encoding_lookup[$id3v2_majorversion][$this->tag_encoding])) {
							...
							if ($id3v2_majorversion < 4) {
								...
								if (!$ID3v2_tag_data_converted) {
									...
									$tag_data_id3v2[$ID3v2_framename][$key]['data']       = "\xFF\xFE".GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'UTF-16LE', $value); // force LittleEndian order version of UTF-16
									$ID3v2_tag_data_converted = true;
								}
								...
								$tag_data_id3v2[$ID3v2_framename][$key]['data']       = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'UTF-8', $value);
							}
						}
				...
				if (strstr($value, "\n")) {
					...
					foreach ($multilineexploded as $newcomment) {
						if (strlen(trim($newcomment)) > 0) {
							$tag_data_vorbiscomment[$tag_key][] = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'UTF-8', $newcomment);
						}
					}
				} elseif (is_string($value) || is_numeric($value)) {
					$tag_data_vorbiscomment[$tag_key][$key] = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'UTF-8', $value);
				} else {
	...
	public function FormatDataForReal() {
		$tag_data_real['title']     = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['TITLE']    ) ? $this->tag_data['TITLE']     : array())));
		$tag_data_real['artist']    = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['ARTIST']   ) ? $this->tag_data['ARTIST']    : array())));
		$tag_data_real['copyright'] = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['COPYRIGHT']) ? $this->tag_data['COPYRIGHT'] : array())));
		$tag_data_real['comment']   = GetId3_Lib_Helper::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['COMMENT']  ) ? $this->tag_data['COMMENT']   : array())));
