...
$tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.adm_lang.html");
$tpl->addBlockFile("LOCATOR", "locator", "tpl.adm_locator.html");

//show tabs
$o = array();
$o["LINK1"] = "content_lang.php?obj_id=".$_GET["obj_id"]."&parent=".$_GET["parent"];
...
if ($rbacsystem->checkAccess('read',$_GET["obj_id"],$_GET["parent"]))
{
	if ($lang_data = getLangList($_GET["order"],$_GET["direction"]) )
	{
		foreach ($user_data as $key => $val)
		{
			...
			$tpl->setVariable("IMG_TYPE","icon_lang_b.gif");
