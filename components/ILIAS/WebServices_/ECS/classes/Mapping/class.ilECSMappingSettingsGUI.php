...
class ilECSMappingSettingsGUI
{
    ...
    protected function cInitOverview($form = null, $current_attribute = null): void
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.ecs_cmap_overview.html', 'components/ILIAS/WebServices_/ECS');
    ...
    protected function initFormCSettings(): \ilPropertyFormGUI
    {
        ...
        $tpl = new ilTemplate('tpl.ecs_import_id_form.html', true, true, 'components/ILIAS/WebServices_/ECS');
    ...
    {
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.ecs_edit_tree.html', 'components/ILIAS/WebServices_/ECS');
