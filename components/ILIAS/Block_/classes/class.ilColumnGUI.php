...
class ilColumnGUI
{
    ...
    protected static array $locations = array(
        ...
        "ilCalendarBlockGUI" => "components/ILIAS/Calendar_/",
        "ilPDCalendarBlockGUI" => "components/ILIAS/Calendar_/",
        "ilPDTasksBlockGUI" => "components/ILIAS/Tasks_/",
        "ilPDMailBlockGUI" => "components/ILIAS/Mail_/",
        "ilSelectedItemsBlockGUI" => "components/ILIAS/Dashboard_/Block/",
        "ilPDNewsBlockGUI" => "components/ILIAS/News/",
        'ilPollBlockGUI' => 'components/ILIAS/Poll_/',
        'ilClassificationBlockGUI' => 'components/ILIAS/Classification_/',
        "ilPDStudyProgrammeSimpleListGUI" => "components/ILIAS/StudyProgramme_/",
        "ilPDStudyProgrammeExpandableListGUI" => "components/ILIAS/StudyProgramme_/",
    );
    ...
    */
    ...
    public function getHTML(): string
    {
        ...
        $this->tpl = new ilTemplate("tpl.column.html", true, true, "components/ILIAS/Block_");
