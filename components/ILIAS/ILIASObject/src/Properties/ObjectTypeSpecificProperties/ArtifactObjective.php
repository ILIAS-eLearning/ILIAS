...
namespace ILIAS\ILIASObject\Properties\ObjectTypeSpecificProperties;
...
class ArtifactObjective extends BuildArtifactObjective
{
    ...
    {
        return "object_specific_properties";
    }
    ...
    public function build(): Artifact
    {
        ...
        foreach ($finder->getMatchingClassNames(ObjectTypeSpecificProperties::class) as $object_properties_class) {
            /** @var $properties \ILIAS\ILIASObject\Properties\ObjectTypeSpecificProperties */
