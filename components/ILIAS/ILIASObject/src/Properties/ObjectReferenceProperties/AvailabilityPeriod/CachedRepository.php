...
namespace ILIAS\ILIASObject\Properties\ObjectReferenceProperties\AvailabilityPeriod;
...
class CachedRepository
{
    ...
    public function getFor(?int $object_reference_id): AvailabilityPeriod
    {
    ...
    public function store(AvailabilityPeriod $property): void
    {
    ...
    private function getDefaultObjectReferenceProperties(): AvailabilityPeriod
    {
        return new AvailabilityPeriod();
    }
