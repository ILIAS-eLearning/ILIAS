...
class Icon implements Property
{
    ...
    public function __construct(
        ...
        private ?Custom $custom_icon = null,
        private ?ObjectTypeSpecificPropertyProviders $object_type_specific_property_providers = null
    ) {
    }
    ...
    public function getCustomIcon(): ?Custom
    {
