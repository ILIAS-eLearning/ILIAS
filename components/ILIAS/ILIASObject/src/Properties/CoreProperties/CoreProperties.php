...
class CoreProperties
{
    ...
    public function __construct(
        private TitleAndDescription $property_title_and_description,
        private Online $property_is_online,
        private PropertyTileImage $property_tile_image,
        ?array $data = null
    ) {
    ...
    public function withPropertyTitleAndDescription(TitleAndDescription $property_title_and_description): self
    {
        $clone = clone $this;
    ...
    public function withPropertyIsOnline(Online $property_is_online): self
    {
        $clone = clone $this;
    ...
    public function withPropertyTileImage(PropertyTileImage $property_tile_image): self
    {
        $clone = clone $this;
