...
class CachedRepository implements Repository
{
    ...
    public function __construct(
        ...
        private readonly TileImage\FlavourDefinition $flavour_definition,
    ...
    public function getFor(?int $object_id, ?string $type = null): CoreProperties
    {
        ...
        return new CoreProperties(
            ...
            new Online(array_shift($data)),
            new TileImage\Property(
                new TileImage\TileImage(
                    $object_id,
                    $data['type'],
                    array_shift($data),
    ...
    private function deleteOldTileImage(TileImage\TileImage $tile_image): void
    {
    ...
    private function getDefaultCoreProperties(?string $type): CoreProperties
    {
        return (new CoreProperties(
            new TitleAndDescription(),
            new Online(),
