...
use ILIAS\ResourceStorage\Flavour\Definition\FlavourDefinition as FlavourDefinitionInterface;
...
use ILIAS\ResourceStorage\Flavour\Machine\FlavourMachine as FlavourMachineInterface;
use ILIAS\ResourceStorage\Flavour\Machine\Result;
use ILIAS\ResourceStorage\Information\FileInformation;
use ILIAS\Filesystem\Stream\Stream;

class FlavourMachine extends AbstractMachine implements FlavourMachineInterface
{
    ...
    private ?FlavourDefinition $definition = null;
    ...
    public function canHandleDefinition(FlavourDefinitionInterface $definition): bool
    {
        return $definition instanceof FlavourDefinition;
    }
    ...
    public function processStream(
        ...
        FileStream $stream,
        FlavourDefinitionInterface $for_definition
    ): \Generator {
        /** @var FlavourDefinition $for_definition */
