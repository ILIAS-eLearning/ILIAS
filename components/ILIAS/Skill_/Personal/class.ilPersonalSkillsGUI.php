...
class ilPersonalSkillsGUI
{
    ...
    public function listSkills(): void
    {
        ...
        $tpl = new ilTemplate("tpl.skill_filter.html", true, true, "components/ILIAS/Skill_");
    ...
    public function getSkillHTML(
        ...
        $main_tpl->addJavaScript("./components/ILIAS/Skill_/js/SkillEntries.js");
    ...
    public function renderSkillHTML(
        ...
        $tpl = new ilTemplate("tpl.skill_pres.html", true, true, "components/ILIAS/Skill_");
    ...
    public function assignMaterial(): void
    {
        ...
        // fill template
        $mtpl = new ilTemplate("tpl.materials_selection.html", true, true, "components/ILIAS/Skill_");
    ...
    public function getProfileTargetItem(int $a_profile_id, array $a_levels, int $a_tref_id = 0): string
    {
        ...
        $tpl = new ilTemplate("tpl.skill_eval_item.html", true, true, "components/ILIAS/Skill_");
    ...
    protected function getLatestEntriesForSkillHTML(
        ...
        $tpl = new ilTemplate("tpl.skill_entries_latest.html", true, true, "components/ILIAS/Skill_");
    ...
    protected function getNonLatestEntriesForSkillHTML(
        ...
        $tpl = new ilTemplate("tpl.skill_entries_non_latest.html", true, true, "components/ILIAS/Skill_");
    ...
    {
        $tpl = new ilTemplate("tpl.skill_entries_header.html", true, true, "components/ILIAS/Skill_");
    ...
    {
        $tpl = new ilTemplate("tpl.skill_description_category.html", true, true, "components/ILIAS/Skill_");
    ...
    {
        $tpl = new ilTemplate("tpl.skill_description_basic.html", true, true, "components/ILIAS/Skill_");
    ...
    {
        $level_data = $skill->getLevelData();
        $tpl = new ilTemplate("tpl.skill_desc.html", true, true, "components/ILIAS/Skill_");
