        ...
        switch ($a_entity) {
            case "skl_subtree":
                if ((int) $a_rec["TopNode"] === 1) {
                    ...
                    $parent = (int) $a_mapping->getMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["Parent"]);
                ...
                switch ($a_rec["Type"]) {
                    case "scat":
                        ...
                        $a_mapping->addMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["Child"], (string) $scat->getId());
                        break;
                    ...
                    case "skll":
                        ...
                        $a_mapping->addMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["Child"], (string) $skll->getId());
                        break;

                    case "sktr":
                        $template_id = (int) $a_mapping->getMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["TemplateId"]);
                        ...
                        if ($template_id > 0) {
                            ...
                            $a_mapping->addMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["Child"], (string) $sktr->getId());
                        }
                        break;
                }
                break;
            ...
            case "skl_templ_subtree":
                ...
                switch ($a_rec["Type"]) {
                    case "sctp":
                        ...
                        $a_mapping->addMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["Child"], (string) $sctp->getId());
                        break;
                    ...
                    case "sktp":
                        ...
                        $a_mapping->addMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["Child"], (string) $sktp->getId());
                        break;
                }
                break;

            case "skl_level":
                $skill_id = (int) $a_mapping->getMapping("components/ILIAS/Skill_", "skl_tree", $a_rec["SkillId"]);
            ...
            case "skl_prof":
                ...
                $a_mapping->addMapping("components/ILIAS/Skill_", "skl_prof", $a_rec["Id"], (string) $new_profile->getId());
                break;
            ...
            case "skl_local_prof":
                ...
                $a_mapping->addMapping("components/ILIAS/Skill_", "skl_local_prof", $a_rec["Id"], (string) $new_profile->getId());
                break;

            case "skl_prof_level":
                $profile_id = (int) $a_mapping->getMapping("components/ILIAS/Skill_", "skl_prof", $a_rec["ProfileId"])
                    ? (int) $a_mapping->getMapping("components/ILIAS/Skill_", "skl_prof", $a_rec["ProfileId"])
                    : (int) $a_mapping->getMapping("components/ILIAS/Skill_", "skl_local_prof", $a_rec["ProfileId"]);
                if ($profile_id > 0) {
