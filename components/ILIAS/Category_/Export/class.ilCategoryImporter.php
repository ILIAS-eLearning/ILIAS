...
class ilCategoryImporter extends ilXmlImporter
{
    ...
    public function importXmlRepresentation(
        ...
        elseif ($new_id = $a_mapping->getMapping('components/ILIAS/Container_', 'refs', '0')) {
        ...
        foreach ($a_mapping->getMappingsOfEntity('components/ILIAS/Container_', 'objs') as $old => $new) {
    ...
    public function finalProcessing(
        ...
        foreach ($maps as $old => $new) {
            if ($old !== "new_id" && (int) $old > 0) {
                ...
                $new_tax_ids = $a_mapping->getMapping("components/ILIAS/Taxonomy_", "tax_usage_of_obj", (string) $old);
