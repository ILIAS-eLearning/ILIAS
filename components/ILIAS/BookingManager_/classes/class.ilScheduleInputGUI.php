...
class ilScheduleInputGUI extends ilFormPropertyGUI
{
    ...
    protected function render(
        ...
        $tpl = new ilTemplate("tpl.schedule_input.html", true, true, "components/ILIAS/BookingManager_");
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl->addJavascript("components/ILIAS/BookingManager_/js/ScheduleInput.js");
