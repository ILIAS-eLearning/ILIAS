...
- The Form component employs the following components, please consult the respective PRIVACY.md
  files:
    - [AccessControl](https://github.com/ILIAS-eLearning/ILIAS/blob/release_11/components/ILIAS/AccessControl/PRIVACY.md) — the location input element
    ...
    - FileUpload — the file input element (`ilFileInputGUI`) uses the
      FileUpload service for processing uploaded files.
    - HTTP — form elements use the HTTP service to read request parameters
      (POST and query values).
    - Refinery — form elements use the Refinery component for input
