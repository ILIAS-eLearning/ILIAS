...
class ilOnScreenChatGUI implements ilCtrlBaseClassInterface
{
    ...
    public static function initializeFrontend(ilGlobalTemplateInterface $page): void
    {
        ...
        if (!self::$frontend_initialized) {
            ...
            $chatWindowTemplate = new ilTemplate('tpl.chat-window.html', false, false, 'components/ILIAS/OnScreenChat_');
            ...
            $guiConfig = [
                ...
                'messageTemplate' => (new ilTemplate(
                    ...
                    false,
                    false,
                    'components/ILIAS/OnScreenChat_'
                ))->get(),
            ...
            $page->addJavascript('./components/ILIAS/UIComponent_/Modal/js/Modal.js');
            $page->addJavascript('./node_modules/moment/min/moment-with-locales.min.js');
            $page->addJavascript('./components/ILIAS/Notifications_/js/browser_notifications.js');
            $page->addJavascript('./components/ILIAS/OnScreenChat_/js/onscreenchat-notifications.js');
            $page->addJavascript('./components/ILIAS/OnScreenChat_/js/moment.js');
            $page->addJavascript('./components/ILIAS/Chatroom_/chat/node_modules/socket.io-client/dist/socket.io.js');
            $page->addJavascript('./components/ILIAS/OnScreenChat_/js/chat.js');
            $page->addJavascript('./components/ILIAS/OnScreenChat_/js/onscreenchat.js');
