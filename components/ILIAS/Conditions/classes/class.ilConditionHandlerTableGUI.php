...
class ilConditionHandlerTableGUI extends ilTable2GUI
{
    ...
    protected function fillRow(array $a_set): void
    {
        ...
        if (!$this->enable_editing) {
            ...
            $this->tpl->setVariable(
                'OBL_SRC',
                ilUtil::getImagePath($a_set['obligatory'] ? 'standard/icon_ok.svg' : 'standard/icon_not_ok.svg')
            );
            $this->tpl->setVariable(
                'OBL_ALT',
    ...
    protected function initTable(): void
    {
        ...
        $this->setRowTemplate('tpl.condition_handler_row.html', 'components/ILIAS/Conditions');
