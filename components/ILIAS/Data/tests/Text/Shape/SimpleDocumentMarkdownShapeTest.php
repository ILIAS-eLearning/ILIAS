...
use ILIAS\Data\Text\Shape\SimpleDocumentMarkdown;
...
{
    protected SimpleDocumentMarkdown $simple_doc_markdown_shape;
    ...
    protected function setUp(): void
    {
        ...
        $this->simple_doc_markdown_shape = new SimpleDocumentMarkdown(new \ILIAS\Refinery\String\MarkdownFormattingToHTML());
    }
