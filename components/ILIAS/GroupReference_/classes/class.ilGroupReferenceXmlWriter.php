...
include_once substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . '/components/ILIAS/ContainerReference_/classes/class.ilContainerReferenceXmlWriter.php';
...
class ilGroupReferenceXmlWriter extends ilContainerReferenceXmlWriter
{
    ...
    protected function buildHeader(): void
    {
        ...
        $this->xmlSetDtdDef("<!DOCTYPE course reference PUBLIC \"-//ILIAS//DTD Group//EN\" \"" . ILIAS_HTTP_PATH . "/components/ILIAS/Export_/xml/ilias_course_reference_4_3.dtd\">");
