...
class ilTextWizardInputGUI extends ilTextInputGUI
{
    ...
    {
        $tpl = new ilTemplate("tpl.prop_textwizardinput.html", true, true, "components/ILIAS/Form_");
        $i = 0;
        ...
        if (!$this->getDisabled()) {
            $this->tpl->addJavascript("./components/ILIAS/Form_/js/ServiceFormWizardInput.js");
            $this->tpl->addJavascript("./components/ILIAS/Form_/templates/default/textwizard.js");
        }
