...
class ilPropertyFormGUI extends ilFormGUI
{
    ...
    public function getContent(): string
    {
        ...
        $tpl->addJavaScript("./components/ILIAS/JavaScript_/js/Basic.js");
        $tpl->addJavaScript("components/ILIAS/Form_/js/Form.js");

        $this->tpl = new ilTemplate("tpl.property_form.html", true, true, "components/ILIAS/Form_");
    ...
    public function insertItem(
        ...
        if ($item instanceof ilMultiValuesItem && $item->getMulti()) {
            $tpl->addJavascript("./components/ILIAS/Form_/js/ServiceFormMulti.js");
