...
class ilHierarchyFormGUI extends ilFormGUI
{
    ...
    public function __construct()
    {
        ...
        $this->main_tpl->addJavascript("./components/ILIAS/Form_/js/ServiceFormHierarchyForm.js");
    ...
    public function getContent(): string
    {
        ...
        $ttpl = new ilTemplate("tpl.hierarchy_form.html", true, true, "components/ILIAS/Form_");
...
//        $this->diss_menues[$a_id][$a_group][] = array("type" => $a_type, "text" => $a_diss_text);
    ...
    public function getLegend(): string
    {
        ...
        $ttpl = new ilTemplate("tpl.hierarchy_form_legend.html", true, true, "components/ILIAS/Form_");
        if ($this->getDragIcon() != "") {
    ...
    public function getLevelHTML(
        ...
        $a_childs = $childs;
        $ttpl = new ilTemplate("tpl.hierarchy_form_nodes.html", true, true, "components/ILIAS/Form_");
