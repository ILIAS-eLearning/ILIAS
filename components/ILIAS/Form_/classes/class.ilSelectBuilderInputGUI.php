...
class ilSelectBuilderInputGUI extends ilTextWizardInputGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate("tpl.prop_selectbuilder.html", true, true, "components/ILIAS/Form_");
        $i = 0;
        ...
        $tpl->addJavascript("./components/ILIAS/Form_/templates/default/textwizard.js");
    }
}
