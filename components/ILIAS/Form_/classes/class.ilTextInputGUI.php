...
class ilTextInputGUI extends ilSubEnabledFormPropertyGUI implements ilTableFilterItem, ilToolbarItem, ilMultiValuesItem
{
    ...
    public function render(string $a_mode = ""): string
    {
        ...
        $tpl = new ilTemplate("tpl.prop_textinput.html", true, true, "components/ILIAS/Form_");
        ...
        if ($this->getDataSource()) {
            ...
            $jstpl = new ilTemplate("tpl.prop_text_autocomplete.js", true, true, "components/ILIAS/Form_");
