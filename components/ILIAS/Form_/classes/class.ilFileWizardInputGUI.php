...
class ilFileWizardInputGUI extends ilFileInputGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate("tpl.prop_filewizardinput.html", true, true, "components/ILIAS/Form_");
        ...
        $main_tpl = $this->tpl;
        $main_tpl->addJavascript("./components/ILIAS/Form_/js/ServiceFormWizardInput.js");
        $main_tpl->addJavascript("./components/ILIAS/Form_/templates/default/filewizard.js");
    }
}
