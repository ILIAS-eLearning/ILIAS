...
class ilImageFileInputGUI extends ilFileInputGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $i_tpl = new ilTemplate("tpl.prop_image_file.html", true, true, "components/ILIAS/Form_");
        ...
        if ($this->getAllowCapture()) {
            ...
            $main_tpl = $this->tpl;
            $main_tpl->addJavascript("./components/ILIAS/Form_/js/ServiceFormImageFileCapture.js");
        }
