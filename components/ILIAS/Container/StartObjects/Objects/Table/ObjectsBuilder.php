...
class ObjectsBuilder extends CommonTableBuilder
{
    ...
    {
        return "start_objs_" . $this->start_objects->getObjId();
    }

    protected function getTitle(): string
    {
        return $this->lng->txt('crs_start_objects');
    }

    protected function getRetrieval(): RetrievalInterface
    {
        return new ObjectsRetrieval($this->start_objects);
    }
    ...
    protected function build(TableAdapterGUI $table): TableAdapterGUI
    {
        return $table
            ...
            ->standardAction('askDeleteStarter', $this->lng->txt('remove'));
    }
}
