...
class ObjectsRetrieval implements RetrievalInterface
{
    use RetrievalBase;
    ...
    public function getData(
        ...
        foreach ($this->start_objects->getStartObjects() as $start_id => $item) {
            $data = [];
    ...
    public function count(
        ...
        return count($this->start_objects->getStartObjects());
    }
