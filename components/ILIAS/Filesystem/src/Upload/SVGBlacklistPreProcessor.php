...
use ILIAS\FileUpload\Processor\IsMimeTypeOrExtension;

/**
 * PreProcessor which checks SVGs for scripts and other malicious content.
 */
class SVGBlacklistPreProcessor implements PreProcessor
{
    ...
    {
        return $this->isMimeTypeOrExtension($metadata, self::SVG, [self::SVG_MIME_TYPE]);
    }
