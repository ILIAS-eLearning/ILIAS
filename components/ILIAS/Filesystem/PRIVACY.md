...
## General Information
- Components read and write files using the Filesystem.
- Components which use the Filesystem might store, present, delete or export personal data. This is specified in their respective PRIVACY.md.
