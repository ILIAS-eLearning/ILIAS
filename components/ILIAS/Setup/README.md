...
therefore can implement the [`getMigrations`](`components/ILIAS/Setup/src/Agent.php#L82`) method to
make these [`Migration`s](components/ILIAS/Setup/src/Migration.php) available in the setup.
