...
* [2. Database Update Steps Lifespan](#2-database-update-steps-lifespan)
* [3. Best Practices](#3-best-practices)
  * [3.1. Update steps for one major version](#31-update-steps-for-one-major-version)
    * [3.1.2. Example](#312-example)
  * [3.2. Update steps for multiple major versions](#32-update-steps-for-multiple-major-versions)
    * [3.2.1. Example](#321-example)
  * [3.3 Recommended Namespace Pattern](#33-recommended-namespace-pattern)
* [4. Removing Database Update Steps](#4-removing-database-update-steps)
...
will not be considered new by the Setup component, but we lose the safeguard against divergent step methods
