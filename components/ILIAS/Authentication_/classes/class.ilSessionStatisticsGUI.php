...
class ilSessionStatisticsGUI
{
    ...
    protected function renderCurrentBasics(): string
    {
        ...
        $left = new ilTemplate("tpl.session_statistics_left.html", true, true, "components/ILIAS/Authentication_");
    ...
    {
        $center = new ilTemplate("tpl.session_statistics_center.html", true, true, "components/ILIAS/Authentication_");
