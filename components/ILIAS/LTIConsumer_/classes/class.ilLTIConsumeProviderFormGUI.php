...
//        Abfrage ob Key und secret von Objekterstellern eingegeben werden soll
    ...
    public function getContentSelectionFrame($formaction): string
    {
        ...
        $template = new ilTemplate('tpl.lti_content_selection.html', true, true, "components/ILIAS/LTIConsumer_");
    ...
    public function getDynRegRequest(): string
    {
        ...
        $template = new ilTemplate('tpl.lti_dyn_reg_request.html', true, true, "components/ILIAS/LTIConsumer_");
