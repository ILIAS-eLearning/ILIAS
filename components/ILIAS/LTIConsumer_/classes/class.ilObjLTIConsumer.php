...
class ilObjLTIConsumer extends ilObject2
{
    ...
    public function buildLaunchParameters(ilCmiXapiUser $cmixUser, string $token, string $contextType, string $contextId, string $contextTitle, ?string $returnUrl = ''): array
    {
        ...
        $launch_vars = [
            ...
            "lis_outcome_service_url" => self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/result.php?client_id=" . CLIENT_ID,
            "role_scope_mentor" => ""
        ];
    ...
    public function buildLaunchParametersLTI13(ilCmiXapiUser $cmixUser, string $endpoint, string $clientId, int $deploymentId, string $nonce, string $contextType, string $contextId, string $contextTitle, ?string $returnUrl = ''): ?array
    {
        ...
        if ($this->getProvider()->isGradeSynchronization()) {
            ...
            $launch_vars['custom_lineitems_url'] = self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/ltiservices.php/gradeservice/" . $contextId . "/linetitems/";
    ...
    public static function getIliasHttpPath(): string
    {
        ...
        $uri = str_replace("components/ILIAS/LTIConsumer_", "", $uri);
    ...
    {
        return self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/ltiauth.php";
    }

    public static function getAccessTokenUrl(): string
    {
        return self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/ltitoken.php";
    }

    public static function getPublicKeysetUrl(): string
    {
        return self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/lticerts.php";
    }

    public static function getRegistrationUrl(): string
    {
        return self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/ltiregistration.php";
    }

    public static function getRegistrationStartUrl(): string
    {
        return self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/ltiregstart.php";
    }

    public static function getRegistrationEndUrl(): string
    {
        return self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/ltiregend.php";
    }

    public static function getOpenidConfigUrl(): string
    {
        return self::getIliasHttpPath() . "/components/ILIAS/LTIConsumer_/lticonfig.php";
    }
