...
class ilObjLTIConsumerGUI extends ilObject2GUI
{
    ...
    public function contentSelectionRequest(): void
    {
        ...
        if (!ilSession::has('lti13_login_data')) {
            ...
            $tplLogin = new ilTemplate("tpl.lti_initial_login.html", true, true, "components/ILIAS/LTIConsumer_");
            ...
            $tplContentSelection = new ilTemplate("tpl.lti_jwt_autosubmit.html", true, true, "components/ILIAS/LTIConsumer_");
    ...
    public function saveContentSelection(ilLTIConsumeProvider $provider, string $token): void
    {
        ...
        $template = new ilTemplate('tpl.lti_content_selection_finished.html', true, true, 'components/ILIAS/LTIConsumer_');
