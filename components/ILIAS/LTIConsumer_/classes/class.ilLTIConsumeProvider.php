 ...
 *
 * @package     components/ILIAS/LTIConsumer_
 */
class ilLTIConsumeProvider
{
    protected int $id = 0;
    ...
    // {
        // return ILIAS_HTTP_PATH . "/components/ILIAS/LTIConsumer_/ltiauth.php";
    // }

    // public function getAccessTokenUrl(): string
    // {
        // return ILIAS_HTTP_PATH . "/components/ILIAS/LTIConsumer_/ltitoken.php";
    // }

    // public function getPublicKeysetUrl(): string
    // {
        // return ILIAS_HTTP_PATH . "/components/ILIAS/LTIConsumer_/lticerts.php";
    // }
}
