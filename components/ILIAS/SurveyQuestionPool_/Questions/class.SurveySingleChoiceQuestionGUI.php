...
class SurveySingleChoiceQuestionGUI extends SurveyQuestionGUI
{
    ...
    public function getPrintView(
        ...
        $template = new ilTemplate("tpl.il_svy_qpl_sc_printview.html", true, true, "components/ILIAS/SurveyQuestionPool_");
    ...
    public function getWorkingForm(
        ...
        $template = new ilTemplate($template_file, true, true, "components/ILIAS/SurveyQuestionPool_");
