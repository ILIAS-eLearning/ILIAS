...
class ilSurveyQuestionsTableGUI extends ilTable2GUI
{
    ...
    public function __construct(
        ...
        $this->setRowTemplate("tpl.il_svy_qpl_questions_row.html", "components/ILIAS/SurveyQuestionPool_");
    ...
    protected function fillRow(array $a_set): void
    {
        ...
        if ($this->getEditable()) {
            ...
            $obligatory = "<img src=\"" . ilUtil::getImagePath("obligatory.png", "components/ILIAS/Survey_") .
