...
abstract class SurveyQuestionGUI
{
    ...
    public function preview(): void
    {
        ...
        $tpl = new ilTemplate("tpl.il_svy_qpl_preview.html", true, true, "components/ILIAS/SurveyQuestionPool_");
    ...
    protected function getMaterialOutput(): string
    {
        if (count($this->object->getMaterial())) {
            $template = new ilTemplate("tpl.il_svy_qpl_material.html", true, true, "components/ILIAS/SurveyQuestionPool_");
