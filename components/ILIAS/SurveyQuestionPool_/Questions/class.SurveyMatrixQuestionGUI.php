...
class SurveyMatrixQuestionGUI extends SurveyQuestionGUI
{
    ...
    public function getPrintView(
        ...
        $bordercolor = "#808080";
        $template = new ilTemplate("tpl.il_svy_qpl_matrix_printview.html", true, true, "components/ILIAS/SurveyQuestionPool_");
        ...
        $tplheaders = new ilTemplate("tpl.il_svy_out_matrix_columnheaders.html", true, true, "components/ILIAS/SurveyQuestionPool_");
        ...
        for ($i = 0; $i < $this->object->getRowCount(); $i++) {
            $rowobj = $this->object->getRow($i);
            $tplrow = new ilTemplate("tpl.il_svy_qpl_matrix_printview_row.html", true, true, "components/ILIAS/SurveyQuestionPool_");
            for ($j = 0; $j < $this->object->getColumnCount(); $j++) {
                $cat = $this->object->getColumn($j);
                if ($i === 0 && $j === 0) {
                    if ($this->object->getBipolarAdjective(0) !== '' && $this->object->getBipolarAdjective(1) !== '') {
    ...
    public function layout(): void
    {
        ...
        $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_svy_qpl_layout.html", "components/ILIAS/SurveyQuestionPool_");
    ...
    public function getLayoutRow(): string
    {
        ...
        $template = new ilTemplate("tpl.il_svy_out_matrix_layout.html", true, true, "components/ILIAS/SurveyQuestionPool_");
        if ($this->object->getBipolarAdjective(0) !== '' && $this->object->getBipolarAdjective(1) !== '') {
    ...
    public function getWorkingForm(
        ...
        $neutralstyle = "3px solid #808080";
        $bordercolor = "#808080";
        $template = new ilTemplate("tpl.il_svy_out_matrix.html", true, true, "components/ILIAS/SurveyQuestionPool_");
        ...
        for ($i = 0; $i < $this->object->getRowCount(); $i++) {
            $rowobj = $this->object->getRow($i);
            $tplrow = new ilTemplate("tpl.il_svy_out_matrix_row.html", true, true, "components/ILIAS/SurveyQuestionPool_");
            for ($j = 0; $j < $this->object->getColumnCount(); $j++) {
                $cat = $this->object->getColumn($j);
                if ($i === 0 && $j === 0) {
                    if ($this->object->getBipolarAdjective(0) !== '' && $this->object->getBipolarAdjective(1) !== '') {
