...
class SurveyMetricQuestionGUI extends SurveyQuestionGUI
{
    ...
    */
    public function getPrintView(
        ...
        $template = new ilTemplate("tpl.il_svy_qpl_metric_printview.html", true, true, "components/ILIAS/SurveyQuestionPool_");
    ...
    public function getWorkingForm(
        ...
        $template = new ilTemplate("tpl.il_svy_out_metric.html", true, true, "components/ILIAS/SurveyQuestionPool_");
