...
class SurveyQuestion
{
    ...
    public static function _includeClass(
        ...
        if (file_exists("./components/ILIAS/SurveyQuestionPool_/Questions/class." . $type . ".php")) {
            return true;
        } else {
            global $DIC;
    ...
    public static function _getQuestionTypeName(
        ...
        if (file_exists("./components/ILIAS/SurveyQuestionPool_/Questions/class." . $type_tag . ".php")) {
            $lng = $DIC->language();
