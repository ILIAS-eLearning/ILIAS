...
class ilMatrixRowWizardInputGUI extends ilTextInputGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate("tpl.prop_matrixrowwizardinput.html", true, true, "components/ILIAS/SurveyQuestionPool_");
        ...
        $tpl->addJavaScript("./components/ILIAS/SurveyQuestionPool_/js/matrixrowwizard.js");
    }
}
