...
class ilAwarenessGUI implements ilCtrlBaseClassInterface
{
    ...
    public function initJS(): void
    {
        $ilUser = $this->user;
        // init js
        $this->main_tpl->addJavaScript("./components/ILIAS/Awareness_/js/Awareness.js");
    ...
    public function getAwarenessList(bool $return = false): ?array
    {
        ...
        $tpl = new ilTemplate("tpl.awareness_list.html", true, true, "components/ILIAS/Awareness_");
