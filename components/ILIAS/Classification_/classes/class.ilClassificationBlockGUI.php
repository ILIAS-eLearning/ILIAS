...
//            $this->repo->unsetAll();
        ...
        $tpl->addJavaScript("components/ILIAS/Classification_/js/ilClassification.js");
    ...
    protected function getLegacyContent(): string
    {
        ...
        $overall_html = "";
        if (sizeof($html)) {
            $btpl = new ilTemplate("tpl.classification_block.html", true, true, "components/ILIAS/Classification_");
    ...
    protected function filterContainer(): void
    {
        ...
        $ltpl = new ilTemplate("tpl.classification_object_list.html", true, true, "components/ILIAS/Classification_");
