...
class ilContextSaml implements ilContextTemplate
{
    ...
    {
        if (strpos($httpPath, '/components/ILIAS/Saml_/lib/') !== false && strpos($httpPath, '/metadata.php') === false) {
            return substr($httpPath, 0, strpos($httpPath, '/components/ILIAS/Saml_/lib/'));
        }
