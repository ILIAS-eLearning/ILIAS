...
class ilAdvancedSearchGUI extends ilSearchBaseGUI
{
    ...
    public function showAdvMDSearch(): bool
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.advanced_adv_search.html', 'components/ILIAS/Search_');
    ...
    public function showSearch(): bool
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.advanced_search.html', 'components/ILIAS/Search_');
