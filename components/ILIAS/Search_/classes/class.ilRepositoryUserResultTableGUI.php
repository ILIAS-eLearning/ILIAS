...
class ilRepositoryUserResultTableGUI extends ilTable2GUI
{
    ...
    public function __construct($a_parent_obj, $a_parent_cmd, $a_admin_mode = false, $a_type = self::TYPE_STANDARD)
    {
        ...
        if ($this->getType() == self::TYPE_STANDARD) {
            $this->setRowTemplate("tpl.rep_search_usr_result_row.html", "components/ILIAS/Search_");
            ...
            $this->setRowTemplate("tpl.global_search_usr_result_row.html", "components/ILIAS/Search_");
    ...
    {
        $tpl = new ilTemplate('tpl.lucene_relevance.html', true, true, 'components/ILIAS/Search_');
