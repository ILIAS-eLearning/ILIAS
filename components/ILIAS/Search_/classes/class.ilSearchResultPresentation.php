...
class ilSearchResultPresentation
{
    ...
    */
    ...
    public function appendAdditionalInformation(
        ...
        $tpl = new ilTemplate('tpl.lucene_additional_information.html', true, true, 'components/ILIAS/Search_');
    ...
    protected function appendPath(int $a_ref_id): string
    {
        ...
        $tpl = new ilTemplate('tpl.lucene_path.html', true, true, 'components/ILIAS/Search_');
    ...
    protected function appendMorePathes(int $a_ref_id): string
    {
        ...
        $tpl = new ilTemplate('tpl.lucene_more_references.html', true, true, 'components/ILIAS/Search_');
