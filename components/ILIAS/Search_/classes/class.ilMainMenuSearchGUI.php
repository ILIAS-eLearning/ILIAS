...
class ilMainMenuSearchGUI
{
    ...
    public function __construct()
    {
        ...
        $DIC['tpl']->addJavascript('components/ILIAS/Search_/js/SearchMainMenu.js');
    ...
    public function getHTML(): string
    {
        ...
        $this->tpl = new ilTemplate('tpl.main_menu_search.html', true, true, 'components/ILIAS/Search_');
