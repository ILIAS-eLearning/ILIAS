...
class PrintProcessGUI
{
    ...
    public function getModalElements(
        ...
        $ui->mainTemplate()->addJavaScript("./components/ILIAS/Form_/js/Form.js");
    ...
    public function sendForm(): void
    {
        ...
        $tpl = new \ilTemplate("tpl.print_view_selection.html", true, true, "components/ILIAS/Export_/Print");
    ...
    public function renderPrintView(int $content_style_id = 0): string
    {
        ...
        $tpl = new \ilGlobalTemplate(
            ...
            true,
            true,
            "components/ILIAS/Export_/Print"
        );
