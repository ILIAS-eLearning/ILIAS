...
class ilImportContainer extends ilImport
{
    ...
    protected function createDummy(string $a_type): ilObject
    {
        ...
        $this->getMapping()->addMapping('components/ILIAS/Container_', 'objs', '0', (string) $new->getId());
        $this->getMapping()->addMapping('components/ILIAS/Container_', 'refs', '0', (string) $new->getRefId());
