...
class ilImport
{
    ...
    protected function doImportObject(
        ...
        $obj_map = $this->getMapping()->getMappingsOfEntity('components/ILIAS/Container_', 'objs');
        if (is_array($obj_map)) {
    ...
    public function processItemXml(
        ...
        if ($this->objDefinition->isRBACObject($a_entity) &&
            $this->getMapping()->getMapping('components/ILIAS/Container_', 'imported', $a_id)) {
        ...
        if ($this->objDefinition->isRBACObject($a_entity)) {
            $this->getMapping()->addMapping('components/ILIAS/Container_', 'imported', $a_id, '1');
        }
    }
}
