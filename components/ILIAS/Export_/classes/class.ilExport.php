...
class ilExport
{
     ...
     * @param string $a_comp component (e.g. "components/ILIAS/Glossary_")
    ...
    public static function _generateIndexFile(
        ...
        $f_tpl = new ilTemplate("tpl.export_list.html", true, true, "components/ILIAS/Export_");
     ...
     * @param string $a_target_release target release
     * @param string $a_component      component that exports (e.g. "components/ILIAS/Style_")
     * @return array success and info array
     */
    ...
    /**
     * Process exporter
     * @param string $a_comp           e.g. "components/ILIAS/Forum_"
    ...
    public function processExporter(
        ...
        $attribs = array("InstallationId" => IL_INST_ID,
                         ...
                         "xsi:schemaLocation" => "http://www.ilias.de/Services/Export/exp/4_1 " . ILIAS_HTTP_PATH . "/components/ILIAS/Export_/xml/ilias_export_4_1.xsd"
        );
        if ($sv["namespace"] != "" && $sv["xsd_file"] != "") {
            $attribs["xsi:schemaLocation"] .= " " . $sv["namespace"] . " " .
                ILIAS_HTTP_PATH . "/components/ILIAS/Export_/xml/" . $sv["xsd_file"];
            $attribs["xmlns"] = $sv["namespace"];
        }
        if ($sv["uses_dataset"]) {
            $attribs["xsi:schemaLocation"] .= " " .
                "http://www.ilias.de/Services/DataSet/ds/4_3 " . ILIAS_HTTP_PATH . "/components/ILIAS/Export_/xml/ilias_ds_4_3.xsd";
