...
class ilTestEvaluationGUI extends ilTestServiceGUI
{
    ...
    */
    public function eval_a()
    {
        ...
        $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_as_tst_eval_anonymous_aggregation.html", "components/ILIAS/Test_");
    ...
    */
    public function outParticipantsPassDetails()
    {
        ...
        $template = new ilTemplate("tpl.il_as_tst_pass_details_overview_participants.html", true, true, "components/ILIAS/Test_");
    ...
    public function outParticipantsResultsOverview()
    {
        ...
        $template = new ilTemplate("tpl.il_as_tst_pass_overview_participants.html", true, true, "components/ILIAS/Test_");
    ...
    public function outUserPassDetails(): void
    {
        ...
        $tpl = new ilTemplate('tpl.il_as_tst_pass_details_overview_participants.html', true, true, "components/ILIAS/Test_");
    ...
    public function outUserResultsOverview()
    {
        ...
        $templatehead = new ilTemplate("tpl.il_as_tst_results_participants.html", true, true, "components/ILIAS/Test_");
        $template = new ilTemplate("tpl.il_as_tst_results_participant.html", true, true, "components/ILIAS/Test_");
    ...
    public function outUserListOfAnswerPasses()
    {
        ...
        $template = new ilTemplate("tpl.il_as_tst_info_list_of_answers.html", true, true, "components/ILIAS/Test_");
    ...
    public function singleResults()
    {
        ...
        $counter = 0;
        $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_as_tst_eval_single_answers.html", "components/ILIAS/Test_");
    ...
    protected function prepareContentForPrint(string $question_title, string $question_content): string
    {
        ...
        $tpl->addCss(ilUtil::getStyleSheetLocation("output", "test_print.css", "components/ILIAS/Test_"), "print");
