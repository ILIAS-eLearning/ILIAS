...
abstract class ilTestPlayerAbstractGUI extends ilTestServiceGUI
{
    ...
    {
        $this->tpl->addBlockFile($this->getContentBlockName(), "adm_content", "tpl.il_as_tst_anonymous_code_presentation.html", "components/ILIAS/Test_");
    ...
    public function redirectAfterAutosaveCmd()
    {
        ...
        $this->tpl->addBlockFile($this->getContentBlockName(), "adm_content", "tpl.il_as_tst_redirect_autosave.html", "components/ILIAS/Test_");
    ...
    */
    ...
    {
        $template = new ilTemplate("tpl.il_as_tst_final_statement.html", true, true, "components/ILIAS/Test_");
    ...
    public function getKioskHead(): string
    {
         ...
         */
        $this->tpl->addCSS('components/ILIAS/Test_/templates/default/test_kiosk_header.css');
        //end of hack

        $template = new ilTemplate('tpl.il_as_tst_kiosk_head.html', true, true, 'components/ILIAS/Test_');
    ...
    */
    ...
    {
        $this->tpl->addBlockFile($this->getContentBlockName(), "adm_content", "tpl.il_as_tst_submit_answers_confirm.html", "components/ILIAS/Test_");
        $this->tpl->setCurrentBlock("adm_content");
    ...
    public function outProcessingTime(int $active_id): void
    {
        ...
        $template = new ilTemplate("tpl.workingtime.js", true, true, 'components/ILIAS/Test_');
    ...
    public function outQuestionSummaryCmd(
        ...
        if ($fullpage) {
            $this->tpl->addBlockFile($this->getContentBlockName(), "adm_content", "tpl.il_as_tst_question_summary.html", "components/ILIAS/Test_");
        }
    ...
    */
    ...
    {
        $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_as_tst_correct_solution.html", "components/ILIAS/Test_");
        ...
        if ($this->object->getShowSolutionAnswersOnly()) {
            $this->tpl->addCss(ilUtil::getStyleSheetLocation("output", "test_print_hide_content.css", "components/ILIAS/Test_"), "print");
        }
    ...
    */
    ...
    {
        $this->tpl->addBlockFile($this->getContentBlockName(), "adm_content", "tpl.il_as_tst_finish_list_of_answers.html", "components/ILIAS/Test_");
        ...
        foreach ($result_array as $question_data) {
            ...
            if (is_numeric($question)) {
                ...
                $template = new ilTemplate("tpl.il_as_qpl_question_printview.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    protected function populateHelperGuiContent($helperGui)
    {
        if ($this->object->getKioskMode()) {
            //$this->tpl->setBodyClass("kiosk");
            $this->tpl->hideFooter();
            $this->tpl->addBlockfile('CONTENT', 'adm_content', "tpl.il_as_tst_kiosk_mode_content.html", "components/ILIAS/Test_");
    ...
    protected function populateInstantResponseModal(assQuestionGUI $questionGui, $navUrl)
    {
        ...
        $tpl = new ilTemplate('tpl.tst_player_response_modal.html', true, true, 'components/ILIAS/Test_');
    ...
    {
        if ($this->object->getKioskMode()) {
            $this->tpl->addBlockfile($this->getContentBlockName(), 'content', "tpl.il_as_tst_kiosk_mode_content.html", "components/ILIAS/Test_");
    ...
    {
        $tpl = new ilTemplate('tpl.tst_player_confirmation_modal.html', true, true, 'components/ILIAS/Test_');
    ...
    protected function populateQuestionEditControl($questionGUI)
    {
        ...
        $this->tpl->addJavascript('./components/ILIAS/Test_/js/ilTestPlayerQuestionEditControl.js');
