...
class ilParticipantsTestResultsGUI
{
    ...
    protected function showUserResults($show_pass_details, $show_answers, $show_reached_points = false): void
    {
        ...
        if ($template instanceof ilTemplate) {
            ...
            $this->main_tpl->addCss(ilUtil::getStyleSheetLocation("output", "test_print.css", "components/ILIAS/Test_"), "print");
            if ($this->getTestObj()->getShowSolutionAnswersOnly()) {
                $this->main_tpl->addCss(ilUtil::getStyleSheetLocation("output", "test_print_hide_content.css", "components/ILIAS/Test_"), "print");
            }
        }
    }
    ...
    public function createUserResults(
        ...
        $template = new ilTemplate("tpl.il_as_tst_participants_result_output.html", true, true, "components/ILIAS/Test_");
