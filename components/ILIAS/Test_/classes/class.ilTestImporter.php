...
class ilTestImporter extends ilXmlImporter
{
    ...
    public function importXmlRepresentation(string $a_entity, string $a_id, string $a_xml, ilImportMapping $a_mapping): void
    {
        ...
        if ($new_id = (int) $a_mapping->getMapping('components/ILIAS/Container_', 'objs', $a_id)) {
            // container content
            ...
            // single object
            $new_id = (int) $a_mapping->getMapping('components/ILIAS/Test_', 'tst', 'new_id');
            $newObj = ilObjectFactory::getInstanceByObjId($new_id, false);
        ...
        if (@file_exists(ilSession::get("tst_import_results_file"))) {
            ...
            $results->setQuestionIdMapping($a_mapping->getMappingsOfEntity('components/ILIAS/Test_', 'quest'));
            $results->setSrcPoolDefIdMapping($a_mapping->getMappingsOfEntity('components/ILIAS/Test_', 'rnd_src_pool_def'));
        ...
        $a_mapping->addMapping("components/ILIAS/Test_", "tst", (string) $a_id, (string) $newObj->getId());
    }
    ...
    {
        $maps = $a_mapping->getMappingsOfEntity("components/ILIAS/Test_", "tst");
    ...
    protected function importQuestionSkillAssignments(ilImportMapping $mapping, ilObjTest $testOBJ, $xmlFile): ilAssQuestionSkillAssignmentList
    {
        ...
        $importer->setImportMappingComponent('components/ILIAS/Test_');
