...
class ilObjTestGUI extends ilObjectGUI implements ilCtrlBaseClassInterface
{
    ...
    */
    public function uploadTstObject()
    {
        ...
        $importVerificationTpl = new ilTemplate('tpl.tst_import_verification.html', true, true, 'components/ILIAS/Test_');
    ...
    */
    public function importVerifiedFileObject()
    {
        ...
        if (is_file(ilSession::get("tst_import_dir") . '/' . ilSession::get("tst_import_subdir") . "/manifest.xml")) {
            ...
            $map = $imp->getMapping();
            $map->addMapping('components/ILIAS/Test_', 'tst', 'new_id', (string) $newObj->getId());
            $imp->importObject($newObj, $fullPath, $fileName, 'tst', 'components/ILIAS/Test_', true);
        } else {
   ...
   */
    ...
    */
    ...
    public function questionsObject()
    {
        ...
        $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_as_tst_questions.html", "components/ILIAS/Test_");
    ...
    */
    public function printobject()
    {
        ...
        $this->getTabsManager()->getQuestionsSubTabs();
        $template = new ilTemplate("tpl.il_as_tst_print_test_confirm.html", true, true, "components/ILIAS/Test_");

        $template->setCurrentBlock("navigation_buttons");
        $template->setVariable("BUTTON_PRINT", $this->lng->txt("print"));
        $template->parseCurrentBlock();

        $this->tpl->addCss(ilUtil::getStyleSheetLocation("output", "test_print.css", "components/ILIAS/Test_"), "print");
