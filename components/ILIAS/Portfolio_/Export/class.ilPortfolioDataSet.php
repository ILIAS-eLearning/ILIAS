    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "prtt":
                ...
                $a_mapping->addMapping("components/ILIAS/Portfolio_", "prtt", $a_rec["Id"], $newObj->getId());
                $a_mapping->addMapping("components/ILIAS/Object_", "obj", $a_rec["Id"], $newObj->getId());
                break;

            case "portfolio_page":
                $prtt_id = (int) $a_mapping->getMapping("components/ILIAS/Portfolio_", "prtt", $a_rec["PortfolioId"]);
                if ($prtt_id) {
                    ...
                    $a_mapping->addMapping("components/ILIAS/COPage_", "pg", "prtt:" . $a_rec["Id"], "prtt:" . $newObj->getId());
                }
                break;
        }
    }
