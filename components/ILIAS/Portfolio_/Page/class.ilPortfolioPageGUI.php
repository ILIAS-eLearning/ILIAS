...
class ilPortfolioPageGUI extends ilPageObjectGUI
{
    ...
    protected function renderConsultationHours(
        ...
        $this->tpl->addCss(ilUtil::getStyleSheetLocation('filesystem', 'delos.css', 'components/ILIAS/Calendar_'));
    ...
    protected function renderMyCourses(
        ...
        if (count($data)) {
            ...
            $tpl = new ilTemplate("tpl.pc_my_courses.html", true, true, "components/ILIAS/Portfolio_");
            ...
            // #15508
            if (!self::$initialized) {
                $GLOBALS["tpl"]->addJavaScript("components/ILIAS/Portfolio_/js/ilPortfolio.js");
