...
class ilDBUpdateNewObjectType
{
     ...
     *
     * @deprecated use components/ILIAS/Object/classes/Setup/class.ilObjectNewTypeAddedObjective.php instead
     */
     ...
     *
     * @deprecated use components/ILIAS/AccessControl/classes/Setup/class.ilAccessRBACOperationsAddedObjective.php instead
     */
     ...
     *
     * @deprecated use components/ILIAS/AccessControl/classes/Setup/class.ilAccessRBACOperationDeletedObjective.php instead
     */
     ...
     *
     * @deprecated use components/ILIAS/AccessControl/classes/Setup/class.ilAccessCustomRBACOperationAddedObjective.php instead
     */
     ...
     *
     * @deprecated use components/ILIAS/AccessControl/classes/Setup/class.ilAccessRBACOperationOrderUpdatedObjective.php instead
     */
     ...
     *
     * @deprecated use components/ILIAS/Tree/classes/Setup/class.ilTreeAdminNodeAddedObjective.php instead
     */
    public static function addAdminNode(string $obj_type, string $title): void
    {
        ...
        // put in tree
        require_once("components/ILIAS/Tree/classes/class.ilTree.php");
     ...
     *
     * @deprecated use components/ILIAS/AccessControl/classes/Setup/class.ilAccessRBACOperationClonedObjective.php instead
     */
    ...
    /**
     * @deprecated use components/ILIAS/AccessControl/classes/Setup/class.ilAccessRolePermissionSetObjective.php instead
     */
     ...
     * @deprecated use components/ILIAS/AccessControl/classes/Setup/class.ilAccessInitialPermissionGuidelineAppliedObjective.php instead
     */
