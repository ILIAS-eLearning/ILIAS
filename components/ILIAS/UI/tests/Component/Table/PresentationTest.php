        ...
        <div class="il-table-presentation-row row collapsed" id="id_4">
            ...
            <div class="il-table-presentation-row-controls col-lg-auto col-sm-12">
                <div class="il-table-presentation-row-controls-expander inline">
                    <button class="btn btn-link" id="id_5"><span class="glyph" aria-label="expand_content" role="img"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></span></button>
                </div>
                <div class="il-table-presentation-row-controls-collapser">
                    <button class="btn btn-link" id="id_6"><span class="glyph" aria-label="collapse_content" role="img"><span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></span></button>
                </div>
            </div>
