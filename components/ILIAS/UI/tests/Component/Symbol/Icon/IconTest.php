...
imgtag;
    ...
    public function testHTMLInName(): void
    {
        ...
        $expected = '<img class="icon &lt;h1&gt;name&lt;/h1&gt; small" src="./assets/images/standard/icon_default.svg" alt="label"/>';
        $this->assertEquals($expected, $html);
    }
    ...
    public function testHTMLInLabel(): void
    {
        ...
        $html = $this->brutallyTrimHTML($this->getDefaultRenderer()->render($ico));
        $expected = '<img class="icon name small" src="./assets/images/standard/icon_default.svg" alt="&lt;h1&gt;label&lt;/h1&gt;"/>';
        $this->assertEquals($expected, $html);
    }
