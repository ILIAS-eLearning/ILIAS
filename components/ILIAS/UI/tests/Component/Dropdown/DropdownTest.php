...
EOT;
    ...
    public function testRenderItemsWithLabel(): void
    {
        ...
        $expected = <<<EOT
			<div class="dropdown" id="id_3"><button class="btn btn-default dropdown-toggle" type="button" aria-expanded="false" aria-controls="id_3_menu">label<span class="caret"></span></button>
				<ul id="id_3_menu" class="dropdown-menu">
					<li><button class="btn btn-link" data-action="https://www.ilias.de" id="id_1">ILIAS</button></li>
					<li><hr  /></li>
					<li><button class="btn btn-link" data-action="https://www.github.com" id="id_2">GitHub</button></li>
...
EOT;
    ...
    public function testRenderWithLinkNewViewport(): void
    {
        ...
        $expected = <<<EOT
			<div class="dropdown" id="id_1"><button class="btn btn-default dropdown-toggle" type="button" aria-label="actions" aria-expanded="false" aria-controls="id_1_menu"><span class="caret"></span></button>
...
EOT;
    ...
    public function testRenderItemsWithAriaLabel(): void
    {
        ...
        $expected = <<<EOT
			<div class="dropdown" id="id_3"><button class="btn btn-default dropdown-toggle" type="button" aria-label="my_aria_label" aria-expanded="false" aria-controls="id_3_menu">label<span class="caret"></span></button>
				<ul id="id_3_menu" class="dropdown-menu">
					<li><button class="btn btn-link" data-action="https://www.ilias.de" id="id_1">ILIAS</button></li>
					<li><hr  /></li>
					<li><button class="btn btn-link" data-action="https://www.github.com" id="id_2">GitHub</button></li>
