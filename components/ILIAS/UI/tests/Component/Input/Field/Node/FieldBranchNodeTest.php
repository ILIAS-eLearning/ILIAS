 ...
 */
class FieldBranchNodeTest extends \ILIAS_UI_TestBase
{
    ...
    public function testRenderWithChildren(): void
    {
        ...
        $expected = <<<HTML
<li data-node-id="$node_id" class="c-input-node c-input-node__branch c-drilldown__branch">
...
HTML;
    ...
    public function testRenderWithoutChildren(): void
    {
        ...
        $this->assertTrue(str_contains($this->brutallyTrimHTML($actual), "<ul></ul>"));
    }
