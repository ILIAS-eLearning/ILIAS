 ...
 */
class FieldLeafNodeTest extends \ILIAS_UI_TestBase
{
    ...
    public function testRender(): void
    {
        ...
        $component = $this->getNodeFactory()->leaf([$node_id], $node_name);
        $renderer = $this->getDefaultRenderer();

        $expected = <<<HTML
<li data-node-id="$node_id" class="c-input-node c-input-node__leaf c-drilldown__leaf">
    <p class="il-link link-bulky c-input-node__name" tabindex="0">
        $this->icon_html<span data-node-name>$node_name</span>
    </p>
...
HTML;
    ...
    protected function testRenderWithIcon(): void
    {
        ...
        $component = $this->getNodeFactory()->leaf([''], '');
    ...
    public function testRenderWithoutIcon(): void
    {
        ...
        $component = $this->getNodeFactory()->leaf([''], $node_name);
        $renderer = $this->getDefaultRenderer();
    ...
    protected function testConstructorWithValidNodePath(): void
    {
        ...
        $node = $this->getNodeFactory()->leaf($full_node_path, "");
