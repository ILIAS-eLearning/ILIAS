 ...
 */
class TreeSelectTest extends \ILIAS_UI_TestBase
{
    use NameSourceStubs;
...
HTML;
    ...
    public function testRenderDrilldownMenu(): void
    {
        ...
        $component = $this->getFieldFactory()->treeSelect($node_retrieval, $tree_select_label);
        $component = $component->withNameFrom($this->createFixedNameSourceStub($fixed_input_name));

        $renderer = $this->getDefaultRenderer(null, [$leaf_stub]);

        $expected_html = <<<HTML
<fieldset class="c-input" data-il-ui-component="tree-select-field-input" data-il-ui-input-name="$fixed_input_name">
