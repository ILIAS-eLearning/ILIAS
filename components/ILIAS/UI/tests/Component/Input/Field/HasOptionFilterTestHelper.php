...
trait HasOptionFilterTestHelper
{
    ...
    protected function testHasOptionFilter(I\Input\Field\HasOptionFilterInternal $component): void
    {
        ...
        $filter_after_nesting = $strip_ids_fn(parent::brutallyTrimHTML('<span class="message-no-match" style="display: none">ui_field_option_filter_no_match</span><span class="message-async-start-search" style="display: none">ui_field_option_filter_async_start_search</span></div></div><div class="c-input__help-byline">byline</div></fieldset>'));
