...
<div class="il-card thumbnail">
	<div class="il-card-repository-head">
		<div>
			<img class="icon crs medium" src="./assets/images/standard/icon_crs.svg" alt="Course" />
		</div>
		<div>
...
<div class="il-card thumbnail">
	...
	<div class="il-card-repository-head">
		...
		<div>
			<img class="icon cert medium" src="./assets/images/standard/icon_cert.svg" alt="Certificate" />
		</div>
		<div class="il-card-repository-dropdown">
