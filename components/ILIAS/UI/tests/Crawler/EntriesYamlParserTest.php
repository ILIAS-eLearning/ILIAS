...
include_once(substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . "/components/ILIAS/UI/tests/Crawler/Fixture/Fixture.php");
...
class CrawlerTest extends TestCase
{
    ...
    {
        $yaml_entries = $this->parser->parseYamlStringArrayFromFile("components/ILIAS/UI/tests/Crawler/Fixture/ProperEntry.php");
    ...
    {
        $entries = $this->parser->parseArrayFromFile("components/ILIAS/UI/tests/Crawler/Fixture/ProperEntry.php");
    ...
    {
        try {
            $this->parser->parseYamlStringArrayFromFile("components/ILIAS/UI/tests/Crawler/Fixture/NoDescriptionEntry.php");
            $this->assertFalse("This should not happen");
        } catch (Crawler\Exception\CrawlerException $e) {
    ...
    {
        try {
            $this->parser->parseYamlStringArrayFromFile("components/ILIAS/UI/tests/Crawler/Fixture/NoReturnValueEntry.php");
            $this->assertFalse("This should not happen");
        } catch (Crawler\Exception\CrawlerException $e) {
    ...
    {
        try {
            $this->parser->parseArrayFromFile("components/ILIAS/UI/tests/Crawler/Fixture/InvalidYamlEntry.php");
            $this->assertFalse("This should not happen");
        } catch (Crawler\Exception\CrawlerException $e) {
    ...
    {
        $entries = $this->parser->parseEntriesFromFile("components/ILIAS/UI/tests/Crawler/Fixture/ProperEntry.php");
