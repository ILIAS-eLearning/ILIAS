...
1. Add your new component into the respective factory interface. E.g. if you introduce a component of a completely new type, you MUST add the description to the main factory (components/ILIAS/UI/src/Factory.php). If you add a new type of button, you MUST add the description to the existing factory for buttons, located at components/ILIAS/UI/src/Component/Button/Factory.
...
3. This freshly added function in the factory leads to an error as soon as ILIAS is opened, since the implementation
 of the factory (located at components/ILIAS/UI/src/Implementation/Factory.php) does not implement that function yet. For
...
4. Next, you should think about the interface you would like to propose for this component.
 ...
 For the demo component, this interface could look as follows (located at (components/ILIAS/UI/src/Component/Demo/Demo.php):
    ``` php
...
6. Congratulations, at this point you are ready to present your work to the JF. Create
 ...
 components/ILIAS/UI/src/examples/Demo/mockup.php:
    ``` php
    <?php declare(strict_types=1)
    function mockup() {
    ...
    ```
   If needed, you can also add JS-logic (e.g. components/ILIAS/UI/src/examples/Demo/mockup.php):
    ``` php
    <?php declare(strict_types=1)
    function script() {
   ...
   look like:
    ...
    function mockup() {
	    global $DIC;
 	    ...
 	    $mockup = $f->image()->responsive("components/ILIAS/UI/src/examples/Demo/mockup.png");
...
8. Currently you will only get the NotImplementedException you threw previously. That needs to be changed.
  First, add an implementation for the new interface (add it at components/ILIAS/UI/src/Implementation/Component/Demo/Demo.php):
    ``` php
    <?php declare(strict_types=1)
    ...
    ```
9. Next, make the factory return the new component (change demo() of components/ILIAS/UI/src/Implementation/Factory.php):

    ``` php
    return new Component\Demo\Demo($content);
    ```

10. Then, implement the renderer at components/ILIAS/UI/src/Implementation/Component/Demo/Demo.php:
    ``` php
    <?php declare(strict_types=1)
    ...
    ```
11. Finally you need the template used to render your component. Create it at components/ILIAS/UI/src/templates/default/Demo/tpl.demo.html:
     ``` php
...
13. Remember to add examples demonstrating the usage of your new component.
    ...
    components/ILIAS/UI/src/examples/Demo/render.php):
    ``` php
      <?php declare(strict_types=1)
      function render() {
...
```
./node_modules/.bin/eslint --parser-options ecmaVersion:13 components/ILIAS/UI/src/templates/js/...
```
...
required. The [Renderer](https://github.com/ILIAS-eLearning/ILIAS/blob/trunk/components/ILIAS/UI/src/Renderer.php)
...
the case, whether you could achieve the same effect by using CSS. The class [FSLoader](components/ILIAS/UI/src/Implementation/Render/FSLoader.php)
