 ...
 * ---
 * description: >
 *   Example for rendring a angry glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome angry-smiley symbol on a grey background. Moving the cursor above the symbol will darken it's
