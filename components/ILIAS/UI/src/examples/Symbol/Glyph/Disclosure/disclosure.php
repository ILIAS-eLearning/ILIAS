 ...
 * ---
 * description: >
 *   Example for rendring a disclosure glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome three-points-on-top-of-each-other symbol on a grey background. Moving the cursor above the symbol will darken it's
