...
namespace ILIAS\UI\examples\Symbol\Glyph\Time;

/**
 * ---
 * description: >
 *   Example for rendring a time glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome clock symbol on a grey background. Moving the cursor above the symbol will darken it's
