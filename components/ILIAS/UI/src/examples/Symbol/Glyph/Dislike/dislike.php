...
namespace ILIAS\UI\examples\Symbol\Glyph\Dislike;

/**
 * ---
 * description: >
 *   Example for rendring a dislike glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome thumbs-down symbol on a grey background. Moving the cursor above the symbol will darken it's
