...
namespace ILIAS\UI\examples\Symbol\Glyph\Help;

/**
 * ---
 * description: >
 *   Example for rendring a help glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome questionmark symbol on a grey background. Moving the cursor above the symbol will darken it's
