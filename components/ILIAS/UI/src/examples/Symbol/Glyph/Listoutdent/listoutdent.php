 ...
 * ---
 * description: >
 *   Example for rendring a list outdent glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome outdent-list symbol on a grey background. Moving the cursor above the symbol will darken it's
