 ...
 *
 * expected output: >
 *   ILIAS shows the Tree Select Field inside a Standard Form. Its label and byline are
 ...
 *   Node as value. Clicking this Button will enable the Modals "Select" Button and disables all
 *   other Bulky Buttons to select Nodes. Clicking the same Bulky Button to unselect a Node again
 *   will reverse these two actions. If a Node is selected/choosen and the Modals "Select" Button
 *   is clicked, the Modal is closed and the Node-name will appear above the Fields "Select" Shy
 *   Button. Next to this name a Glyph is visible. Clicking this Glyph will remove the selected
 *   Node from above the Shy Button and will reverse the actions performed in the Modal, like when
 *   unselecting a Node inside the Modal again. If a Node is selected and the Form is submitted,
 *   the page is reloaded and the Node-id (<X>) will appear inside the output printed above the
 *   Form. The Field will display a "dummy leaf node <X>" now.
 * ---
 */
function base(): string
{
    ...
    $node_retrieval = new TreeSelectExampleNodeRetrieval($node_id_url_builder, $node_id_parameter);
