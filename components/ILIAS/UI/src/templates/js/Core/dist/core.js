...
(function (il, document) {
  ...
  class AsyncRenderer {
    ...
    #createElements(html) {
      ...
      newElement.querySelectorAll('script').forEach((oldScript) => {
        ...
        // oldScript.parentElement.appendChild(this.#restoreScript(oldScript));
        // oldScript.remove();
      });
  ...
  il__default["default"].UI.core.AsyncRenderer = new AsyncRenderer(il__default["default"].UI.core.HydrationRegistry, document__default["default"]);
