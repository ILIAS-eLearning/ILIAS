...
class ScheduleTableDeleteAction implements TableAction
{
    ...
    public function getModal(
        ...
        return $this->ui_factory->modal()->interruptive(
            ...
            array_map(fn(array $record) => $this->ui_factory->modal()->interruptiveItem()->standard(
    ...
    public function onSubmit(
        ...
        foreach ($selected_records as $record) {
            $schedule = new \ilBookingSchedule($record['booking_schedule_id']);
            $schedule->delete();
        }
    ...
    protected function resolveRecords(array $selected_ids): array
    {
        ...
        return array_filter(array_map(fn($id) => $schedules[$id] ?? null, $selected_ids));
    }
}
