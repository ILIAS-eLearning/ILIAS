...
{
    public const string ACTION_ID = 'edit_booking';

    public const string ACTION_LABEL = 'book_deassign';
    ...
    public function onExecute(
        ...
        $this->ctrl->setParameterByClass(
            ...
            'user_id',
            (int) $this->http->resolveRowParameter($row_id_token->getName())
        );
        $this->ctrl->redirectByClass(ilBookingReservationsGUI::class, 'log');
    ...
    {
        $user_data = ilBookingParticipant::getList(
            $this->pool_id,
            ['user_id' => $user_id]
        )["{$this->pool_id}_{$user_id}"] ?? null;
