...
class ilSingleChoiceWizardInputGUI extends ilTextInputGUI
{
    ...
    */
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate("tpl.prop_singlechoicewizardinput.html", true, true, "components/ILIAS/TestQuestionPool_");
        $i = 0;
        ...
        $tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/singlechoicewizard.js");
    }
}
