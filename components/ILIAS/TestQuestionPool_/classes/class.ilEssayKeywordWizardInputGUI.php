...
class ilEssayKeywordWizardInputGUI extends ilSingleChoiceWizardInputGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate("tpl.prop_essaykeywordswizardinput.html", true, true, "components/ILIAS/TestQuestionPool_");
        $i = 0;
        ...
        global $DIC;
        $tpl = $DIC['tpl'];
        $tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/answerwizardinput.js");
        $tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/essaykeywordwizard.js");
    }
}
