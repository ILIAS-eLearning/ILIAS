 ...
 * @version		$Id$
 *
 * @package     components/ILIAS/TestQuestionPool_
 */
class ilKprimChoiceWizardInputGUI extends ilSingleChoiceWizardInputGUI
{
    ...
    {
        $tpl = new ilTemplate("tpl.prop_kprimchoicewizardinput.html", true, true, "components/ILIAS/TestQuestionPool_");
        ...
        $this->tpl->addJavascript("components/ILIAS/TestQuestionPool_/templates/default/answerwizardinput.js");
        $this->tpl->addJavascript("components/ILIAS/TestQuestionPool_/templates/default/kprimchoicewizard.js");
        $this->tpl->addJavascript('components/ILIAS/TestQuestionPool_/js/ilAssKprimChoice.js');
    }
