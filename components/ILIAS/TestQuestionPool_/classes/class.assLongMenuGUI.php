...
class assLongMenuGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable
{
    ...
    public function populateQuestionSpecificFormPart(ilPropertyFormGUI $form): ilPropertyFormGUI
    {
        ...
        $tpl = new ilTemplate("tpl.il_as_qpl_longmenu_question_gap_button_code.html", true, true, "components/ILIAS/TestQuestionPool_");
        ...
        $this->tpl->addJavaScript('./components/ILIAS/TestQuestionPool_/templates/default/longMenuQuestionGapBuilder.js');
        $this->tpl->addJavaScript('./components/ILIAS/TestQuestionPool_/templates/default/longMenuQuestion.js');
        $tpl = new ilTemplate("tpl.il_as_qpl_longmenu_question_gap.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_longmenu_question_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
        ...
        $solution_template = new ilTemplate("tpl.il_as_tst_solution_output.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    {
        $template = new ilTemplate("tpl.il_as_qpl_longmenu_question_output.html", true, true, "components/ILIAS/TestQuestionPool_");
        $this->tpl->addJavaScript('./components/ILIAS/TestQuestionPool_/templates/default/longMenuQuestionPlayer.js');
    ...
    public function getAggregatedAnswersView(array $relevant_answers): string
    {
        ...
        $tpl = new ilTemplate('tpl.il_as_aggregated_longmenu_question_answers_table.html', true, true, "components/ILIAS/TestQuestionPool_");
    ...
    {
        $tpl = new ilTemplate("tpl.il_as_qpl_longmenu_question_text_gap.html", true, true, "components/ILIAS/TestQuestionPool_");
        if ($solution) {
    ...
    {
        $tpl = new ilTemplate("tpl.il_as_qpl_longmenu_question_select_gap.html", true, true, "components/ILIAS/TestQuestionPool_");
        $tpl->setVariable('KEY', $key);
        if ($solution) {
            $tpl->setVariable('DISABLED', 'disabled');
            $tpl->setVariable('JS_IGNORE', '_ignore');
