...
class ilObjQuestionPoolGUI extends ilObjectGUI implements ilCtrlBaseClassInterface
{
    ...
    */
    public function uploadQplObject($questions_only = false)
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.qpl_import_verification.html', 'components/ILIAS/TestQuestionPool_');
    ...
    public function importVerifiedFileObject(): void
    {
        ...
        if (is_string(ilSession::get("qpl_import_dir")) && is_string(ilSession::get("qpl_import_subdir")) && is_file(
            ...
            $map = $imp->getMapping();
            $map->addMapping('components/ILIAS/TestQuestionPool_', 'qpl', 'new_id', $newObj->getId());
            $imp->importObject($newObj, $fullPath, $fileName, 'qpl', 'components/ILIAS/TestQuestionPool_', true);
        } else {
