...
class ilClozeGapInputBuilderGUI extends ilSubEnabledFormPropertyGUI
{
    ...
    public function insert(ilTemplate $template): void
    {
        ...
        $DIC->ui()->mainTemplate()->addJavascript(
            './components/ILIAS/TestQuestionPool_/templates/default/clozeQuestionGapBuilder.js'
        );


        $custom_template = new ilTemplate('tpl.il_as_cloze_gap_builder.html', true, true, 'components/ILIAS/TestQuestionPool_');
