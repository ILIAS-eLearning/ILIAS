...
class ilAssQuestionSkillAssignmentsGUI
{
    ...
    private function showSkillSelectionCmd(): void
    {
        ...
        if (!$skillSelectorExplorerGUI->handleCommand()) {
            $tpl = new ilTemplate('tpl.qpl_qst_skl_assign_selection.html', false, false, 'components/ILIAS/TestQuestionPool_');
    ...
    {
        $this->tpl->addCss('components/ILIAS/COPage_/css/content.css');
