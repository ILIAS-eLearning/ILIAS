...
class assMatchingQuestionGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable, ilGuiAnswerScoringAdjustable
{
    ...
    */
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_matching_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
        $solutiontemplate = new ilTemplate("tpl.il_as_tst_solution_output.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function getPreview($show_question_only = false, $showInlineFeedback = false): string
    {
        ...
        $this->tpl->addJavaScript('components/ILIAS/TestQuestionPool_/js/ilMatchingQuestion.js');
        $this->tpl->addOnLoadCode('ilMatchingQuestionInit();');
        $this->tpl->addCss(ilUtil::getStyleSheetLocation('output', 'test_javascript.css', 'components/ILIAS/TestQuestionPool_'));

        $template = new ilTemplate("tpl.il_as_qpl_matching_output.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function getPresentationJavascripts(): array
    {
        ...
        $files[] = 'components/ILIAS/TestQuestionPool_/js/ilMatchingQuestion.js';
