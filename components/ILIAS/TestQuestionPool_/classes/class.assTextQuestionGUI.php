...
class assTextQuestionGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable, ilGuiAnswerScoringAdjustable
{
    ...
    */
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_text_question_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    */
    ...
    private function getBestAnswer($asHtml): string
    {
        ...
        $tpl = new ilTemplate($tplFile, true, true, 'components/ILIAS/TestQuestionPool_');
    ...
    {
        $template = new ilTemplate("tpl.il_as_qpl_text_question_output.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    {
        $tpl = new ilTemplate('tpl.charcounter.html', true, true, 'components/ILIAS/TestQuestionPool_');
