...
class ilMatchingWizardInputGUI extends ilTextInputGUI
{
    ...
    */
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $lng = $DIC['lng'];
        $global_tpl = $DIC['tpl'];
        $global_tpl->addJavascript('./components/ILIAS/TestQuestionPool_/templates/default/matchinginput.js');
        $global_tpl->addOnLoadCode('il.test.matchingquestion.init();');

        $tpl = new ilTemplate("tpl.prop_matchingwizardinput.html", true, true, "components/ILIAS/TestQuestionPool_");
        $i = 0;
