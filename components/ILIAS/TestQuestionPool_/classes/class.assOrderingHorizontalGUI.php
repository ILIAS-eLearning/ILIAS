...
class assOrderingHorizontalGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable
{
    ...
    */
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_orderinghorizontal_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function getPreview($show_question_only = false, $showInlineFeedback = false): string
    {
        ...
        $template = new ilTemplate("tpl.il_as_qpl_orderinghorizontal_preview.html", true, true, "components/ILIAS/TestQuestionPool_");
        $js = <<<JS
...
JS;
        ...
        $this->tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/orderinghorizontal.js");
    ...
    // hey.
    {
        ...
        $template = new ilTemplate("tpl.il_as_qpl_orderinghorizontal_output.html", true, true, "components/ILIAS/TestQuestionPool_");
        $js = <<<JS
    $().ready(function() {
