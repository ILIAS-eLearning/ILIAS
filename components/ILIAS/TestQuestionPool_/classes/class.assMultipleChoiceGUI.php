...
class assMultipleChoiceGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable, ilGuiAnswerScoringAdjustable
{
    ...
    */
    ...
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_mc_mr_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function getPreview($show_question_only = false, $showInlineFeedback = false): string
    {
        ...
        $template = new ilTemplate("tpl.il_as_qpl_mc_mr_output.html", true, true, "components/ILIAS/TestQuestionPool_");
        foreach ($keys as $answer_id) {
            $answer = $this->object->answers[$answer_id];
            if (strlen($answer->getImage())) {
                if ($this->object->getThumbSize()) {
    ...
    public function getTestOutput(
        ...
        $this->tpl->addJavaScript('components/ILIAS/TestQuestionPool_/js/ilAssMultipleChoice.js');
        $this->tpl->addOnLoadCode('ilAssMultipleChoiceCharCounterInit();');
    ...
    {
        return array('components/ILIAS/TestQuestionPool_/js/ilAssMultipleChoice.js');
    }
