...
class ilTestQuestionPoolImporter extends ilXmlImporter
{
    ...
    public function importXmlRepresentation(string $a_entity, string $a_id, string $a_xml, ilImportMapping $a_mapping): void
    {
        ...
        if (($new_id = $a_mapping->getMapping('components/ILIAS/Container_', 'objs', $a_id)) !== null) {
        ...
        } elseif (($new_id = $a_mapping->getMapping('components/ILIAS/TestQuestionPool_', 'qpl', "new_id")) !== null) {
            $newObj = ilObjectFactory::getInstanceByObjId($new_id, false);
        } else {
            // Shouldn't happen
        ...
        $a_mapping->addMapping("components/ILIAS/TestQuestionPool_", "qpl", $a_id, $newObj->getId());
    ...
    protected function importQuestionSkillAssignments($xmlFile, ilImportMapping $mappingRegistry, $targetParentObjId): void
    {
        ...
        $importer->setImportMappingComponent('components/ILIAS/TestQuestionPool_');
