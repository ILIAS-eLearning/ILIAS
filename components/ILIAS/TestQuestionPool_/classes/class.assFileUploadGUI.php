...
class assFileUploadGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable
{
    ...
    */
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_fileupload_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
        ...
        if (($active_id > 0) && (!$show_correct_solution)) {
            ...
            #);
            // hey.
            $table_gui->setRowTemplate("tpl.il_as_qpl_fileupload_file_view_row.html", "components/ILIAS/TestQuestionPool_");
    ...
    {
        $template = new ilTemplate("tpl.il_as_qpl_fileupload_output.html", true, true, "components/ILIAS/TestQuestionPool_");
