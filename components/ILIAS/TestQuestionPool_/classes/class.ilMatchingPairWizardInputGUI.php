...
class ilMatchingPairWizardInputGUI extends ilTextInputGUI
{
    ...
    */
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $lng = $DIC['lng'];
        $global_tpl = $DIC['tpl'];
        $global_tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/answerwizardinput.js");
        $global_tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/matchingpairwizard.js");

        $tpl = new ilTemplate("tpl.prop_matchingpairinput.html", true, true, "components/ILIAS/TestQuestionPool_");
        $i = 0;
