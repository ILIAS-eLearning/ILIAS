...
class assImagemapQuestionGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable, ilGuiAnswerScoringAdjustable
{
    ...
    */
    ...
    public function areaEditor($shape = ''): void
    {
        ...
        $editorTpl = new ilTemplate('tpl.il_as_qpl_imagemap_question.html', true, true, 'components/ILIAS/TestQuestionPool_');
    ...
    */
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_imagemap_question_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function getPreview($show_question_only = false, $showInlineFeedback = false): string
    {
        ...
        // generate the question output
        $template = new ilTemplate("tpl.il_as_qpl_imagemap_question_output.html", true, true, "components/ILIAS/TestQuestionPool_");
