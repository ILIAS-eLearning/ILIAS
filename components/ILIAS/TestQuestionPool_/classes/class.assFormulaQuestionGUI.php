...
class assFormulaQuestionGUI extends assQuestionGUI
{
    ...
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_formulaquestion_output_solution.html", true, true, 'components/ILIAS/TestQuestionPool_');
        $correctness_icons = [
    ...
    public function getPreview($show_question_only = false, $showInlineFeedback = false): string
    {
        ...
        $template = new ilTemplate("tpl.il_as_qpl_formulaquestion_output.html", true, true, 'components/ILIAS/TestQuestionPool_');
        if (is_object($this->getPreviewSession())) {
