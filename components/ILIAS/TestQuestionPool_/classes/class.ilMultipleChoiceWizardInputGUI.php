...
class ilMultipleChoiceWizardInputGUI extends ilSingleChoiceWizardInputGUI
{
    ...
    */
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate("tpl.prop_multiplechoicewizardinput.html", true, true, "components/ILIAS/TestQuestionPool_");
        $i = 0;
        ...
        $tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/multiplechoicewizard.js");
    }
