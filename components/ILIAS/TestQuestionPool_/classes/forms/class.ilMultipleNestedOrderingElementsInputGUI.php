...
abstract class ilMultipleNestedOrderingElementsInputGUI extends ilIdentifiedMultiValuesInputGUI
{
    ...
    {
        $this->setListTpl(
            new ilTemplate('tpl.prop_nested_ordering_list.html', true, true, 'components/ILIAS/TestQuestionPool_')
        );
    }
    ...
    protected function renderJsInit(): void
    {
        ...
        $this->global_tpl->addJavaScript('components/ILIAS/TestQuestionPool_/templates/default/nested_ordering.js');
    ...
    public function render(string $a_mode = ""): string
    {
        if ($this->isStylingEnabled()) {
            $this->getGlobalTpl()->addCss('components/ILIAS/Form_/css/nested_ordering.css');
        }
