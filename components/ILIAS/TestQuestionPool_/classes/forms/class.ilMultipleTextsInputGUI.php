...
abstract class ilMultipleTextsInputGUI extends ilIdentifiedMultiValuesInputGUI
{
    ...
    {
        $tpl = new ilTemplate("tpl.prop_multi_text_inp.html", true, true, "components/ILIAS/TestQuestionPool_");
        $i = 0;
        ...
        if (!$this->getDisabled()) {
            ...
            $this->tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/identifiedwizardinput.js");
