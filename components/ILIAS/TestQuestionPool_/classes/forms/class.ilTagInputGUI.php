...
class ilTagInputGUI extends ilSubEnabledFormPropertyGUI
{
    ...
    */
    public function __construct($a_title = "", $a_postvar = "")
    {
        ...
        $this->tpl->addJavaScript('./components/ILIAS/TestQuestionPool_/templates/default/bootstrap-tagsinput_2015_25_03.js');
        $this->tpl->addJavaScript('./components/ILIAS/TestQuestionPool_/templates/default/typeahead_0.11.1.js');
        $this->tpl->addCss('./components/ILIAS/TestQuestionPool_/templates/default/bootstrap-tagsinput_2015_25_03.css');
    }
    ...
    */
    ...
    {
        $this->tpl->addJavaScript('components/ILIAS/TestQuestionPool_/templates/default/tagInput.js');
        $config = [
        ...
        $tpl = new ilTemplate("tpl.prop_tag_typeahead.html", true, true, "components/ILIAS/TestQuestionPool_");
