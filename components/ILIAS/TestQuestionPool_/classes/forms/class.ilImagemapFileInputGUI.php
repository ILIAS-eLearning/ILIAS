...
class ilImagemapFileInputGUI extends ilImageFileInputGUI
{
    ...
    */
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $template = new ilTemplate("tpl.prop_imagemap_file.html", true, true, "components/ILIAS/TestQuestionPool_");
        ...
        $this->tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/imagemap.js");
    }
}
