...
class ilImagemapCorrectionsInputGUI extends ilImagemapFileInputGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $template = new ilTemplate("tpl.prop_imagemapquestioncorrection_input.html", true, true, "components/ILIAS/TestQuestionPool_");
        ...
        #$tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/imagemap.js");
    }
}
