...
class assErrorTextGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable, ilGuiAnswerScoringAdjustable
{
    ...
    */
    ...
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_errortext_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    {
        $template = new ilTemplate("tpl.il_as_qpl_errortext_output.html", true, true, "components/ILIAS/TestQuestionPool_");
        ...
        $this->tpl->addJavascript('./components/ILIAS/TestQuestionPool_/templates/default/errortext.js');
        $questionoutput = $template->get();
