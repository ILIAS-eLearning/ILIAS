...
class assKprimChoiceGUI extends assQuestionGUI implements ilGuiQuestionScoringAdjustable, ilGuiAnswerScoringAdjustable
{
    ...
    public function getTestOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_mc_kprim_output.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function getSolutionOutput(
        ...
        $template = new ilTemplate("tpl.il_as_qpl_mc_kprim_output_solution.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function renderAggregateView($aggregate): ilTemplate
    {
        ...
        $tpl = new ilTemplate('tpl.il_as_aggregated_kprim_answers_table.html', true, true, "components/ILIAS/TestQuestionPool_");
