...
abstract class assQuestionGUI
{
    ...
    public function getQuestionTemplate(): void
    {
        ...
        if (!$this->tpl->blockExists('content')) {
            $this->tpl->addBlockFile("CONTENT", "content", "tpl.il_as_qpl_content.html", "components/ILIAS/TestQuestionPool_");
        }
        ...
        if (!$this->tpl->blockExists('adm_content')) {
            $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_as_question.html", "components/ILIAS/TestQuestionPool_");
        }
    }
    ...
    {
        $tpl = new ilTemplate('tpl.tst_question_additional_behaviour_checkbox.html', true, true, 'components/ILIAS/TestQuestionPool_');
    ...
    public function originalSyncForm(string $return_to = "", string $return_to_feedback = ''): void
    {
        ...
        $template = new ilTemplate("tpl.il_as_qpl_sync_original.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function suggestedsolution(): void
    {
        ...
        if ($solution) {
            ...
            $template = new ilTemplate("tpl.il_as_qpl_suggested_solution_input_presentation.html", true, true, "components/ILIAS/TestQuestionPool_");
    ...
    public function outSolutionExplorer(): void
    {
        ...
        $template = new ilTemplate("tpl.il_as_qpl_explorer.html", true, true, "components/ILIAS/TestQuestionPool_");
