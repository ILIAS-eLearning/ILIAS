...
class ilAnswerWizardInputGUI extends ilTextInputGUI
{
    ...
    */
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate($this->getTemplate(), true, true, "components/ILIAS/TestQuestionPool_");
        $i = 0;
        ...
        $tpl->addJavascript("./components/ILIAS/TestQuestionPool_/templates/default/answerwizard.js");
    }
