...
class ilInitialisation
{
    ...
    protected static function requireCommonIncludes(): void
    {
        ...
        self::initGlobal("ilBench", "ilBenchmark", "./components/ILIAS/Utilities_/classes/class.ilBenchmark.php");
    }
    ...
    protected static function initSettings(): void
    {
        ...
        self::initGlobal(
            "ilSetting",
            "ilSetting",
            "components/ILIAS/Administration_/classes/class.ilSetting.php"
        );
    ...
    protected static function initStyle(): void
    {
        ...
        self::initGlobal(
            "styleDefinition",
            "ilStyleDefinition",
            "./components/ILIAS/Style_/System/classes/class.ilStyleDefinition.php"
        );
        ...
        foreach ($component_factory->getActivePluginsInSlot("uihk") as $ui_plugin) {
            ...
            $gui_class->modifyGUI("components/ILIAS/Init_", "init_style", array("styleDefinition" => $DIC->systemStyle()));
        }
    }
    ...
    protected static function initAccessHandling(): void
    {
        self::initGlobal(
            "rbacreview",
            "ilRbacReview",
            "./components/ILIAS/AccessControl_/classes/class.ilRbacReview.php"
        );
        ...
        self::initGlobal(
            "rbacadmin",
            "ilRbacAdmin",
            "./components/ILIAS/AccessControl_/classes/class.ilRbacAdmin.php"
        );

        self::initGlobal(
            "ilAccess",
            "ilAccess",
            "./components/ILIAS/AccessControl_/classes/class.ilAccess.php"
        );
    }
    ...
    protected static function initCore(): void
    {
        ...
        self::initGlobal(
            "ilErr",
            "ilErrorHandling",
            "./components/ILIAS/Init_/classes/class.ilErrorHandling.php"
        );
        ...
        // deprecated
        self::initGlobal("ilias", "ILIAS", "./components/ILIAS/Init_/classes/class.ilias.php");
    }
    ...
    protected static function initClient(): void
    {
        ...
        self::initGlobal(
            "ilAppEventHandler",
            "ilAppEventHandler",
            "./components/ILIAS/EventHandling_/classes/class.ilAppEventHandler.php"
        );
        ...
        if (!isset($DIC["ilPluginAdmin"]) || !$DIC["ilPluginAdmin"] instanceof ilPluginAdmin) {
            self::initGlobal(
                ...
                "./components/ILIAS/Component_/classes/class.ilPluginAdmin.php"
            );
        }
        self::initGlobal("https", "ilHTTPS", "./components/ILIAS/Http_/classes/class.ilHTTPS.php");
        self::initSettings();
        ...
        self::initGlobal(
            "ilObjDataCache",
            "ilObjectDataCache",
            "./components/ILIAS/Object_/classes/class.ilObjectDataCache.php"
        );

        self::initGlobal(
            "objDefinition",
            "ilObjectDefinition",
            "./components/ILIAS/Object_/classes/class.ilObjectDefinition.php"
        );
    ...
    protected static function initUser(): void
    {
        ...
        self::initGlobal(
            ...
            "./components/ILIAS/User_/classes/class.ilObjUser.php"
        );
...
//        $c->globalScreen()->tool()->context()->current()->addAdditionalData('DEVMODE', (bool) DEVMODE);
    ...
    protected static function initHTML(): void
    {
        ...
        self::initGlobal(
            "ilNavigationHistory",
            "ilNavigationHistory",
            "components/ILIAS/Navigation_/classes/class.ilNavigationHistory.php"
        );

        self::initGlobal(
            "ilHelp",
            "ilHelpGUI",
            "components/ILIAS/Help_/classes/class.ilHelpGUI.php"
        );
        ...
        self::initGlobal(
            "ilToolbar",
            "ilToolbarGUI",
            "./components/ILIAS/UIComponent_/Toolbar/classes/class.ilToolbarGUI.php"
        );

        self::initGlobal(
            "ilLocator",
            "ilLocatorGUI",
            "./components/ILIAS/Locator_/classes/class.ilLocatorGUI.php"
        );

        self::initGlobal(
            "ilTabs",
            "ilTabsGUI",
            "./components/ILIAS/UIComponent_/Tabs/classes/class.ilTabsGUI.php"
        );
        ...
        if (ilContext::hasUser()) {
            ...
            self::initGlobal("lti", "ilLTIViewGUI", "./components/ILIAS/LTI_/classes/class.ilLTIViewGUI.php");
