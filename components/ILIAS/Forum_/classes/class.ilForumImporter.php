...
class ilForumImporter extends ilXmlImporter implements ilForumObjectConstants
{
    ...
    public function importXmlRepresentation(string $a_entity, string $a_id, string $a_xml, ilImportMapping $a_mapping): void
    {
        ...
        $a_mapping->addMapping('components/ILIAS/Forum_', 'frm', $a_id, (string) $newObj->getId());
    }
    ...
    public function finalProcessing(ilImportMapping $a_mapping): void
    {
        ...
        $copaMap = $a_mapping->getMappingsOfEntity('components/ILIAS/COPage_', 'pg');
        ...
        $styleMapping = $a_mapping->getMappingsOfEntity('components/ILIAS/Forum_', 'style');
        foreach ($styleMapping as $newForumId => $oldStyleId) {
            $newStyleId = (int) $a_mapping->getMapping('components/ILIAS/Style_', 'sty', $oldStyleId);
