...
class ilNotificationOSDGUI
{
    ...
    public function populatePage(): void
    {
        ...
        $osdTemplate = new ilTemplate('tpl.osd_notifications.js', true, true, 'components/ILIAS/Notifications_');
        ...
        $this->page->addJavaScript('components/ILIAS/Notifications_/templates/default/notifications.js');
        $this->page->addCSS('components/ILIAS/Notifications_/templates/default/osd.css');
