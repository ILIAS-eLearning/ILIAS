...
class exQuestionPoolImporter extends ilXmlImporter
{
    ...
    public function finalProcessing(ilImportMapping $a_mapping): void
    {
        ...
        $maps = $a_mapping->getMappingsOfEntity("components/ILIAS/TestQuestionPool_", "qpl");

        foreach ($maps as $old => $new) {
            if ($old != "new_id" && (int) $old > 0) {
                $newQstIds = $a_mapping->getMapping("components/ILIAS/AssessmentQuestion_", "qst", $old);
                ...
                $qstMappings = $a_mapping->getMappingsOfEntity('components/ILIAS/AssessmentQuestion_', 'qst');
