    ...
    public function view(): void
    {
        ...
        if ($id_ref != "") {
            ...
            if ($resource->getHref() != "") {
                ...
                $this->tpl = new ilGlobalTemplate("tpl.scorm_content_frameset.html", true, true, "components/ILIAS/ScormAicc_");
        ...
        $this->tpl->addBlockFile("CONTENT", "content", "tpl.scorm_obj.html", "components/ILIAS/ScormAicc_");
