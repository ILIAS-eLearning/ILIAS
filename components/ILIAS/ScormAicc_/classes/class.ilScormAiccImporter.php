...
class ilScormAiccImporter extends ilXmlImporter
{
    ...
    public function importXmlRepresentation(string $a_entity, string $a_id, string $a_import_dirname, ?ilImportMapping $a_mapping): void
    {
        ...
        //        }
        // case i container
        if ($a_id !== "" && $a_mapping !== null && $new_id = $a_mapping->getMapping('components/ILIAS/Container_', 'objs', $a_id)) {
            ...
            if (file_exists($manifestFile)) {
                ...
                if (isset($manifest)) {
                    ...
                    if (isset($xml)) {
                        ...
                        if ($a_id != null && $new_id = $a_mapping->getMapping('components/ILIAS/Container_', 'objs', $a_id)) {
