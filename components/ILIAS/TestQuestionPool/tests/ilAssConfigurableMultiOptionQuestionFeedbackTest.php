...
*/
class ilAssConfigurableMultiOptionQuestionFeedbackTest extends assBaseTestCase
{
    protected $backupGlobals = false;

    private ilAssConfigurableMultiOptionQuestionFeedback $object;
    ...
    {
        $this->assertInstanceOf(ilAssConfigurableMultiOptionQuestionFeedback::class, $this->object);
    }
}