...
*/
class ilAssLacAbstractManufacturerTest extends assBaseTestCase
{
    protected $backupGlobals = false;

    private ilAssLacAbstractManufacturer $object;
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new class($ilAssLacAbstractComposite) extends ilAssLacAbstractManufacturer{
            ...
            {
                return $this->ilAssLacAbstractComposite;
            }
    ...
    {
        $this->assertInstanceOf(ilAssLacAbstractManufacturer::class, $this->object);
    }
}