...
class ilContainerSelectionExplorer extends ilExplorer
{
    ...
    public function formatHeader(ilTemplate $tpl, $a_obj_id, array $a_option): void
    {
        ...
        $tpl = new ilTemplate("tpl.tree.html", true, true, "components/ILIAS/UIComponent_/Explorer");// TODO PHP8-REVIEW Why is this overwritten? Are you sure this is correct?
