...
class ilHelpGUI implements ilCtrlBaseClassInterface
{
    ...
    public function showHelp(): void
    {
        ...
        if ($oh_lm_id > 0) {
            ...
            $h_tpl = new ilTemplate("tpl.help.html", true, true, "components/ILIAS/Help_");
    ...
    public function initHelp(
        ...
        $a_tpl->addJavaScript("./components/ILIAS/Help_/js/ilHelp.js");
        $a_tpl->addJavaScript("./components/ILIAS/Accordion_/js/accordion.js");
