...
class ilPageLayout
{
    public const SEQ_TEMPLATE_DIR = './components/ILIAS/Scorm2004_/templates/editor/page_layouts_temp/thumbnails';
    ...
    {
        return "./components/ILIAS/COPage_/Layout/xml/layout2html.xsl";
    }
