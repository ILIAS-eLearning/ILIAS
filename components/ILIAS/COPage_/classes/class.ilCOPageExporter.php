...
class ilCOPageExporter extends ilXmlExporter
{
    ...
    public function init(): void
    {
        ...
        $this->config = $this->getExport()->getConfig("components/ILIAS/COPage_");
    ...
    public function getXmlExportHeadDependencies(
        ...
        if ($a_entity == "pg") {
            ...
            return array(
                array(
                    "component" => "components/ILIAS/MediaObjects_",
                    "entity" => "mob",
                    "ids" => $mob_ids),
                array(
                    "component" => "components/ILIAS/File_",
                    "entity" => "file",
                    "ids" => $file_ids)
                );
        }
    ...
    public function getXmlExportTailDependencies(
        ...
        if ($a_entity == "pgtp") {
            ...
            return array(
                array(
                    "component" => "components/ILIAS/COPage_",
                    "entity" => "pg",
                    "ids" => $pg_ids)
                );
        }
