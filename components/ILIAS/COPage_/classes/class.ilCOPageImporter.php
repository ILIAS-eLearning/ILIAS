...
class ilCOPageImporter extends ilXmlImporter
{
    ...
    public function init(): void
    {
        ...
        $this->config = $this->getImport()->getConfig("components/ILIAS/COPage_");
    ...
    public function importXmlRepresentation(
        ...
        if ($a_entity == "pg") {
            $pg_id = $a_mapping->getMapping("components/ILIAS/COPage_", "pg", $a_id);
            ...
            if ($pg_id != "") {
                ...
                if (count($id) == 2) {
                    while (substr($a_xml, 0, 11) == "<PageObject") {
                        ...
                        $a_mapping->addMapping("components/ILIAS/COPage_", "pgl", $a_id . ":" . $lstr, $pg_id . ":" . $lstr);
                    }
                }
            }
        }
    ...
    public function finalProcessing(
        ...
        $pages = $a_mapping->getMappingsOfEntity("components/ILIAS/COPage_", "pgl");
        $media_objects = $a_mapping->getMappingsOfEntity("components/ILIAS/MediaObjects_", "mob");
        $file_objects = $a_mapping->getMappingsOfEntity("components/ILIAS/File_", "file");

        $ref_mapping = $a_mapping->getMappingsOfEntity('components/ILIAS/Container_', 'refs');
