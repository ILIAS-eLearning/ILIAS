...
class ilPCQuestion extends ilPageContent
{
    ...
    public function getJavascriptFiles(string $a_mode): array
    {
        ...
        if ($this->getPage()->getPageConfig()->getEnableSelfAssessment()) {
            $js_files[] = "./components/ILIAS/Scorm2004_/scripts/questions/pure.js";
            $js_files[] = "./components/ILIAS/Scorm2004_/scripts/questions/question_handling.js";
            $js_files[] = 'components/ILIAS/TestQuestionPool_/js/ilAssMultipleChoice.js';
            $js_files[] = "components/ILIAS/TestQuestionPool_/js/ilMatchingQuestion.js";
        ...
        if (!$this->getPage()->getPageConfig()->getEnableSelfAssessmentScorm() && $a_mode != ilPageObjectGUI::PREVIEW
            && $a_mode != "offline") {
            $js_files[] = "./components/ILIAS/COPage_/js/ilCOPageQuestionHandler.js";
        }
    ...
    {
        if ($this->getPage()->getPageConfig()->getEnableSelfAssessment()) {
            return array("./components/ILIAS/Scorm2004_/templates/default/question_handling.css",
                "components/ILIAS/TestQuestionPool_/templates/default/test_javascript.css");
        }
        return array();
    }
