...
class ilCOPageHTMLExport
{
    ...
    public function exportStyles(): void
    {
        ...
        if ($this->getContentStyleId() < 1) {     // basic style
            ...
            ilFileUtils::makeDirParents($this->exp_dir . "/components/ILIAS/COPage_/css");
            copy("components/ILIAS/COPage_/css/content.css", $this->exp_dir . "/components/ILIAS/COPage_/css/content.css");
        } else {
    ...
    protected function initResourceTemplate(
        ...
        $tpl = new ilGlobalTemplate($template_file, true, true, "components/ILIAS/COPage_");
