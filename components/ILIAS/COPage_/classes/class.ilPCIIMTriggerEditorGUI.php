...
class ilPCIIMTriggerEditorGUI extends ilPCImageMapEditorGUI
{
    public function __construct(
        ...
        $this->main_tpl->addJavaScript("./components/ILIAS/COPage_/js/ilCOPagePres.js");
        $this->main_tpl->addJavaScript("./components/ILIAS/COPage_/js/ilCOPagePCInteractiveImage.js");
