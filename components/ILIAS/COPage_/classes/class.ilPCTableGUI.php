...
class ilPCTableGUI extends ilPageContentGUI
{
    ...
    public function editCellWidth(): void
    {
        ...
        $ctpl = new ilTemplate("tpl.table_cell_properties.html", true, true, "components/ILIAS/COPage_");
    ...
    public function getEditDataTable(bool $initial = false): string
    {
        ...
        $dtpl = new ilTemplate("tpl.tabledata2.html", true, true, "components/ILIAS/COPage_");
