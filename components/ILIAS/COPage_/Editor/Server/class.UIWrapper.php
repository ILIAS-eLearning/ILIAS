...
class UIWrapper
{
    ...
    public function getRenderedButtonGroups(array $groups): string
    {
        ...
        $tpl = new \ilTemplate("tpl.editor_button_group.html", true, true, "components/ILIAS/COPage_");
    ...
    public function getRenderedFormFooter(array $buttons): string
    {
        ...
        $tpl = new \ilTemplate("tpl.form_footer.html", true, true, "components/ILIAS/COPage_");
