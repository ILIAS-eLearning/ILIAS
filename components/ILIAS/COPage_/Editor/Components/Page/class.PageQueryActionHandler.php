...
class PageQueryActionHandler implements Server\QueryActionHandler
{
    ...
    protected function getConfig(): \stdClass
    {
        ...
        $config->content_css =
            ...
            "./components/ILIAS/COPage_/css/tiny_extra.css";
    ...
    protected function getPageEditHelp(): string
    {
        ...
        $tpl = new \ilTemplate("tpl.page_edit_help.html", true, true, "components/ILIAS/COPage_/Editor");
    ...
    protected function getTopActions(): string
    {
        ...
        $lng = $this->lng;
        $lng->loadLanguageModule("content");
        $tpl = new \ilTemplate("tpl.top_actions.html", true, true, "components/ILIAS/COPage_/Editor");
    ...
    protected function getFormatSelection(): string
    {
        $lng = $this->lng;
        $ui = $this->ui;
        $tpl = new \ilTemplate("tpl.format_selection.html", true, true, "components/ILIAS/COPage_/Editor");
