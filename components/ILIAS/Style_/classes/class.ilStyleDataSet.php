    ...
    public function importRecord(string $a_entity, array $a_types, array $a_rec, ilImportMapping $a_mapping, string $a_schema_version): void
    {
        ...
        switch ($a_entity) {
            case "sty":
                ...
                $a_mapping->addMapping("components/ILIAS/Style_", "sty", $a_rec["Id"], $newObj->getId());
                $a_mapping->addMapping("components/ILIAS/Object_", "obj", $a_rec["Id"], $newObj->getId());
                $this->log->debug("Added mapping components/ILIAS/Style_ sty  " . $a_rec["Id"] . " > " . $newObj->getId());
            ...
            case "sty_parameter":
                $mq_id = (int) $a_mapping->getMapping("components/ILIAS/Style_", "media_query", $a_rec["MqId"]);
            ...
            case "sty_media_query":
                ...
                $a_mapping->addMapping("components/ILIAS/Style_", "media_query", $a_rec["Id"], $mq_id);
                break;

            case "sty_template":
                $tid = $this->current_obj->addTemplate($a_rec["TempType"], $a_rec["Name"], array());
                $a_mapping->addMapping("components/ILIAS/Style_", "template", $a_rec["Id"], $tid);
                break;

            case "sty_template_class":
                $tid = (int) $a_mapping->getMapping("components/ILIAS/Style_", "template", $a_rec["TemplateId"]);
                $this->current_obj->addTemplateClass($tid, $a_rec["ClassType"], $a_rec["Class"]);
                break;

            case "sty_usage":
                $obj_id = (int) $a_mapping->getMapping("components/ILIAS/Object_", "obj", $a_rec["ObjId"]);
                $style_id = (int) $a_mapping->getMapping("components/ILIAS/Style_", "sty", $a_rec["StyleId"]);
