...
class ilSystemStylesTableGUI extends ilTable2GUI
{
    ...
    public function __construct(object $a_parent_obj, string $a_parent_cmd = '')
    {
        ...
        $this->setRowTemplate('tpl.sys_styles_row.html', 'components/ILIAS/Style_/System');
    ...
    public function addActions($management_enabled, bool $read_documentation = true)
    {
        ...
        $this->setRowTemplate('tpl.sys_styles_row_with_actions.html', 'components/ILIAS/Style_/System');
        ...
        if ($this->isWithActions()) {
            ...
            if ($a_set['skin_id'] == 'other') {
                ...
                if ($this->isReadDocumentation()) {
                    $this->ctrl->setParameterByClass('ilSystemStyleDocumentationGUI', 'skin_id', $a_set['skin_id']);
                    $this->ctrl->setParameterByClass('ilSystemStyleDocumentationGUI', 'style_id', $a_set['style_id']);
