...
class ilSystemStyleDocumentationGUI
{
    ...
    public const DATA_PATH = './components/ILIAS/Style_/System/data/data.php';
    public const ROOT_FACTORY_PATH = './components/ILIAS/Style_/System/data/abstractDataFactory.php';
