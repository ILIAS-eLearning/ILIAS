...
class ilBackgroundPositionInputGUI extends ilFormPropertyGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $layout_tpl = new ilTemplate("tpl.prop_hv_layout.html", true, true, "components/ILIAS/Style_/Content");

        foreach ($this->dirs as $dir) {
            $value = "";
            $current_unit = "";
            $tpl = new ilTemplate("tpl.prop_background_position.html", true, true, "components/ILIAS/Style_/Content");
