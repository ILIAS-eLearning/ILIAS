...
class ilTRBLNumericStyleValueInputGUI extends ilFormPropertyGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $value = "";
        $layout_tpl = new ilTemplate("tpl.prop_trbl_layout.html", true, true, "components/ILIAS/Style_/Content");

        foreach ($this->dirs as $dir) {
            $tpl = new ilTemplate("tpl.prop_trbl_style_numeric.html", true, true, "components/ILIAS/Style_/Content");
