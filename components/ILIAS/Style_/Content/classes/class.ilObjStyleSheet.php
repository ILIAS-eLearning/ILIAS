    ...
    */
    ...
    public static function getContentStylePath(
        ...
        if ($a_style_id > 0 && ilObject::_exists($a_style_id)) {
            ...
            return "./components/ILIAS/COPage_/css/content.css";
        }
    }

    public static function getContentPrintStyle(): string
    {
        return "./components/ILIAS/COPage_/css/print_content.css";
    }

    public static function getSyntaxStylePath(): string
    {
        return "./components/ILIAS/COPage_/css/syntaxhighlight.css";
    }

    public static function getPlaceHolderStylePath(): string
    {
        return "./components/ILIAS/COPage_/css/placeholder.css";
    }
    ...
    /**
     * This is more or less a copy of components/ILIAS/Migration_/DBUpdate_1385/classes
