...
class ilServicesStyleSuite extends TestSuite
{
    public static function suite()
    {
        ...
        include_once("./components/ILIAS/Style_/System/test/ilServicesStyleSystemSuite.php");
        include_once("./components/ILIAS/Style_/Content/test/ilServicesStyleContentSuite.php");
