...
class ilRatingGUI
{
    ...
    */
    ...
    protected function renderDetails(
        ...
        $ttpl = new ilTemplate("tpl.rating_details.html", true, true, "components/ILIAS/Rating_");
    ...
    public function getHTML(
        ...
        $ttpl = new ilTemplate("tpl.rating_input.html", true, true, "components/ILIAS/Rating_");
