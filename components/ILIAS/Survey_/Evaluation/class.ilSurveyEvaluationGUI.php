...
class ilSurveyEvaluationGUI
{
    ...
    public function checkAnonymizedEvaluationAccess(): bool
    {
        ...
        if ($this->object->getAnonymize() === 1) {
            ...
            $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_svy_svy_evaluation_checkaccess.html", "components/ILIAS/Survey_");
    ...
    public function evaluation(
        ...
        $eval_tpl = new ilTemplate("tpl.il_svy_svy_evaluation.html", true, true, "components/ILIAS/Survey_");
        ...
        if (!$this->object->get360Mode() || $appr_id) {
            if ($details) {
                ...
                $dtmpl = new ilTemplate("tpl.il_svy_svy_results_details.html", true, true, "components/ILIAS/Survey_/Evaluation");
                $toc_tpl = new ilTemplate("tpl.svy_results_table_contents.html", true, true, "components/ILIAS/Survey_/Evaluation");
