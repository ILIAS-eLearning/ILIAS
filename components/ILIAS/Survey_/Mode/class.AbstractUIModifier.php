...
abstract class AbstractUIModifier implements UIModifier
{
    ...
    public function getDetailPanels(
        ...
        $a_tpl = new \ilTemplate("tpl.svy_results_details_panel.html", true, true, "components/ILIAS/Survey_/Evaluation");
    ...
    protected function getPanelTable(
        ...
        $a_tpl = new \ilTemplate("tpl.svy_results_details_table.html", true, true, "components/ILIAS/Survey_/Evaluation");
    ...
    protected function getPanelChart(
        ...
        $a_tpl = new \ilTemplate("tpl.svy_results_details_chart.html", true, true, "components/ILIAS/Survey_/Evaluation");
        // chart
    ...
    protected function getPanelText(
        ...
        $a_tpl = new \ilTemplate("tpl.svy_results_details_text.html", true, true, "components/ILIAS/Survey_/Evaluation");
