...
class ilSurveyExecutionGUI
{
    ...
    public function outSurveyPage(
        ...
        if (is_null($page) && $direction === -1) {
            ...
            $required = false;
            //$this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.il_svy_svy_content.html", "components/ILIAS/Survey_");
            $stpl = new ilTemplate("tpl.il_svy_svy_content.html", true, true, "components/ILIAS/Survey_");
