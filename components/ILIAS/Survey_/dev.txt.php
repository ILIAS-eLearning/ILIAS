...
- components/ILIAS/SurveyQuestionPool_/classes/class.SurveySingleChoiceQuestionGUI.php
- components/ILIAS/SurveyQuestionPool_/classes/class.SurveyMultipleChoiceQuestionGUI.php
- components/ILIAS/SurveyQuestionPool_/classes/class.SurveyMatrixQuestionGUI.php

Not affected:
- components/ILIAS/SurveyQuestionPool_/classes/class.SurveySingleChoiceQuestion.php
- components/ILIAS/SurveyQuestionPool_/classes/class.SurveyMultipleChoiceQuestion.php
- components/ILIAS/SurveyQuestionPool_/classes/class.SurveyMatrixQuestion.php
...
* table svy_question  (What is the difference between tstamp and created?)
    ...
    * questiontext:
    * label:
    INSERT: components/ILIAS/SurveyQuestionPool_/classes/class.SurveyQuestion.php - saveToDb
    UPDATE: components/ILIAS/SurveyQuestionPool_/classes/class.SurveyQuestion.php - saveToDb
    DELETE: components/ILIAS/SurveyQuestionPool_/classes/class.SurveyQuestion.php - delete
    UPDATE: components/ILIAS/SurveyQuestionPool_/classes/class.SurveyQuestion.php - delete
    UPDATE: components/ILIAS/SurveyQuestionPool_/classes/class.SurveyQuestion.php - _changeOriginalId
    INSERT: components/ILIAS/SurveyQuestionPool_/classes/class.SurveyQuestion.php - createNewQuestion
    UPDATE: components/ILIAS/SurveyQuestionPool_/classes/class.SurveyQuestion.php - saveCompletionStatus
    UPDATE: components/ILIAS/Survey_/classes/class.ilObjSurvey.php - setObligatoryStates
    UPDATE: components/ILIAS/SurveyQuestionPool_/classes/class.ilObjSurveyQuestionPool.php - setObligatoryStates
