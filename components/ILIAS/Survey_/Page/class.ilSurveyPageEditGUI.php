...
//                $ilToolbar->addSeparator();
    ...
    protected function renderPage(): void
    {
        ...
        if ($pages) {
            $ttpl = new ilTemplate("tpl.il_svy_svy_page_view.html", true, true, "components/ILIAS/Survey_");
            ...
            if (!$read_only) {
                 ...
                 * I removed a line $tpl->addJavascript("./components/ILIAS/RTE_/tiny_mce_.../tiny_mce_src.js"); at the end
            ...
            $tpl->addJavaScript("./components/ILIAS/Survey_/js/SurveyPageView.js");
        }
    }
    ...
    public function getPageNodes(
        ...
        $ttpl = new ilTemplate("tpl.il_svy_svy_page_view_nodes.html", true, true, "components/ILIAS/Survey_");
