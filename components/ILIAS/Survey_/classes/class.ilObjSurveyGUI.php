...
class ilObjSurveyGUI extends ilObjectGUI implements ilCtrlBaseClassInterface
{
    ...
    public function executeCommand(): void
    {
        ...
        //$this->tpl->addCss(ilUtil::getStyleSheetLocation("output", "survey.css", "components/ILIAS/Survey_"), "screen");
        $this->prepareOutput();
    ...
    */
    ...
    public function getUserResultsTable(
        ...
        $rtpl = new ilTemplate("tpl.svy_view_user_results.html", true, true, "components/ILIAS/Survey_");
