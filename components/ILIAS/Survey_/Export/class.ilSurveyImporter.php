...
class ilSurveyImporter extends ilXmlImporter
{
    ...
    public function importXmlRepresentation(
        ...
        if ($a_entity === "svy") {
            ...
            if (!($new_id = $a_mapping->getMapping('components/ILIAS/Container_', 'objs', $a_id))) {    // case ii, non container
                $new_id = $a_mapping->getMapping("components/ILIAS/Survey_", "svy", 0);
            }
            ...
            $GLOBALS['ilLog']->write("getQuestionPoolID = " . $this->getImport()->getConfig("components/ILIAS/Survey_")->getQuestionPoolID());

            $import = new SurveyImportParser(
                $this->getImport()->getConfig("components/ILIAS/Survey_")->getQuestionPoolID(),
                $xml_file,
                true,
                $a_mapping
            );
            ...
            // this is "written" by components/ILIAS/Survey_/classes/class.ilSurveyImportParser
            ...
            $a_mapping->addMapping("components/ILIAS/Survey_", "svy", (int) $a_id, $newObj->getId());
        } else {
