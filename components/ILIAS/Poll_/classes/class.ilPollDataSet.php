...
class ilPollDataSet extends ilDataSet
{
    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "poll":
                // container copy
                if ($new_id = $a_mapping->getMapping("components/ILIAS/Container_", "objs", (string) ($a_rec["Id"] ?? "0"))) {
                ...
                $a_mapping->addMapping("components/ILIAS/Poll_", "poll", (string) ($a_rec["Id"] ?? "0"), (string) $newObj->getId());
                break;

            case "poll_answer":
                $poll_id = (int) $a_mapping->getMapping("components/ILIAS/Poll_", "poll", (string) ($a_rec["PollId"] ?? "0"));
                if ($poll_id) {
