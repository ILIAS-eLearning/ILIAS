...
class UploadGUI
{
    public const string ACTION_SAVE_ADD_DOCUMENT_FORM = 'saveAddDocumentForm';
    public const string ACTION_SAVE_EDIT_DOCUMENT_FORM = 'saveEditDocumentForm';
    ...
    protected function showDocuments(): void
    {
        ...
        $uri_builder = new UriBuilder($this->http->request(), new Config());

        $document_tbl_gui = new DocumentTableGUI(
            $this,
            $uri_builder,
            'showDocuments',
            $this->ui_factory,
        ...
        $document_tbl_gui->setProvider(
            new TableDataProvider($this->mount_instructions_repository)
        );
    ...
    protected function getDocumentForm(Document $a_document): DocumentFormGUI
    {
    ...
    protected function showAddDocumentForm(): void
    {
        ...
        $form = $this->getDocumentForm(new Document());
