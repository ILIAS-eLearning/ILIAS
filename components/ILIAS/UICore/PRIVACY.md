...
* Component: for plugin information and UI-Hook plugin manipulations
* DI: for the global dependency injection container
* [File](../File/PRIVACY.md): for rendering file-upload dropzones
* [GlobalScreen](../GlobalScreen/PRICACY.md): for page layout modifications, JavaScript and CSS resources
...
* Refinery: to fetch request information and transform it
* Setup: to provide a build objective
