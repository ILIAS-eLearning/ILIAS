...
return [
    'ilctrlbaseclass1testgui' => [
        ...
        ilCtrlStructureInterface::KEY_CLASS_PATH => './components/ILIAS/UICore/tests/Data/GUI/class.ilCtrlBaseClass1TestGUI.php',
    ...
    'ilctrlbaseclass2testgui' => [
        ...
        ilCtrlStructureInterface::KEY_CLASS_PATH => './components/ILIAS/UICore/tests/Data/GUI/class.ilCtrlBaseClass2TestGUI.php',
        ilCtrlStructureInterface::KEY_CLASS_PARENTS => [
            'ilctrlcommandclass1testgui'
        ],
        ilCtrlStructureInterface::KEY_CLASS_CHILDREN => [
    ...
    'ilctrlcommandclass1testgui' => [
        ...
        ilCtrlStructureInterface::KEY_CLASS_PATH => './components/ILIAS/UICore/tests/Data/GUI/class.ilCtrlCommandClass1TestGUI.php',
        ilCtrlStructureInterface::KEY_CLASS_PARENTS => [
            'ilctrlbaseclass1testgui',
            'ilctrlbaseclass2testgui',
        ],
    ...
    'ilctrlcommandclass2testgui' => [
        ...
        ilCtrlStructureInterface::KEY_CLASS_PATH => './components/ILIAS/UICore/tests/Data/GUI/class.ilCtrlCommandClass2TestGUI.php',
        ilCtrlStructureInterface::KEY_CLASS_PARENTS => [
            'ilctrlcommandclass1testgui',
        ],
        ilCtrlStructureInterface::KEY_CLASS_CHILDREN => [],
    ...
    'ilias\\tests\\ctrl\\ilctrlnamespacedtestgui' => [
        ...
        ilCtrlStructureInterface::KEY_CLASS_PATH => './components/ILIAS/UICore/tests/Data/GUI/class.ilCtrlNamespacedTestGUI.php',
        ilCtrlStructureInterface::KEY_CLASS_PARENTS => [
            'ilctrlbaseclass1testgui',
        ],
        ilCtrlStructureInterface::KEY_CLASS_CHILDREN => [],
