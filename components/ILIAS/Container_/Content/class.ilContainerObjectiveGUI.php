...
class ilContainerObjectiveGUI extends ilContainerContentGUI
{
    ...
    public function getMainContent(): string
    {
        ...
        $tpl = new ilTemplate("tpl.container_page.html", true, true, "components/ILIAS/Container_");
    ...
    public function showStatus(): void
    {
        ...
        $info_tpl = new ilTemplate('tpl.crs_objectives_view_info_table.html', true, true, 'components/ILIAS/Course_');
    ...
    public static function renderProgressBar(
        ...
        $tpl = new ilTemplate("tpl.objective_progressbar.html", true, true, "components/ILIAS/Container_");
    ...
    public static function renderProgressMeter(
        ...
        $tpl = new ilTemplate("tpl.objective_progressmeter.html", true, true, "components/ILIAS/Container_");
    ...
    protected function buildAccordionTitle(
        ...
        $tpl = new ilTemplate("tpl.objective_accordion_title.html", true, true, "components/ILIAS/Container_");
    ...
    {
        $tpl = new ilTemplate("tpl.objective_accordion_content.html", true, true, "components/ILIAS/Container_");
