...
class ilContainerImporter extends ilXmlImporter
{
    ...
    public function finalProcessing(ilImportMapping $a_mapping): void
    {
        ...
        // pages
        $page_map = $a_mapping->getMappingsOfEntity('components/ILIAS/COPage_', 'pg');
        foreach ($page_map as $old_pg_id => $new_pg_id) {
            ...
            $new_obj_id = $a_mapping->getMapping('components/ILIAS/Container_', 'objs', $old_obj_id);
        ...
        // skills
        $crs_map = $a_mapping->getMappingsOfEntity('components/ILIAS/Course_', 'crs');
        ...
        $skl_local_prof_map = $a_mapping->getMappingsOfEntity('components/ILIAS/Skill_', 'skl_local_prof');
    ...
    protected function handleOfflineStatus(string $xml, ilImportMapping $mapping): void
    {
        ...
        foreach ($root->xpath('//Item') as $item) {
            ...
            $new_ref_id = $mapping->getMapping('components/ILIAS/Container_', 'refs', $ref_id);
