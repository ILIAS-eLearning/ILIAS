...
class ilMailSearchGUI
{
    ...
    public function showResults(): void
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.mail_search.html', 'components/ILIAS/Contact_');
        ...
        if (count($relations) > 0) {
            ...
            $tbl_contacts->setRowTemplate('tpl.mail_search_addr_row.html', 'components/ILIAS/Contact_');
        ...
        if ($users !== []) {
            ...
            $tbl_users->setRowTemplate('tpl.mail_search_users_row.html', 'components/ILIAS/Contact_');
        ...
        if ($group_results->getResults()) {
            ...
            $tbl_grp->setRowTemplate('tpl.mail_search_groups_row.html', 'components/ILIAS/Contact_');
