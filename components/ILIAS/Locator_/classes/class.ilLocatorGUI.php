...
class ilLocatorGUI
{
    ...
    public function getHTML(): string
    {
        ...
        if ($this->getTextOnly()) {
            $loc_tpl = new ilTemplate("tpl.locator_text_only.html", true, true, "components/ILIAS/Locator_");
        } else {
            $loc_tpl = new ilTemplate("tpl.locator.html", true, true, "components/ILIAS/Locator_");
        }
