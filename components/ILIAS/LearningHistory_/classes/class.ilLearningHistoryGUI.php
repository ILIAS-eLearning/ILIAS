...
class ilLearningHistoryGUI
{
    ...
    public function __construct()
    {
        ...
        $this->main_tpl->addJavaScript("./components/ILIAS/LearningHistory_/js/LearningHistory.js");
        $this->http = $DIC->http();
    }
    ...
    protected function getHistoryHtml(
        ...
        $tpl = new ilTemplate("tpl.timeline.html", true, true, "components/ILIAS/LearningHistory_");
