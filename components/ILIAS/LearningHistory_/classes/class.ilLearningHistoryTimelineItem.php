...
class ilLearningHistoryTimelineItem implements ilTimelineItemInt
{
    ...
    public function render(): string
    {
        ...
        $tpl = new ilTemplate("tpl.timeline_item_inner.html", true, true, "components/ILIAS/LearningHistory_");
    ...
    {
        $tpl = new ilTemplate("tpl.emphasized_title.php", true, true, "components/ILIAS/LearningHistory_");
