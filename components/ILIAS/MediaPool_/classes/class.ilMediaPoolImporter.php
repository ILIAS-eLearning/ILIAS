...
class ilMediaPoolImporter extends ilXmlImporter
{
    ...
    public function init(): void
    {
        ...
        $this->config = $this->getImport()->getConfig("components/ILIAS/MediaPool_");
        if ($this->config->getTranslationImportMode()) {
            ...
            $mob_config = $this->getImport()->getConfig("components/ILIAS/MediaObjects_");
    ...
    public function finalProcessing(
        ...
        $pg_map = $a_mapping->getMappingsOfEntity("components/ILIAS/MediaPool_", "pg");
