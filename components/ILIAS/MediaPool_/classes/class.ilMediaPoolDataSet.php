    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "mep":
                ...
                $a_mapping->addMapping("components/ILIAS/MediaPool_", "mep", $a_rec["Id"], $newObj->getId());
            ...
            case "mep_tree":
                if (!$this->getTranslationImportMode()) {
                    switch ($a_rec["Type"]) {
                        case "fold":
                            $parent = (int) $a_mapping->getMapping("components/ILIAS/MediaPool_", "mep_tree", $a_rec["Parent"]);
                            $fold_id =
                        ...
                        case "mob":
                            $parent = (int) $a_mapping->getMapping("components/ILIAS/MediaPool_", "mep_tree", $a_rec["Parent"]);
                            $mob_id = (int) $a_mapping->getMapping("components/ILIAS/MediaObjects_", "mob", $a_rec["ForeignId"]);
                        ...
                        case "pg":
                            ...
                            $item->setImportId($a_rec["ImportId"]);
                            $item->create();
                            $a_mapping->addMapping("components/ILIAS/MediaPool_", "pg", $a_rec["Child"], $item->getId());
                            $a_mapping->addMapping(
                    ...
                    if ($imp_id[0] === "il" &&
                        ...
                        if ($pool == $this->getTranslationMep()->getId()) {
                            $a_mapping->addMapping("components/ILIAS/MediaPool_", "pg", $a_rec["Child"], $pg_id);
                            $a_mapping->addMapping(
                                "components/ILIAS/COPage_",
                                "pg",
                                "mep:" . $a_rec["Child"],
