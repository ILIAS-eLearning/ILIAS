...
class ilObjMediaPoolGUI extends ilObject2GUI
{
    ...
    public function showPage(): void
    {
        ...
        $tpl = new ilGlobalTemplate("tpl.fullscreen.html", true, true, "components/ILIAS/COPage_");
    ...
    {
        include_once(substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . "/components/ILIAS/MediaPool_/classes/class.ilMediaPoolPageGUI.php");
    ...
    public static function getPreviewModalHTML(
        ...
        $tpl->addJavaScript("./components/ILIAS/MediaPool_/js/ilMediaPool.js");
