...
class ilMediaPoolTableGUI extends ilTable2GUI
{
    ...
    public function __construct(
        ...
        $this->setRowTemplate("tpl.mep_list_row.html", "components/ILIAS/MediaPool_");
    ...
    public function render(): string
    {
        ...
        $mtpl = new ilTemplate("tpl.media_sel_table.html", true, true, "components/ILIAS/MediaPool_");
