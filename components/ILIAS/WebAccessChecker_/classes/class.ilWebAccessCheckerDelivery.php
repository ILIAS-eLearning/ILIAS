...
class ilWebAccessCheckerDelivery
{
    ...
    {
        $ilFileDelivery = new Delivery('./components/ILIAS/WebAccessChecker_/templates/images/access_denied.png', $this->http);
    ...
    {
        $ilFileDelivery = new Delivery('./components/ILIAS/WebAccessChecker_/templates/images/access_denied.mp4', $this->http);
        $ilFileDelivery->setDisposition($this->wac->getDisposition());
