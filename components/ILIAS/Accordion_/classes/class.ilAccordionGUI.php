...
class ilAccordionGUI
{
    ...
    */
    ...
    {
        return array(
            "./components/ILIAS/Accordion_/js/accordion.js",
    ...
    {
        return array(
            "./components/ILIAS/Accordion_/css/accordion.css",
    ...
    public function getHTML(bool $async = false): string
    {
        ...
        $tpl = new ilTemplate("tpl.accordion.html", true, true, "components/ILIAS/Accordion_");
