...
class ilCmiXapiImporter extends ilXmlImporter
{
    ...
    public function importXmlRepresentation(string $a_entity, string $a_id, string $a_xml, ilImportMapping $a_mapping): void
    {
        ...
        if (false === ($this->_newId = $a_mapping->getMapping('components/ILIAS/Container_', 'objs', (string) $this->_import_objId))) {
    ...
    private function prepareSingleObject(): self
    {
        ...
        $this->_mapping->addMapping('components/ILIAS/CmiXapi_', 'cmix', (string) $this->_import_objId, (string) $this->_newId);
        //$this->getImport();
    ...
    {
        if ($this->_newId = $this->_mapping->getMapping('components/ILIAS/Container_', 'objs', (string) $this->_import_objId)) {
            // container content
            ...
            $this->_mapping->addMapping("components/ILIAS/CmiXapi_", "cmix", (string) $this->_import_objId, $this->_newId);
        }
        $this->_cmixObj->save();
        $this->_cmixObj->update();
    }
