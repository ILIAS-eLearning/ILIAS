    ...
    */
    public static function initDatabase(): void
    {
        if (!isset($GLOBALS['ilDB'])) {
            parent::initGlobal("ilBench", "ilBenchmark", "./components/ILIAS/Utilities_/classes/class.ilBenchmark.php");
            parent::initDatabase();
        }
    }
    ...
    */
    ...
    public static function initLog(): void
    {
        if (!isset($GLOBALS['ilLog'])) {
            parent::initLog();
            parent::initGlobal("ilAppEventHandler", "ilAppEventHandler", "./components/ILIAS/EventHandling_/classes/class.ilAppEventHandler.php");
        }
    }
}
