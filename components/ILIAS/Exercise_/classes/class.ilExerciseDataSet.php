    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "exc":
                ...
                $a_mapping->addMapping("components/ILIAS/Exercise_", "exc", $a_rec["Id"], $newObj->getId());
                $a_mapping->addMapping('components/ILIAS/Object_', 'objs', $a_rec['Id'], $newObj->getId());
                $a_mapping->addMapping('components/ILIAS/AdvancedMetaData_', 'parent', $a_rec['Id'], $newObj->getId());
                $a_mapping->addMapping(
                    "components/ILIAS/MetaData_",
                    "md",
                    $a_rec["Id"] . ":0:exc",
                    $newObj->getId() . ":0:exc"
                );
            ...
            case "exc_assignment":
                $exc_id = $a_mapping->getMapping("components/ILIAS/Exercise_", "exc", $a_rec["ExerciseId"]);
                if ($exc_id > 0) {
                    ...
                    if ($a_rec["PeerCritCat"]) {
                        $ass->setPeerReviewCriteriaCatalogue((int) $a_mapping->getMapping("components/ILIAS/Exercise_", "exc_crit_cat", $a_rec["PeerCritCat"]));
                    }
                    ...
                    $a_mapping->addMapping("components/ILIAS/Exercise_", "exc_assignment", $a_rec["Id"], $ass->getId());
                }

                break;

            case "exc_crit_cat":
                $exc_id = $a_mapping->getMapping("components/ILIAS/Exercise_", "exc", $a_rec["Parent"]);
                if ($exc_id > 0) {
                    ...
                    $a_mapping->addMapping("components/ILIAS/Exercise_", "exc_crit_cat", $a_rec["Id"], $crit_cat->getId());
                }
                break;

            case "exc_crit":
                $crit_cat_id = $a_mapping->getMapping("components/ILIAS/Exercise_", "exc_crit_cat", $a_rec["Parent"]);
                if ($crit_cat_id > 0) {
            ...
            case "exc_ass_file_order":
                ...
                $ass_id = $a_mapping->getMapping("components/ILIAS/Exercise_", "exc_assignment", $a_rec["AssignmentId"]);
                if ($ass_id > 0) {
            ...
            case "exc_ass_reminders":
                // (5.3) reminders
                $new_ass_id = $a_mapping->getMapping("components/ILIAS/Exercise_", "exc_assignment", $a_rec["AssId"]);
                $new_exc_id = $a_mapping->getMapping('components/ILIAS/Exercise_', 'exc', $a_rec['ExcId']);
