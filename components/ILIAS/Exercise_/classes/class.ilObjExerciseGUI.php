...
class ilObjExerciseGUI extends ilObjectGUI
{
    ...
    public function showOverviewObject(): void
    {
        ...
        $tpl->addJavaScript("./components/ILIAS/Exercise_/js/ilExcPresentation.js");
        ...
        $mtpl = new ilTemplate("tpl.exc_ass_overview.html", true, true, "components/ILIAS/Exercise_");
