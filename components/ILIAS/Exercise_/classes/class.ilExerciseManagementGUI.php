...
class ilExerciseManagementGUI
{
    ...
    public function listTextAssignmentObject(): void
    {
        ...
        $group_panels_tpl = new ilTemplate("tpl.exc_group_report_panels.html", true, true, "components/ILIAS/Exercise_");
    ...
    public function getReportPanel(array $a_data): string
    {
        ...
        $card_tpl = new ilTemplate("tpl.exc_report_details_card.html", true, true, "components/ILIAS/Exercise_");
        ...
        $feedback_tpl = new ilTemplate("tpl.exc_report_feedback.html", true, true, "components/ILIAS/Exercise_");
    ...
    public function getEvaluationModal(
        ...
        $modal_tpl = new ilTemplate("tpl.exc_report_evaluation_modal.html", true, true, "components/ILIAS/Exercise_");
    ...
    protected function initIndividualDeadlineModal(): string
    {
        ...
        $tpl->addJavaScript("./components/ILIAS/Exercise_/js/ilExcIDl.js", true, 3);
