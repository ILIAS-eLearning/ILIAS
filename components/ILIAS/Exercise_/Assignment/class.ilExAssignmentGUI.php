...
class ilExAssignmentGUI
{
    ...
    public function getOverviewHeader(ilExAssignment $a_ass): string
    {
        ...
        $tpl = new ilTemplate("tpl.assignment_head.html", true, true, "components/ILIAS/Exercise_");
    ...
    public function getOverviewBody(ilExAssignment $a_ass): string
    {
        ...
        $tpl = new ilTemplate("tpl.assignment_body.html", true, true, "components/ILIAS/Exercise_");
        ...
        if (count($files) > 0) {
            ...
            foreach ($files as $file) {
                ...
                if ($this->media_type->isImage($mime)) {
                    ...
                    $img_tpl = new ilTemplate("tpl.image_file.html", true, true, "components/ILIAS/Exercise_");
                    ...
                    $media_tpl = new ilTemplate("tpl.media_file.html", true, true, "components/ILIAS/Exercise_");
