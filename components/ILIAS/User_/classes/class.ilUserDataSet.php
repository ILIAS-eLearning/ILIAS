    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "personal_data":
                ...
                $a_mapping->addMapping("components/ILIAS/User_", "usr", $a_rec["Id"], $ilUser->getId());
                break;

            case "usr_profile":
                $usr_id = $a_mapping->getMapping("components/ILIAS/User_", "usr", $a_rec["Id"]);
            ...
            case "usr_setting":
                $usr_id = $a_mapping->getMapping("components/ILIAS/User_", "usr", $a_rec["UserId"]);
                if ($usr_id > 0 && ilObject::_lookupType($usr_id) == "usr") {
                    if (!isset($this->users[$usr_id])) {
                        $this->users[$usr_id] = new ilObjUser($usr_id);
                    }
