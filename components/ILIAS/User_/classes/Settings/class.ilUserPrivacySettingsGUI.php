...
class ilUserPrivacySettingsGUI
{
    ...
    protected function appendChatJsToTemplate(
        ...
        $tpl = new ilTemplate('tpl.personal_chat_settings_form.html', true, true, 'components/ILIAS/Chatroom_');
        if ($this->shouldShowOnScreenChatOptions() && $this->chatSettings->get('enable_browser_notifications', '0')) {
            $pageTemplate->addJavaScript('./components/ILIAS/Notifications_/js/browser_notifications.js');
