...
class ilObjUser extends ilObject
{
    ...
    */
    ...
    public function importPersonalData(
        ...
        if (!$a_profile_data) {
            $imp->addSkipEntity("components/ILIAS/User_", "usr_profile");
        }
        if (!$a_settings) {
            $imp->addSkipEntity("components/ILIAS/User_", "usr_setting");
        }
        if (!$a_notes) {
            $imp->addSkipEntity("components/ILIAS/Notes", "user_notes");
        }
        if (!$a_calendar) {
            $imp->addSkipEntity("components/ILIAS/Calendar_", "calendar");
        }
        $imp->importEntity(
            $a_file["tmp_name"],
            $a_file["name"],
