...
class AdditionalInformationGenerator
{
    ...
    public const KEY_QUESTION_IMAGEMAP_ANSWER_OPTION_COORD = 'coords';
    ...
    public const KEY_QUESTION_ERRORTEXT_ERRORTEXT = 'error_text';
    public const KEY_QUESTION_MAXCHARS = 'maxchars';
    public const KEY_QUESTION_LOWER_LIMIT = 'lower_limit';
    public const KEY_QUESTION_UPPER_LIMIT = 'upper_limit';
