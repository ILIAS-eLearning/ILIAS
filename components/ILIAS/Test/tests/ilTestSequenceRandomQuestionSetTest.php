...
class ilTestSequenceRandomQuestionSetTest extends ilTestBaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->testObj = new ilTestSequenceRandomQuestionSet($DIC['ilDB'], 0, 0, $this->createMock(\ILIAS\TestQuestionPool\Questions\GeneralQuestionPropertiesRepository::class));
    }
