...
class TokenTest extends TestCase
{
    ...
    public function testLargeAmountOfData(string $data): void
    {
        ...
        $this->assertSame([$data], $verified_data);
        $this->assertSame($singed_data, urlencode($singed_data));
        $signed_data_without_suffix = rtrim($singed_data, '=');
        $this->assertSame($signed_data_without_suffix, urlencode($signed_data_without_suffix));
    }
