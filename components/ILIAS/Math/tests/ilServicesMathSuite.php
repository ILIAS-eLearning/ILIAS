...
class ilServicesMathSuite extends TestSuite
{
    ...
    {
        $suite = new self();
        require_once 'components/ILIAS/Math/tests/ilMathTest.php';
        $suite->addTestSuite(ilMathTest::class);
        require_once 'components/ILIAS/Math/tests/ilMathPhpAdapterTest.php';
        $suite->addTestSuite(ilMathPhpAdapterTest::class);
        require_once 'components/ILIAS/Math/tests/ilMathBCAdapterTest.php';
