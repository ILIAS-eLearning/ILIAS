...
use ILIAS\Refinery\Encode\Transformation\JsonEncode;
use JsonException;
...
class JsonEncodeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(JsonEncode::class, new JsonEncode());
    }
    ...
    {
        $this->$method($exptected, (new JsonEncode())->transform($in));
    }

    public function testInvalidEncoding(): void
    {
        $this->expectException(JsonException::class);
        (new JsonEncode())->transform(chr(128));
    }
