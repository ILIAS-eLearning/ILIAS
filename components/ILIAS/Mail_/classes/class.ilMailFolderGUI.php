...
class ilMailFolderGUI
{
    ...
    {
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.mail.html', 'components/ILIAS/Mail_');
        $this->tpl->setTitle($this->lng->txt('mail'));
    ...
    {
        $tplprint = new ilTemplate('tpl.mail_print.html', true, true, 'components/ILIAS/Mail_');
