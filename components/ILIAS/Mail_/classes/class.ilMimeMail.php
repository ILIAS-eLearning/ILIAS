...
class ilMimeMail
{
    ...
    {
        $bracket_path = './components/ILIAS/Mail_/templates/default/tpl.html_mail_template.html';

        if ($skin !== 'default') {
            $tplpath = './Customizing/global/skin/' . $skin . '/components/ILIAS/Mail_/tpl.html_mail_template.html';

            if (is_file($tplpath)) {
                $bracket_path = './Customizing/global/skin/' . $skin . '/components/ILIAS/Mail_/tpl.html_mail_template.html';
            }
        }
    ...
    {
        $this->gatherImagesFromDirectory('./components/ILIAS/Mail_/templates/default/img');

        if ($skin !== 'default') {
            $skinDirectory = './Customizing/global/skin/' . $skin . '/components/ILIAS/Mail_/img';
