...
abstract class ilDashboardBlockGUI extends ilBlockGUI
{
    ...
    public function init(): void
    {
        ...
        $this->main_tpl->addJavaScript('components/ILIAS/Dashboard_/Block/js/ReplaceModalContent.js');
    ...
    public function manage(ReplaceSignal $replace_signal = null): string
    {
        ...
        $tpl = new ilTemplate('tpl.remove_multiple_modal_id_wrapper.html', true, true, 'components/ILIAS/Dashboard_');
