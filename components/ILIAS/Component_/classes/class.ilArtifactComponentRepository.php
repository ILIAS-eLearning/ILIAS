...
{
    public const COMPONENT_DATA_PATH = "components/ILIAS/Component_/artifacts/component_data.php";
    public const PLUGIN_DATA_PATH = "components/ILIAS/Component_/artifacts/plugin_data.php";
