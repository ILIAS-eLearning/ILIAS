...
## General Information
- The FileUpload component handles the uploading of files.
- Components which store and use the uploaded files might store, present, delete or export personal data. This is specified in their respective PRIVACY.md.
