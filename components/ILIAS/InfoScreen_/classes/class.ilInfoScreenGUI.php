...
class ilInfoScreenGUI
{
    ...
    */
    ...
    public function getHTML(): string
    {
        ...
        $tpl = new ilTemplate("tpl.infoscreen.html", true, true, "components/ILIAS/InfoScreen_");
        ...
        if ((count($this->top_formbuttons) > 0) && ($this->form_action !== '')) {
            $tpl->addBlockFile("TOP_FORMBUTTONS", "top_submitbuttons", "tpl.submitbuttons.html", "components/ILIAS/InfoScreen_");
