...
class ilObjectDataSet extends ilDataSet
{
    ...
    public function getNewObjId(ilImportMapping $mapping, string $old_id): int
    {
        ...
        $new_id = $mapping->getMapping('components/ILIAS/Container_', 'objs', $old_id);
        if (!$new_id) {
            $new_id = $mapping->getMapping('components/ILIAS/Object_', 'objs', $old_id);
        }
        if (!$new_id) {
            $new_id = $mapping->getMapping('components/ILIAS/Object_', 'obj', $old_id);
        }
        if (!$new_id) {
