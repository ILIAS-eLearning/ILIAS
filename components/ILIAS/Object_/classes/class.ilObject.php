    ...
    */
    ...
    public function delete(): bool
    {
        ...
        if ((!$this->referenced) || ($this->countReferences() == 1)) {
            ...
            $this->app_event_handler->raise('components/ILIAS/Object_', 'beforeDeletion', ['object' => $this]);
        ...
        if ($this->referenced) {
            ...
            $this->app_event_handler->raise('components/ILIAS/Object_', 'deleteReference', ['ref_id' => $this->getRefId()]);
