...
class ilObjectCopyProgressTableGUI extends ilTable2GUI
{
    ...
    {
        $this->main_tpl->addJavaScript('./components/ILIAS/CopyWizard_/js/ilCopyRedirection.js');
        $this->main_tpl->addOnLoadCode('il.CopyRedirection.checkDone()');
        $this->setExternalSorting(true);
        $this->setFormAction($this->ctrl->getFormAction($this->getParentObject()));

        $this->setRowTemplate('tpl.object_copy_progress_table_row.html', 'components/ILIAS/Object_');
