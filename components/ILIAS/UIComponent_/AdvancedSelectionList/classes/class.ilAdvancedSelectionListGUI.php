...
class ilAdvancedSelectionListGUI implements ilToolbarItem
{
    ...
    */
    ...
    public function getHTML(bool $a_only_cmd_list_asynch = false): string
    {
        ...
        $this->global_tpl->addJavaScript("./components/ILIAS/UIComponent_/AdvancedSelectionList/js/AdvancedSelectionList.js");

        $tpl = new ilTemplate(
            "tpl.adv_selection_list.html",
            true,
            true,
            "components/ILIAS/UIComponent_/AdvancedSelectionList",
            "DEFAULT",
            false,
            true
        );
