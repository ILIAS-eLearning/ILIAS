...
class ilToolbarGUI
{
    ...
    public function getHTML(): string
    {
        ...
        if (count($this->items) || count($this->sticky_items)) {
            $tpl = new ilTemplate("tpl.toolbar.html", true, true, "components/ILIAS/UIComponent_/Toolbar");
            ...
            if (count($this->sticky_items)) {
                $tpl_sticky = new ilTemplate("tpl.toolbar_sticky_items.html", true, true, "components/ILIAS/UIComponent_/Toolbar");
            ...
            foreach ($this->getGroupedItems() as $i => $group) {
                $tpl_items = new ilTemplate("tpl.toolbar_items.html", true, true, "components/ILIAS/UIComponent_/Toolbar");
                if ($i > 0) {
                    static $tpl_separator;
                    if ($tpl_separator === null) {
                        $tpl_separator = new ilTemplate('tpl.toolbar_separator.html', true, true, 'components/ILIAS/UIComponent_/Toolbar');
                    }
            ...
            if ($this->getFormAction() !== "") {
                // #18947
                $GLOBALS["tpl"]->addJavaScript("components/ILIAS/Form_/js/Form.js");
