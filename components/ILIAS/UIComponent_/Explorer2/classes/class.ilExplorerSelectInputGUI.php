...
abstract class ilExplorerSelectInputGUI extends ilFormPropertyGUI implements ilTableFilterItem
{
    ...
    public function render(string $a_mode = "property_form"): string
    {
        ...
        $this->global_tpl->addJavascript("./components/ILIAS/UIComponent_/Explorer2/js/Explorer2.js");
        $this->global_tpl->addJavascript("./components/ILIAS/UIComponent_/Modal/js/Modal.js");
        $this->global_tpl->addOnLoadCode(
            "il.Explorer2.initSelect('" . $this->getFieldId() . "');"
        );

        $tpl = new ilTemplate("tpl.prop_expl_select.html", true, true, "components/ILIAS/UIComponent_/Explorer2");
