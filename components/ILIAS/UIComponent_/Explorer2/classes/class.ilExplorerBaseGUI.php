...
abstract class ilExplorerBaseGUI
{
    ...
    protected static string $js_expl_path = "./components/ILIAS/UIComponent_/Explorer2/js/Explorer2.js";
    ...
    {
        ilFileUtils::makeDirParents($a_target_dir . "/components/ILIAS/UIComponent_/Explorer2/lib/jstree-v.pre1.0");
        ilFileUtils::makeDirParents($a_target_dir . "/components/ILIAS/UIComponent_/Explorer2/js");
    }
    ...
    public function getNodeAsync(): string
    {
        ...
        $etpl = new ilTemplate("tpl.explorer2.html", true, true, "components/ILIAS/UIComponent_/Explorer2");
