...
class ilProgressBar
{
    ...
    {
        $tpl = new ilTemplate("tpl.il_progress.html", true, true, "components/ILIAS/UIComponent_/ProgressBar");
        ...
        if ($this->ajax_url !== '' && $this->ajax_timeout) {
            $this->main_tpl->addJavaScript("components/ILIAS/UIComponent_/ProgressBar/js/progress_bar.js");
