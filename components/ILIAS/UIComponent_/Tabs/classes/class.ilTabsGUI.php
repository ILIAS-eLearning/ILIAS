...
class ilTabsGUI
{
    ...
    private function __getHTML(
        ...
        if ($a_get_sub_tabs) {
            $tpl = new ilTemplate("tpl.sub_tabs.html", true, true, "components/ILIAS/UIComponent_/Tabs");
            $pre = "sub";
            $pre2 = "SUB_";
            $sr_pre = "sub_";
        } else {
            $tpl = new ilTemplate("tpl.tabs.html", true, true, "components/ILIAS/UIComponent_/Tabs");
