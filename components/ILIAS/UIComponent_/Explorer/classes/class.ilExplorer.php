...
class ilExplorer
{
    ...
    public function getOutput(): string
    {
        ...
        $tpl->addJavaScript("./components/ILIAS/UIComponent_/Explorer/js/ilExplorer.js");

        //echo "hh";
        // set global body class
        //		$tpl->setBodyClass("il_Explorer");

        $tpl_tree = new ilTemplate("tpl.tree.html", true, true, "components/ILIAS/UIComponent_/Explorer");
