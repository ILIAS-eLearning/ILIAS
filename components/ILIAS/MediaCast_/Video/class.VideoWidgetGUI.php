...
class VideoWidgetGUI
{
    ...
    public function __construct(
        ...
        $main_tpl->addJavaScript("components/ILIAS/MediaCast_/Video/js/video_widget.js");
    ...
    public function render(): string
    {
        ...
        $tpl = new \ilTemplate("tpl.wrapper.html", true, true, "components/ILIAS/MediaCast_/Video");
        $f = $ui->factory();
