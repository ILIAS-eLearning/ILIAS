...
class VideoViewGUI
{
    ...
    public function renderSideColumn(): string
    {
        ...
        $lng = $this->lng;
        $tpl = new \ilTemplate("tpl.video_cast_side.html", true, true, "components/ILIAS/MediaCast_/Presentation");
        ...
        if ($has_items) {
            ...
            $item_tpl = new \ilTemplate("tpl.playlist_item.html", true, true, "components/ILIAS/MediaCast_/Video");
    ...
    public function render(): string
    {
        ...
        $tpl = new \ilTemplate("tpl.video_cast_layout.html", true, true, "components/ILIAS/MediaCast_/Presentation");
