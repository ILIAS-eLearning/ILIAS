 ...
 * $ilAppEventHandler->raise("components/ILIAS/User_", "deleteUser", array("id" => ..., ...))
 *
 ...
 * service, add a
 * $this->listener["components/ILIAS/User_"] = array("components/ILIAS/News");
 * This information will go to xml files in the future.
 *
 * A component has to implement a listener class that implements
 * components/ILIAS/EventHandling_/interfaces/interface.ilAppEventListener.php
 *
...
class ilAppEventHandler
{
     ...
     *
     * @param	string	$a_component	component, e.g. "components/ILIAS/Forum_" or "components/ILIAS/User_"
    ...
    public function raise(
        ...
        if (is_array($this->listener[$a_component] ?? null)) {
            foreach ($this->listener[$a_component] as $listener) {
                // Allow listeners like components/ILIAS/WebServices_/ECS
