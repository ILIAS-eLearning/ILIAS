...
final class ilContainerResourceGUI implements UploadHandler
{
    ...
    final public function __construct(
        ...
        $this->action_provider = new CombinedActionProvider(
            new StandardActionProvider($this->view_request),
    ...
    public function executeCommand(): void
    {
        ...
        switch ($this->ctrl->getNextClass()) {
            case strtolower(ilContainerResourceActionGUI::class);
                $this->ctrl->forwardCommand(
                    new ilContainerResourceActionGUI()
                );
                return;
            default:
                break;
    ...
    private function addDirectory(): void
    {
        ...
        $modal = $this->getAddDirectoryModal()->withRequest($this->http->request());
    ...
    protected function getAddDirectoryModal(): \ILIAS\UI\Component\Modal\RoundTrip
    {
        return $this->ui_factory->modal()->roundtrip(
            ...
            $this->ctrl->getFormAction($this, self::ADD_DIRECTORY)
        );
    }
