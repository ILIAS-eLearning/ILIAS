...
final class StandardActionProvider implements ActionProvider
{
    ...
    private \ILIAS\UI\Component\Modal\RoundTrip $modal;
    ...
    public function __construct(
        ...
        $this->modal = $this->ui_factory->modal()->roundtrip(
    ...
    public function getComponents(): array
    {
        ...
        if ($this->show_paths) {
            $components[]= $this->ui_factory->messageBox()->info(implode('<br>', array_keys($this->request->getWrapper()->getData())));
        }
