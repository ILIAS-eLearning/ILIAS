...
class CourseReferenceObjectPropertiesProviders implements ObjectTypeSpecificPropertyProviders
{
    ...
    public function getObjectTypeSpecificIcon(
        ...
        $course = new ilObjCourse(
            ilObjCategoryReference::_lookupTargetId($object_id),
            false
        );

        $custom_icon = $course->getObjectProperties()->getPropertyIcon()->getCustomIcon();
