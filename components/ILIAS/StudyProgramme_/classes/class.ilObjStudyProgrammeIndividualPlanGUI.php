...
class ilObjStudyProgrammeIndividualPlanGUI
{
    ...
    public function __construct(
        ...
        $this->tpl->addCss("components/ILIAS/StudyProgramme_/templates/css/ilStudyProgramme.css");
    }
    ...
    protected function view(): string
    {
        ...
        $tpl = new ilTemplate("tpl.individual_plan_tree_frame.html", false, false, "components/ILIAS/StudyProgramme_");
    ...
    protected function buildFrame(string $tab, string $content): string
    {
        ...
        $tpl = new ilTemplate("tpl.indivdual_plan_frame.html", true, true, "components/ILIAS/StudyProgramme_");
        $ass = $this->getAssignmentObject();
