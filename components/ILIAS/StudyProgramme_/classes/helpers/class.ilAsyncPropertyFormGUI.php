...
class ilAsyncPropertyFormGUI extends ilPropertyFormGUI
{
     ...
     */
    protected static string $js_path = "./components/ILIAS/StudyProgramme_/templates/js/";
    ...
    public static function getErrorMessageTemplate(): string
    {
        ...
        $tpl = new ilTemplate("tpl.property_form.html", true, true, "components/ILIAS/Form_");
