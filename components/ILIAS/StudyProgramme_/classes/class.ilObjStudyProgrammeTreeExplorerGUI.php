...
class ilObjStudyProgrammeTreeExplorerGUI extends ilExplorerBaseGUI
{
    ...
    protected string $js_study_programme_path = "./components/ILIAS/StudyProgramme_/templates/js/ilStudyProgramme.js";
    protected string $css_study_programme_path = "./components/ILIAS/StudyProgramme_/templates/css/ilStudyProgrammeTree.css";
    ...
    {
        return new ilTemplate("tpl.tree_node_content.html", true, true, "components/ILIAS/StudyProgramme_");
    }
