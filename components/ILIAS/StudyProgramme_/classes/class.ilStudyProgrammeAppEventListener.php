    ...
    public static function handleEvent(string $component, string $event, array $parameter): void
    {
        ...
        switch ($component) {
            ...
            case "components/ILIAS/Object_":
                ...
                break;
            case "components/ILIAS/ContainerReference_":
                switch ($event) {
            ...
            case "components/ILIAS/AccessControl_":
                ...
                break;
            case "components/ILIAS/OrgUnit_":
                switch ($event) {
            ...
            case 'components/ILIAS/StudyProgramme_':
                switch ($event) {
                    case 'userSuccessful':
