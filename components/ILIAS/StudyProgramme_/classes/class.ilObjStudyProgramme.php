...
class ilObjStudyProgramme extends ilContainer
{
     ...
     *
     * This is exclusively called via event "components/ILIAS/Tracking_, updateStatus" (onServiceTrackingUpdateStatus)
     */
    public static function setProgressesCompletedFor(int $obj_id, int $user_id): void
    {
        ...
        if ($type === "crs") {
            require_once(substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . "/components/ILIAS/ContainerReference_/classes/class.ilContainerReference.php");
