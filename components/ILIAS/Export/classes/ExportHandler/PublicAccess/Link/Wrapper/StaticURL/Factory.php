...
use ILIAS\Export\ExportHandler\I\PublicAccess\Link\Wrapper\StaticURL\FactoryInterface as ilExportHandlerPublicAccessLinkStaticURLFactoryInterface;
...
class Factory implements ilExportHandlerPublicAccessLinkStaticURLFactoryInterface
{
    ...
    {
        return (new ilExportHandlerPublicAccessLinkStaticURLWrapper())
            ->withStaticURL($this->static_url);
    }
}
