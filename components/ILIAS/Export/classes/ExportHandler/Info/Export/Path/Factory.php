...
use ILIAS\Export\ExportHandler\Info\Export\Path\Handler as ExportPathInfo;

class Factory implements ExportPathInfoFactoryInterface
{
    public function handler(): ExportPathInfoInterface
    {
        return new ExportPathInfo();
    }
}
