...
class CollectionTest extends TestCase
{
    public function testExportHandlerRepositoryElementCollection(): void
    {
        ...
        $values_mock_01 = $this->createMock(ilExportHandlerRepositoryValues::class);
        $values_mock_01->method("getCreationDate")->willReturn($date_1);
        $values_mock_02 = $this->createMock(ilExportHandlerRepositoryValues::class);
        $values_mock_02->method("getCreationDate")->willReturn($date_2);
        $values_mock_03 = $this->createMock(ilExportHandlerRepositoryValues::class);
        $values_mock_03->method("getCreationDate")->willReturn($date_2);
        $values_mock_04 = $this->createMock(ilExportHandlerRepositoryValues::class);
        $values_mock_04->method("getCreationDate")->willReturn($date_3);
        $element_mock_01 = $this->createMock(ilExportHandlerRepositoryElement::class);
        $element_mock_01->method('getValues')->willReturn($values_mock_01);
        $element_mock_02 = $this->createMock(ilExportHandlerRepositoryElement::class);
        $element_mock_02->method('getValues')->willReturn($values_mock_02);
        $element_mock_03 = $this->createMock(ilExportHandlerRepositoryElement::class);
        $element_mock_03->method('getValues')->willReturn($values_mock_03);
        $element_mock_04 = $this->createMock(ilExportHandlerRepositoryElement::class);
    ...
    /**
     * @param ilExportHandlerRepositoryElement[] $elements
     */
