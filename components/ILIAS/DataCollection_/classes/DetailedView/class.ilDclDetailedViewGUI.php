...
class ilDclDetailedViewGUI
{
    ...
    public function renderRecord(bool $editComments = false): void
    {
        ...
        $rctpl = new ilDataCollectionGlobalTemplate("tpl.record_view.html", false, true, "components/ILIAS/DataCollection_");
        ...
        $rctpl->addCss("./components/ILIAS/COPage_/css/content.css");
        $rctpl->fillCssFiles();
    ...
    public function doExtReplace(array $found): ?string
    {
        ...
        $tpl = new ilTemplate("tpl.reference_list.html", true, true, "components/ILIAS/DataCollection_");
