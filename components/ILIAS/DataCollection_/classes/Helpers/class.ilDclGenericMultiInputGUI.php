...
class ilDclGenericMultiInputGUI extends ilFormPropertyGUI
{
    ...
    {
        $tpl = new ilTemplate("tpl.prop_generic_multi_line.html", true, true, 'components/ILIAS/DataCollection_');
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        if ($this->getMulti()) {
            ...
            $this->global_tpl->addJavaScript('components/ILIAS/DataCollection_/js/generic_multi_line_input.js');
            $id = $this->getFieldId();
