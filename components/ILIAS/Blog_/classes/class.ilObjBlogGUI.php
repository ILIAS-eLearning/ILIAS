...
class ilObjBlogGUI extends ilObject2GUI implements ilDesktopItemHandling
{
    ...
    protected function buildEmbedded(
        ...
        $wtpl = new ilTemplate("tpl.blog_embedded.html", true, true, "components/ILIAS/Blog_");
    ...
    public function renderList(
        ...
        $wtpl = new ilTemplate("tpl.blog_list.html", true, true, "components/ILIAS/Blog_");
    ...
    protected function renderNavigationByDate(
        ...
        if ($this->object->getNavMode() === ilObjBlog::NAV_MODE_LIST || $a_link_template) {
            ...
            $wtpl = new ilTemplate("tpl.blog_list_navigation_by_date.html", true, true, "components/ILIAS/Blog_");
        ...
        // single month
            ...
            $wtpl = new ilTemplate("tpl.blog_list_navigation_month.html", true, true, "components/ILIAS/Blog_");
    ...
    protected function renderNavigationByKeywords(
        ...
        if ($keywords) {
            $wtpl = new ilTemplate("tpl.blog_list_navigation_keywords.html", true, true, "components/ILIAS/Blog_");
    ...
    protected function renderNavigationByAuthors(
        ...
        if (count($authors) > 1) {
            ...
            $wtpl = new ilTemplate("tpl.blog_list_navigation_authors.html", true, true, "components/ILIAS/Blog_");
    ...
    public function renderNavigation(
        ...
        $wtpl = new ilTemplate("tpl.blog_list_navigation.html", true, true, "components/ILIAS/Blog_");
