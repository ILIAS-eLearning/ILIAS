    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "blog":
                ...
                $a_mapping->addMapping("components/ILIAS/Blog_", "blog", $a_rec["Id"], $newObj->getId());
                break;

            case "blog_posting":
                $blog_id = (int) $a_mapping->getMapping("components/ILIAS/Blog_", "blog", $a_rec["BlogId"]);
                if ($blog_id) {
                    ...
                    $a_mapping->addMapping("components/ILIAS/COPage_", "pg", "blp:" . $a_rec["Id"], "blp:" . $newObj->getId());
                }
                break;
        }
    }
