...
class ilBlogImporter extends ilXmlImporter
{
    ...
    public function init(): void
    {
        ...
        $cop_config = $this->getImport()->getConfig("components/ILIAS/COPage_");
    ...
    public function finalProcessing(
        ...
        $blp_map = $a_mapping->getMappingsOfEntity("components/ILIAS/COPage_", "pg");
        ...
        $sty_map = $a_mapping->getMappingsOfEntity("components/ILIAS/Style_", "sty");
