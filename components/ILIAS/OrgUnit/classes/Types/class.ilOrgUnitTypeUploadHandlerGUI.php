...
/**
  ...
  */
class ilOrgUnitTypeUploadHandlerGUI extends ilCtrlAwareStorageUploadHandler implements \ilCtrlCommandClass
{
    public function __construct(
        private string $rid = ""
    ) {
        parent::__construct(new ilOrgUnitTypeStakeholder());
    }
