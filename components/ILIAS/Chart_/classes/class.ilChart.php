...
abstract class ilChart
{
    ...
    protected function initJS(): void
    {
        ...
        $tpl->addJavaScript("components/ILIAS/Chart_/js/flot/excanvas.min.js");
        $tpl->addJavaScript("components/ILIAS/Chart_/js/flot/jquery.flot.min.js");

        if ($this->auto_resize) {
            // #13108
            $tpl->addJavaScript("components/ILIAS/Chart_/js/flot/jquery.flot.resize.min.js");
        }

        if ($this->stacked) {
            $tpl->addJavaScript("components/ILIAS/Chart_/js/flot/jquery.flot.stack.min.js");
        }
    ...
    public function getHTML(): string
    {
        ...
        $chart = new ilTemplate("tpl.grid.html", true, true, "components/ILIAS/Chart_");
