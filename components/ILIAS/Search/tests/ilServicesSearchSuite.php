...
class ilServicesSearchSuite extends TestSuite
{
    public static function suite(): self
    {
        ...
        include_once("./components/ILIAS/Search/tests/ilSearchLuceneQueryParserTest.php");
        include_once("./components/ILIAS/Search/tests/ilObjSearchRpcClientCoordinatorTest.php");
