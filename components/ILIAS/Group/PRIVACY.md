...
## Data being stored
Group doesn’t store any personal data.
## Data being presented
Group doesn’t store any personal data. All data being stored is handled by the integrated services.


## Data being deleted
If the group is moved to the trash, it remains in the system. Only after being deleted from the trash the group is purged from the system.
Members and their interactions will be removed from the group if the group is restored from the trash.

## Data being exported
XML Exports of Group only contains user ID of the group owner.
