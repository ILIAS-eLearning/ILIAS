...
{
    public const string ID = 'crs_context_tutor_manual_preview';
    public const string DEFAULT_COURSE_TITLE = "preview_crs_title";
    public const string DEFAULT_COURSE_STATUS = "preview_crs_status";
    public const string DEFAULT_COURSE_MARK = "preview_crs_mark";
    public const string DEFAULT_COURSE_TIME_SPENT = "3671";
