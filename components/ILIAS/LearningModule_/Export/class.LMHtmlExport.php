    ...
    protected function getSupplyingExportFiles(string $a_target_dir = "."): array
    {
        $scripts = array(
            ...
            array("source" => \ilYuiUtil::getLocalPath('animation/animation-min.js'),
                ...
                "type" => "js"),
            array("source" => './components/ILIAS/Accordion_/js/accordion.js',
                "target" => $a_target_dir . '/js/accordion.js',
                "type" => "js"),
            array("source" => './components/ILIAS/Accordion_/css/accordion.css',
                "target" => $a_target_dir . '/css/accordion.css',
                "type" => "css"),
            array("source" => './components/ILIAS/Scorm2004_/scripts/questions/pure.js',
                "target" => $a_target_dir . '/js/pure.js',
                "type" => "js"),
            array("source" => './components/ILIAS/Scorm2004_/scripts/questions/question_handling.js',
                "target" => $a_target_dir . '/js/question_handling.js',
                "type" => "js"),
            array("source" => './components/ILIAS/Scorm2004_/templates/default/question_handling.css',
                "target" => $a_target_dir . '/css/question_handling.css',
                "type" => "css"),
            array("source" => './components/ILIAS/TestQuestionPool_/templates/default/test_javascript.css',
            ...
            array("source" => \ilExplorerBaseGUI::getLocalJsTreeCssPath(),
                ...
                "type" => "css"),
            array("source" => './components/ILIAS/LearningModule_/js/LearningModule.js',
