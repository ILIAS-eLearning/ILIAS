...
class ilLMContentRendererGUI
{
    ...
    {
        // content style
        $tpl = new ilTemplate("tpl.page_message_screen.html", true, true, "components/ILIAS/LearningModule_");
    ...
    public function renderPreconditionsOfPage(): string
    {
        ...
        $ptpl = new ilTemplate("tpl.page_preconditions.html", true, true, "components/ILIAS/LearningModule_");
