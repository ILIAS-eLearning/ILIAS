...
class ilLMPresentationGUI implements ilCtrlBaseClassInterface, ilCtrlSecurityInterface
{
    ...
    public function layout(
        ...
        $xmlfile = file_get_contents("./components/ILIAS/LearningModule_/layouts/lm/" . $layout . "/" . $a_xml);
    ...
    protected function addResourceFiles(): void
    {
        ...
        if (!$this->offlineMode()) {
            ...
            $this->tpl->addJavaScript("./components/ILIAS/LearningModule_/js/LearningModule.js");
            ...
            $this->tpl->addJavaScript("./components/ILIAS/Navigation_/js/ServiceNavigation.js");
    ...
    {
        $this->tpl = new ilGlobalTemplate("tpl.fullscreen.html", true, true, "components/ILIAS/LearningModule_");
    ...
    {
        $this->tpl = new ilGlobalTemplate("tpl.glossary_term_output.html", true, true, "components/ILIAS/LearningModule_");
        $this->renderPageTitle();
    ...
    {
        $ilUser = $this->user;
        $this->tpl = new ilGlobalTemplate("tpl.page_fullscreen.html", true, true, "components/ILIAS/LearningModule_");
        $GLOBALS["tpl"] = $this->tpl;
        $this->renderPageTitle();
    ...
    public function ilLMSubMenu(): void
    {
        ...
        $tpl_menu = new ilTemplate("tpl.lm_sub_menu.html", true, true, "components/ILIAS/LearningModule_");
    ...
    public function getContent(
        ...
        $tpl = new ilTemplate("tpl.lm_content.html", true, true, "components/ILIAS/LearningModule_/Presentation");
    ...
    public function showPrintViewSelection(): void
    {
        ...
        $tpl = new ilTemplate("tpl.lm_print_selection.html", true, true, "components/ILIAS/LearningModule_");
    ...
    public function showPrintView(): void
    {
        ...
        $tpl = new ilTemplate("tpl.lm_print_view.html", true, true, "components/ILIAS/LearningModule_");
    ...
    public function showDownloadList(): void
    {
        ...
        $tpl = new ilTemplate("tpl.lm_download_list.html", true, true, "components/ILIAS/LearningModule_");
    ...
    public function getHTML(array $pars): string
    {
        ...
        switch ($pars["cmd"]) {
            case "layout":
                $tpl = new ilTemplate("tpl.embedded_view.html", true, true, "components/ILIAS/LearningModule_");
