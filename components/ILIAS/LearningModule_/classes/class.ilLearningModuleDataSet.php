        ...
        switch ($a_entity) {
            case "lm":
                ...
                if ($a_rec["HeaderPage"] > 0) {
                    $a_mapping->addMapping("components/ILIAS/LearningModule_", "lm_header_page", $a_rec["HeaderPage"], "-");
                }
                if ($a_rec["FooterPage"] > 0) {
                    $a_mapping->addMapping("components/ILIAS/LearningModule_", "lm_footer_page", $a_rec["FooterPage"], "-");
                }
                ...
                $a_mapping->addMapping("components/ILIAS/LearningModule_", "lm", $a_rec["Id"], $newObj->getId());
                $a_mapping->addMapping("components/ILIAS/LearningModule_", "lm_style", $newObj->getId(), $a_rec["StyleId"]);
            ...
            case "lm_tree":
                if (!$this->getTranslationImportMode()) {
                    switch ($a_rec["Type"]) {
                        case "st":
                            $parent = (int) $a_mapping->getMapping("components/ILIAS/LearningModule_", "lm_tree", $a_rec["Parent"]);
                            ...
                            $a_mapping->addMapping(
                                "components/ILIAS/LearningModule_",
                                "lm_tree",
                                $a_rec["Child"],
                                $st_obj->getId()
                            );
                        ...
                        case "pg":
                            ...
                            $a_mapping->addMapping("components/ILIAS/LearningModule_", "pg", $a_rec["Child"], $pg_obj->getId());
                        ...
                        case "pg":
                            ...
                            if ($imp_id[0] == "il" &&
                                ...
                                if (ilLMObject::_lookupContObjID($pg_id) == $this->getTranslationLM()->getId()) {
                                    ...
                                    $trans->setTitle($a_rec["Title"]);
                                    $trans->save();
                                    $a_mapping->addMapping("components/ILIAS/LearningModule_", "pg", $a_rec["Child"], $pg_id);
            ...
            case "lm_data_transl":
                if (!$this->getTranslationImportMode()) {
                    ...
                    $lm_obj_id = $a_mapping->getMapping("components/ILIAS/LearningModule_", "lm_tree", $a_rec["Id"]);
                    if ($lm_obj_id > 0) {
            ...
            case "lm_menu":
                $lm_id = (int) $a_mapping->getMapping("components/ILIAS/LearningModule_", "lm", $a_rec["LmId"]);
                if ($lm_id > 0) {
