...
class ilCourseRegistrationGUI extends ilRegistrationGUI
{
    ...
    protected function fillRegistrationPeriod(): void
    {
        ...
        if (ilDateTime::_before($now, $start)) {
            $tpl = new ilTemplate('tpl.registration_period_form.html', true, true, 'components/ILIAS/Membership_');
    ...
    protected function fillMaxMembers(): void
    {
        ...
        $tpl = new ilTemplate('tpl.max_members_form.html', true, true, 'components/ILIAS/Membership_');
