...
class ilObjCourseGUI extends ilContainerGUI
{
    ...
    public function infoScreen(): void
    {
        ...
        // files
        if ($files !== []) {
            $tpl = new ilTemplate('tpl.event_info_file.html', true, true, 'components/ILIAS/Course_');
        ...
        if ($this->object->getContactEmail()) {
            ...
            foreach ($emails as $email) {
                $email = trim($email);
                $etpl = new ilTemplate("tpl.crs_contact_email.html", true, true, 'components/ILIAS/Course_');
                $etpl->setVariable(
                    "EMAIL_LINK",
    ...
    public function editInfoObject(ilPropertyFormGUI $a_form = null): void
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.edit_info.html', 'components/ILIAS/Course_');
