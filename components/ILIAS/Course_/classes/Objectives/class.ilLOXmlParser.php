...
class ilLOXmlParser
{
    ...
    {
        $new_ref_id = $this->getMapping()->getMapping('components/ILIAS/Container_', 'refs', (string) $a_ref_id);
    ...
    {
        $new_obj_id = $this->getMapping()->getMapping('components/ILIAS/Container_', 'objs', (string) $a_obj_id);
    ...
    {
        $new_qid = $this->getMapping()->getMapping('components/ILIAS/Test_', 'quest', (string) $qid);
    ...
    {
        $new_id = $this->getMapping()->getMapping('components/ILIAS/Test_', 'rnd_src_pool_def', (string) $a_id);
        if ($new_id) {
            return (int) $new_id;
        }
        return 0;
