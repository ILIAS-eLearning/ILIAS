...
class ilCourseObjectivesGUI
{
    ...
    protected function listObjectives(): void
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.crs_objectives.html', 'components/ILIAS/Course_');
    ...
    protected function initFormLimits(string $a_mode): ilPropertyFormGUI
    {
        ...
        $tpl = new ilTemplate('tpl.crs_objective_qst_summary.html', true, true, 'components/ILIAS/Course_');
