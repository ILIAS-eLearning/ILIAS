...
{
    protected const COMPONENT_NAME = 'components/ILIAS/Course_';
    ...
    public static function _updatePassed(
        ...
        if (strlen($update_query)) {
            ...
            if ($a_passed) {
                $ilAppEventHandler->raise('components/ILIAS/Course_', 'participantHasPassedCourse', array(
                    'obj_id' => $a_obj_id,
                    'usr_id' => $a_usr_id,
                ));
            }
