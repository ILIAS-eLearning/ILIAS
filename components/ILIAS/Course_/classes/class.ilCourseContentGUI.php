...
class ilCourseContentGUI
{
    ...
    public function showStartObjects(ilCourseStart $start_obj): void
    {
        ...
        $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.crs_start_view.html", 'components/ILIAS/Course_');
    ...
    {
        $this->tpl->addBlockfile('ADM_CONTENT', 'adm_content', 'tpl.crs_user_timings.html', 'components/ILIAS/Course_');
        $this->tabs->clearSubTabs();
