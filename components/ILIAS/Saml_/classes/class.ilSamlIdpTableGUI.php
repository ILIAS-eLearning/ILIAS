...
final class ilSamlIdpTableGUI extends ilTable2GUI
{
    public function __construct(
        ...
        $federationMdUrl = rtrim(ILIAS_HTTP_PATH, '/') . '/components/ILIAS/Saml_/lib/metadata.php?client_id=' . CLIENT_ID;
        ...
        $this->setRowTemplate('tpl.saml_idp_row.html', 'components/ILIAS/Saml_');
