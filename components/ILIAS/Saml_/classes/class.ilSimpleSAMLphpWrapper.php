...
final class ilSimpleSAMLphpWrapper implements ilSamlAuth
{
    ...
    private function initConfigFiles(string $configurationPath): void
    {
        ...
        $templateHandler->copy('./components/ILIAS/Saml_/lib/config.php.dist', 'auth/saml/config/config.php', [
        ...
        $templateHandler->copy('./components/ILIAS/Saml_/lib/authsources.php.dist', 'auth/saml/config/authsources.php', [
            'RELAY_STATE' => rtrim(ILIAS_HTTP_PATH, '/') . '/saml.php',
            'SP_ENTITY_ID' => rtrim(ILIAS_HTTP_PATH, '/') . '/components/ILIAS/Saml_/lib/metadata.php'
        ]);
    }
