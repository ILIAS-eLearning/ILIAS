    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "wiki":
                ...
                $a_mapping->addMapping("components/ILIAS/Wiki_", "wiki", $a_rec["Id"], $newObj->getId());
                $a_mapping->addMapping("components/ILIAS/Object_", "obj", $a_rec["Id"], $newObj->getId());
                $a_mapping->addMapping("components/ILIAS/Rating_", "rating_category_parent_id", $a_rec["Id"], $newObj->getId());
                $a_mapping->addMapping("components/ILIAS/AdvancedMetaData_", "parent", $a_rec["Id"], $newObj->getId());
                break;

            case "wpg":
                $wiki_id = $a_mapping->getMapping("components/ILIAS/Wiki_", "wiki", $a_rec["WikiId"]);
                ...
                $a_mapping->addMapping("components/ILIAS/Wiki_", "wpg", $a_rec["Id"], $wpage->getId());
                $a_mapping->addMapping("components/ILIAS/COPage_", "pg", "wpg:" . $a_rec["Id"], "wpg:" . $wpage->getId());
                $a_mapping->addMapping("components/ILIAS/AdvancedMetaData_", "advmd_sub_item", "advmd:wpg:" . $a_rec["Id"], $wpage->getId());
                break;

            case "wiki_imp_page":
                $wiki_id = $a_mapping->getMapping("components/ILIAS/Wiki_", "wiki", $a_rec["WikiId"]);
                $page_id = $a_mapping->getMapping("components/ILIAS/Wiki_", "wpg", $a_rec["PageId"]);
