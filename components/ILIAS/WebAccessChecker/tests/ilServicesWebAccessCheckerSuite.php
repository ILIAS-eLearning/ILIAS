...
class ilServicesWebAccessCheckerSuite extends TestSuite
{
    ...
    {
        //require_once('./components/ILIAS/WebAccessChecker/tests/Token/ilWACTokenTest.php');
        //$suite->addTestSuite('ilWACTokenTest');

        //require_once('./components/ILIAS/WebAccessChecker/tests/CheckingInstance/ilWACCheckingInstanceTest.php');
        //$suite->addTestSuite('ilWACCheckingInstanceTest');

        //require_once('./components/ILIAS/WebAccessChecker/tests/Path/ilWACPathTest.php');
