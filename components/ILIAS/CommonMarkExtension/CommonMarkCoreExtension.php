...
use ILIAS\CommonMarkExtension\EmphasisRenderer;
...
final class CommonMarkCoreExtension implements ConfigurableExtensionInterface
{
    ...
    public function register(EnvironmentBuilderInterface $environment): void
    {
        $environment
            ...
            ->addBlockStartParser(new CM\Parser\Block\HeadingStartParser(), 60)
            ...
            ->addRenderer(CM\Node\Inline\Emphasis::class, new EmphasisRenderer(), 0)
