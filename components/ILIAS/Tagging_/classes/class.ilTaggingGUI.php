...
class ilTaggingGUI
{
    ...
    public function getTaggingInputHTML(): string
    {
        ...
        $ttpl = new ilTemplate("tpl.tags_input.html", true, true, "components/ILIAS/Tagging_");
    ...
    {
        $ttpl = new ilTemplate("tpl.tag_cloud.html", true, true, "components/ILIAS/Tagging_");
    ...
    public static function initJavascript(
        ...
        $tpl->addJavaScript("./components/ILIAS/Tagging_/js/ilTagging.js");
    ...
    public function getHTML(): string
    {
        ...
        $lng->loadLanguageModule("tagging");
        $tpl = new ilTemplate("tpl.edit_tags.html", true, true, "components/ILIAS/Tagging_");
