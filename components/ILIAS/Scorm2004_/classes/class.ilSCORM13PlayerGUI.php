...
class ilSCORM13PlayerGUI
{
    ...
    {
        $js_data = file_get_contents("./components/ILIAS/Scorm2004_/scripts/buildrte/rte.js");
    ...
    public function getPlayer(): void
    {
        ...
        //template variables
        //$this->tpl = new ilTemplate("tpl.scorm2004.player.html", false, false, "components/ILIAS/Scorm2004_");
        $this->tpl = new ilGlobalTemplate("tpl.scorm2004.player.html", true, true, "components/ILIAS/Scorm2004_");
        ...
        $this->tpl->setVariable('BASE_DIR', './components/ILIAS/Scorm2004_/');
        ...
        if ($this->slm->getCacheDeactivated()) {
            ...
            $this->tpl->setVariable('JS_SCRIPTS', './components/ILIAS/Scorm2004_/scripts/buildrte/rte-min.js');
        }
    ...
    {
        $is_tpl = new ilTemplate("tpl.scorm2004.inlinecss.html", true, true, "components/ILIAS/Scorm2004_");
    ...
    public function specialPage(): void
    {
        ...
        $this->tpl = new ilGlobalTemplate("tpl.scorm2004.specialpages.html", false, false, "components/ILIAS/Scorm2004_");
        $this->tpl->setVariable("LOCATION_STYLESHEET", ilUtil::getStyleSheetLocation());
    ...
    */
    ...
    public function debugGUI(): void
    {
        ...
        /*		if ($_POST['password'] == $this->slm->getDebugPw()) {
                ...
                if ($_SESSION["debug_pw"]!=$this->slm->getDebugPw()) {
                    $this->tpl = new ilTemplate("tpl.scorm2004.debug_pw.html", false, false, "./components/ILIAS/Scorm2004_");
        ...
        $this->tpl = new ilGlobalTemplate("tpl.scorm2004.debug.html", false, false, "./components/ILIAS/Scorm2004_");
        ...
        $this->tpl->setVariable('RECORD_IMG', ilUtil::getImagePath("record.png", "./components/ILIAS/Scorm2004_"));
        $this->tpl->setVariable('STOP_IMG', ilUtil::getImagePath("stop.png", "./components/ILIAS/Scorm2004_"));
        $this->tpl->setVariable('COMMENT_IMG', ilUtil::getImagePath("comment.png", "./components/ILIAS/Scorm2004_"));
    ...
    {
        return new ilTemplate("tpl.scorm2004.debugtxt.txt", true, true, "components/ILIAS/Scorm2004_");
    }
    ...
    private function getDebugValues(?bool $test_sco = false): array
    {
        ...
        $debug_fields = parse_ini_file("./components/ILIAS/Scorm2004_/scripts/rtemain/debug_default.ini", true);
        //		}
        if ($test_sco) {
    ...
    private function createSummary(array $api_data): void
    {
        ...
        $ini_data = parse_ini_file("./components/ILIAS/Scorm2004_/scripts/rtemain/debug_default.ini", true);
