    ...
    public function createDetectorByType(int $type)
    {
        switch ($type) {
            case self::HTTP_REQUEST_DETECTOR:
                require_once "components/ILIAS/Language/classes/class.ilHttpRequestsLanguageDetector.php";
                return new ilHttpRequestsLanguageDetector($this->request_information["HTTP_ACCEPT_LANGUAGE"]);

            case self::DEFAULT_DETECTOR:
                require_once "components/ILIAS/Language/classes/class.ilDefaultLanguageDetector.php";
                return new ilDefaultLanguageDetector($this->client_ini);
        }

        require_once "components/ILIAS/Language/exceptions/class.ilLanguageException.php";
