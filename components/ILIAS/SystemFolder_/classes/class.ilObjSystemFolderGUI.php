    ...
    public function checkObject(): void
    {
        ...
        if ($_POST["mode"]) {
            ...
            $this->tpl->addBlockFile(
                ...
                "adm_content",
                "tpl.adm_check.html",
                "components/ILIAS/SystemFolder_"
            );
...
//        $this->tabs->setTabActive("server");
        ...
        $btpl = new ilTemplate("tpl.server_data.html", true, true, "components/ILIAS/SystemFolder_");
    ...
    */
    public function showJavaServerObject(): void
    {
        ...
        $tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.java_settings.html', 'components/ILIAS/SystemFolder_');
