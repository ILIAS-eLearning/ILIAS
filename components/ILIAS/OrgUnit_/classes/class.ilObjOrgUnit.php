...
class ilObjOrgUnit extends ilContainer
{
    ...
    public function assignUsersToEmployeeRole(array $user_ids): void
    {
        ...
        foreach ($user_ids as $user_id) {
            ...
            $this->ilAppEventHandler->raise('components/ILIAS/OrgUnit_', 'assignUsersToEmployeeRole', array(
                'object' => $this,
                'obj_id' => $this->getId(),
    ...
    public function assignUsersToSuperiorRole(array $user_ids): void
    {
        ...
        foreach ($user_ids as $user_id) {
            ...
            $this->ilAppEventHandler->raise('components/ILIAS/OrgUnit_', 'assignUsersToSuperiorRole', array(
                'object' => $this,
                'obj_id' => $this->getId(),
                'ref_id' => $this->getRefId(),
                'position_id' => $position_id,
    ...
    public function deassignUserFromEmployeeRole(int $user_id): void
    {
        ...
        $this->ilAppEventHandler->raise('components/ILIAS/OrgUnit_', 'deassignUserFromEmployeeRole', array(
            'object' => $this,
            'obj_id' => $this->getId(),
            'ref_id' => $this->getRefId(),
            'position_id' => $position_id,
    ...
    public function deassignUserFromSuperiorRole(int $user_id): void
    {
        ...
        $this->ilAppEventHandler->raise('components/ILIAS/OrgUnit_', 'deassignUserFromSuperiorRole', array(
            'object' => $this,
            'obj_id' => $this->getId(),
            'ref_id' => $this->getRefId(),
            'position_id' => $position_id,
    ...
    public function assignUserToLocalRole(int $role_id, int $user_id): bool
    {
        ...
        $this->ilAppEventHandler->raise('components/ILIAS/OrgUnit_', 'assignUserToLocalRole', array(
            'object' => $this,
            'obj_id' => $this->getId(),
            'ref_id' => $this->getRefId(),
            'role_id' => $role_id,
    ...
    public function deassignUserFromLocalRole(int $role_id, int $user_id): bool
    {
        ...
        $this->ilAppEventHandler->raise('components/ILIAS/OrgUnit_', 'deassignUserFromLocalRole', array(
            'object' => $this,
            'obj_id' => $this->getId(),
            'ref_id' => $this->getRefId(),
            'role_id' => $role_id,
    ...
    public function delete(): bool
    {
        ...
        $this->ilAppEventHandler->raise('components/ILIAS/OrgUnit_', 'delete', array(
            'object' => $this,
            'obj_id' => $this->getId(),
        ));
