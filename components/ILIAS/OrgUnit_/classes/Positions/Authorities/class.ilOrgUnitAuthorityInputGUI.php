...
class ilOrgUnitAuthorityInputGUI extends ilFormPropertyGUI implements ilMultiValuesItem // TODO: still in use?
{
    ...
    {
        $tpl = new ilTemplate("tpl.authority_input.html", true, true, "components/ILIAS/OrgUnit_");
    ...
    protected function initJS(): void
    {
        ...
        $globalTpl->addJavascript("./components/ILIAS/OrgUnit_/templates/default/authority.js");
