...
require_once(substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . "/components/ILIAS/Form_/classes/class.ilFormPropertyGUI.php");
...
class ilOrgUnitGenericMultiInputGUI extends ilFormPropertyGUI
{
    ...
    public function render(int|string $iterator_id = 0, bool $clean_render = false): string
    {
        ...
        $tpl = new ilTemplate("tpl.prop_generic_multi_line.html", true, true, 'components/ILIAS/OrgUnit_');
    ...
    {
        global $tpl;
        $tpl->addJavascript('components/ILIAS/OrgUnit_/js/generic_multi_line_input.js');
    }
