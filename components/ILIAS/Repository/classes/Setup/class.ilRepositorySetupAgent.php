...
class ilRepositorySetupAgent extends Setup\Agent\NullAgent
{
    ...
    {
        return new \ilDatabaseUpdateStepsMetricsCollectedObjective($storage, new ilRepository9DBUpdateSteps());
    }
}
