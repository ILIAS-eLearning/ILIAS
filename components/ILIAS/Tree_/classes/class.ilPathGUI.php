...
class ilPathGUI
{
    ...
    {
        if ($this->textOnly()) {
            $tpl = new ilTemplate('tpl.locator_text_only.html', true, true, "components/ILIAS/Locator_");
            ...
            $tpl = new ilTemplate('tpl.locator.html', true, true, 'components/ILIAS/Locator_');
