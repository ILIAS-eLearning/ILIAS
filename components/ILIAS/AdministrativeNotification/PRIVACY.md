...
- User IDs of the persons that dismissed the notification are stored. This prevents the AdministrativeNotification component from showing dismissed notifications again.

## Data being presented
- The AdministrativeNotification component does not present any personal data.
...
## Data being exported
- The AdministrativeNotification component does not have an export function. Therefore no personal data is being exported.
