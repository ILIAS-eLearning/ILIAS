...
class TimeFormat implements SettingDefinition
{
    ...
    {
        return $lng->txt('cal_user_time_format');
    }
    ...
    public function getInput(
        ...
        return $field_factory->select(
            $lng->txt('cal_user_time_format'),
            $this->buildOptions(),
            $lng->txt('cal_time_format_info')
        )->withRequired(true)
        ->withValue(
            $user !== null
    ...
    public function getLegacyInput(
        ...
        $lng->loadLanguageModule('dateplaner');
        $input = new \ilSelectInputGUI($lng->txt('cal_user_time_format'));
        $input->setOptions($this->buildOptions());
        $input->setInfo($lng->txt('cal_time_format_info'));
        $input->setValue(
            $user !== null
                ? $this->retrieveValueFromUser($user)
    ...
    public function getDefaultValueForDisplay(
        ...
        return $this->buildOptions()[\ilCalendarSettings::_getInstance()->getDefaultTimeFormat()];
    }
    ...
    public function hasUserPersonalizedSetting(
        ...
        return $this->retrieveValueFromUser($user) !== \ilCalendarSettings::_getInstance()->getDefaultTimeFormat();
    }
