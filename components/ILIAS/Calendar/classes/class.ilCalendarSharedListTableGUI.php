...
class ilCalendarSharedListTableGUI extends ilTable2GUI
{
    ...
    public function __construct(object $parent_obj, string $parent_cmd)
    {
        ...
        $this->setRowTemplate('tpl.calendar_shared_list_row.html', 'components/ILIAS/Calendar');
    ...
    protected function fillRow(array $a_set): void
    {
        ...
        $this->tpl->setVariable('TYPE_IMG', ilUtil::getImagePath('standard/icon_' . $a_set['type'] . '.svg'));
