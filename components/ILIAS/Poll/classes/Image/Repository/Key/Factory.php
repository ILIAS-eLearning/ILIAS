...
use ILIAS\Poll\Image\Repository\Key\Handler as ilPollImageRepositoryKey;

class Factory implements ilPollImageRepositoryKeyFactoryInterface
{
    public function handler(): ilPollImageRepositoryKeyInterface
    {
        return new ilPollImageRepositoryKey();
    }
}
