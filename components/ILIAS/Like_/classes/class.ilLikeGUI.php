...
class ilLikeGUI
{
    ...
    {
        $this->main_tpl->addJavaScript("./components/ILIAS/Like_/js/Like.js");
    }
    ...
    public function getHTML(): string
    {
        ...
        $tpl = new ilTemplate("tpl.like.html", true, true, "components/ILIAS/Like_");
    ...
    protected function renderEmoCounters(
        ...
        $tpl = new ilTemplate("tpl.emo_counters.html", true, true, "components/ILIAS/Like_");
        $f = $this->ui->factory();
        $r = $this->ui->renderer();
    ...
    public function renderEmoticons(): void
    {
        ...
        $tpl = new ilTemplate("tpl.emoticons.html", true, true, "components/ILIAS/Like_");
        $tpl->setVariable("ID", $this->dom_id);
