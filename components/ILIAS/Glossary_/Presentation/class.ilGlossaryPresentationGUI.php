...
class ilGlossaryPresentationGUI implements ilCtrlBaseClassInterface
{
    ...
    */
    public function listDefinitions(
        ...
        $def_tpl = new ilTemplate("tpl.glossary_definition_list.html", true, true, "components/ILIAS/Glossary_");
    ...
    {
        $this->tpl = new ilGlobalTemplate("tpl.fullscreen.html", true, true, "components/ILIAS/COPage_");
    ...
    public function showDownloadList(): void
    {
        ...
        $this->tpl->addBlockFile("ADM_CONTENT", "adm_content", "tpl.glo_download_list.html", "components/ILIAS/Glossary_");
        ...
        $this->tpl->addBlockFile("TBL_CONTENT", "tbl_content", "tpl.download_file_row.html", "components/ILIAS/Glossary_");
