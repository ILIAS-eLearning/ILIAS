    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "glo":
                ...
                $a_mapping->addMapping("components/ILIAS/Glossary_", "glo", $a_rec["Id"], $newObj->getId());
            ...
            case "glo_term":
                ...
                $glo_id = (int) $a_mapping->getMapping("components/ILIAS/Glossary_", "glo", $a_rec["GloId"]);
                ...
                $a_mapping->addMapping(
                    "components/ILIAS/AdvancedMetaData_",
                    "advmd_sub_item",
                    "advmd:term:" . $a_rec["Id"],
                    $term_id
                );
            ...
            case "glo_advmd_col_order":
                ...
                // processing
                $a_mapping->addMapping("components/ILIAS/Glossary_", "advmd_col_order", $a_rec["GloId"] . ":" . $a_rec["FieldId"], $a_rec["OrderNr"]);
                break;
