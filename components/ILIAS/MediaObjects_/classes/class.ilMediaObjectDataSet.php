    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "mob":
                ...
                $a_mapping->addMapping("components/ILIAS/MediaObjects_", "mob", $a_rec["Id"], $newObj->getId());
            ...
            case "mob_media_item":
                ...
                $mob_id = (int) $a_mapping->getMapping("components/ILIAS/MediaObjects_", "mob", $a_rec["MobId"]);
                ...
                $a_mapping->addMapping("components/ILIAS/MediaObjects_", "mob_media_item", $a_rec["Id"], $newObj->getId());
            ...
            case "mob_mi_parameter":
                ...
                // get media item
                $med_id = (int) $a_mapping->getMapping("components/ILIAS/MediaObjects_", "mob_media_item", $a_rec["MiId"]);
