...
class ilWidthHeightInputGUI extends ilFormPropertyGUI
{
    ...
    public function insert(ilTemplate $a_tpl): void
    {
        ...
        $tpl = new ilTemplate("tpl.prop_width_height.html", true, true, "components/ILIAS/MediaObjects_");
        ...
        $this->main_tpl
            ->addJavaScript("./components/ILIAS/MediaObjects_/js/ServiceMediaObjectPropWidthHeight.js");
