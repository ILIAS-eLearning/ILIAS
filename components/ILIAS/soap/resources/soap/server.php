...
require_once dirname(__DIR__, 2) . '/vendor/composer/vendor/autoload.php';
...
$ilIliasIniFile = new ilIniFile(dirname(__DIR__, 2) . './ilias.ini.php');
$ilIliasIniFile->read();
...
if (strcasecmp($_SERVER['REQUEST_METHOD'], 'post') === 0) {
    ...
    require_once dirname(__DIR__, 2) . '/components/ILIAS/soap/include/inc.soap_functions.php';
    ...
    require dirname(__DIR__, 2) . '/components/ILIAS/soap/nusoapserver.php';
}
