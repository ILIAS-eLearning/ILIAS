...
class ilSoapTestAdministration extends ilSoapAdministration
{
    ...
    public function saveQuestion(string $sid, int $active_id, int $question_id, int $pass, array $solution)
    {
        ...
        require_once 'components/ILIAS/TestQuestionPool_/classes/class.ilAssQuestionProcessLockerFactory.php';
        ...
        include_once("./components/ILIAS/Test_/classes/class.ilObjAssessmentFolder.php");
        ...
        $processLocker->executePersistWorkingStateLockOperation(function () use (
            ...
            if ($totalrows !== 0) {
                include_once "./components/ILIAS/TestQuestionPool_/classes/class.assQuestion.php";
    ...
    public function getPositionOfQuestion(string $sid, int $active_id, int $question_id, int $pass)
    {
        ...
        include_once "./components/ILIAS/Test_/classes/class.ilTestSequence.php";
    ...
    public function removeTestResults(string $sid, int $test_ref_id, array $a_user_ids)
    {
        ...
        include_once './components/ILIAS/Test_/classes/class.ilObjTest.php';
        include_once './components/ILIAS/Test_/classes/class.ilTestParticipantData.php';
        require_once 'components/ILIAS/Test_/classes/class.ilTestParticipantAccessFilter.php';
    ...
    public function getTestResults(string $sid, int $test_ref_id, bool $sum_only)
    {
        ...
        require_once 'components/ILIAS/Test_/classes/class.ilTestParticipantAccessFilter.php';
        require_once 'components/ILIAS/Test_/classes/class.ilTestParticipantList.php';
    ...
    {
        require_once 'components/ILIAS/Test_/classes/class.ilTestAccess.php';
