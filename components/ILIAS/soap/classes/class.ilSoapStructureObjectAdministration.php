...
class ilSOAPStructureObjectAdministration extends ilSoapAdministration
{
    ...
    public function getStructureObjects(string $sid, int $ref_id)
    {
        ...
        $filename = "./components/ILIAS/soapclasses/class." . $structureReaderClassname . ".php";
        ...
        include_once substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . '/components/ILIAS/soapclasses/class.ilSoapStructureObjectXMLWriter.php';
