...
class ilSoapStructureObjectXMLWriter extends ilXmlWriter
{
    ...
    {
        $this->xmlSetDtdDef("<!DOCTYPE RepositoryObject PUBLIC \"-//ILIAS//DTD UserImport//EN\" \"" . ILIAS_HTTP_PATH . "/components/ILIAS/Export_/xml/ilias_soap_structure_object_3_7.dtd\">");
