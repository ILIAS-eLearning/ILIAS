...
class ilSoapInstallationInfoXMLWriter extends ilXmlWriter
{
    ...
    private function buildHeader(): void
    {
        ...
        $this->xmlSetDtdDef("<!DOCTYPE Installation PUBLIC \"-//ILIAS//DTD InstallationInfo//EN\" \"" . $httpPath . "/components/ILIAS/Export_/xml/ilias_installation_info_5_3.dtd\">");
    ...
    private function buildClient(string $client_directory): bool
    {
        ...
        require_once(substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . "/components/ILIAS/Init_/classes/class.ilIniFile.php");
