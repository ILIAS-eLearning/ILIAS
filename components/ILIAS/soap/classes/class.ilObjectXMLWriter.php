...
class ilObjectXMLWriter extends ilXmlWriter
{
    ...
    {
        $this->xmlSetDtdDef("<!DOCTYPE Objects PUBLIC \"-//ILIAS//DTD ILIAS Repositoryobjects//EN\" \"" . ILIAS_HTTP_PATH . "/components/ILIAS/Export_/xml/ilias_object_4_0.dtd\">");
    ...
    private function getAccessInfo(ilObject $object, int $ref_id): string
    {
        ...
        include_once substr(__FILE__, 0, strpos(__FILE__, "components/ILIAS")) . '/components/ILIAS/AccessControl_/classes/class.ilAccess.php';
