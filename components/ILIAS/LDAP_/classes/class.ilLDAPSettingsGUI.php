...
class ilLDAPSettingsGUI
{
    ...
    public function roleAssignments(): void
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.ldap_role_assignments.html', 'components/ILIAS/LDAP_');
    ...
    */
    ...
    public function roleMapping(): void
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.ldap_role_mappings.html', 'components/ILIAS/LDAP_');
