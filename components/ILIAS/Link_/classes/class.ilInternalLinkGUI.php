...
class ilInternalLinkGUI
{
    ...
    */
    public function showLinkHelp(): void
    {
        ...
        if ($ilCtrl->isAsynch()) {
            $tpl = new ilGlobalTemplate("tpl.link_help_asynch.html", true, true, "components/ILIAS/Link_");
            ...
            $tpl = new ilGlobalTemplate("tpl.link_help.html", true, true, "components/ILIAS/Link_");
    ...
    public function getFileLinkHTML(): string
    {
        ...
        $tpl = new ilTemplate("tpl.link_file.html", true, true, "components/ILIAS/Link_");
    ...
    public function changeTargetObject(
        ...
        $tpl = new ilTemplate("tpl.link_help_explorer.html", true, true, "components/ILIAS/Link_");
    ...
    public static function getInitHTML(string $a_url): string
    {
        ...
        $tpl->addJavascript("./components/ILIAS/Link_/js/ilIntLink.js");
        // #18721
