...
{
    private const CHATROOM_README_PATH = '/components/ILIAS/Chatroom_/README.md';
    ...
    protected function createSettingTemplate(ilPropertyFormGUI $form): ilTemplate
    {
        ...
        $serverTpl = new ilTemplate('tpl.chatroom_serversettings.html', true, true, 'components/ILIAS/Chatroom_');
