...
class ilChatroomHistoryGUI extends ilChatroomGUIHandler
{
    ...
    private function showMessages(
        ...
        if ($export) {
            $roomTpl = new ilGlobalTemplate('tpl.history_export.html', true, true, 'components/ILIAS/Chatroom_');
        } else {
            $roomTpl = new ilTemplate('tpl.history.html', true, true, 'components/ILIAS/Chatroom_');
        }
