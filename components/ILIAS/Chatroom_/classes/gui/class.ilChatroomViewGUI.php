...
class ilChatroomViewGUI extends ilChatroomGUIHandler
{
    ...
    {
        $this->mainTpl->addJavaScript('components/ILIAS/Chatroom_/js/chat.js');
        $this->mainTpl->addJavaScript('components/ILIAS/Chatroom_/js/iliaschat.jquery.js');
        $this->mainTpl->addJavaScript('node_modules/jquery-outside-events/jquery.ba-outside-events.js');
        $this->mainTpl->addJavaScript('./components/ILIAS/UIComponent_/AdvancedSelectionList/js/AdvancedSelectionList.js');

        $this->mainTpl->addCss('components/ILIAS/Chatroom_/templates/default/style.css');
    ...
    private function showRoom(ilChatroom $room, ilChatroomUser $chat_user): void
    {
        ...
        $roomTpl = new ilTemplate('tpl.chatroom.html', true, true, 'components/ILIAS/Chatroom_');
    ...
    {
        $template = new ilTemplate('tpl.chatroom_send_message_form.html', true, true, 'components/ILIAS/Chatroom_');
    ...
    {
        $roomRightTpl = new ilTemplate('tpl.chatroom_right.html', true, true, 'components/ILIAS/Chatroom_');
