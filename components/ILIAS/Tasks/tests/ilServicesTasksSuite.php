...
class ilServicesTasksSuite extends TestSuite
{
    public static function suite(): ilServicesTasksSuite
    {
        ...
        include_once("./components/ILIAS/Tasks/tests/ilDerivedTaskTest.php");
        $suite->addTestSuite("ilDerivedTaskTest");

        include_once("./components/ILIAS/Tasks/tests/ilDerivedTaskFactoryTest.php");
        $suite->addTestSuite("ilDerivedTaskFactoryTest");

        include_once("./components/ILIAS/Tasks/tests/ilDerivedTaskCollectorTest.php");
