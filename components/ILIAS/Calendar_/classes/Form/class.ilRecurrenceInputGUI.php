...
class ilRecurrenceInputGUI extends ilCustomInputGUI
{
    ...
    public function __construct(string $a_title, string $a_postvar)
    {
        ...
        $DIC->ui()->mainTemplate()->addJavaScript("./components/ILIAS/Calendar_/js/recurrence_input.js");
        $this->user = $DIC->user();
    ...
    {
        $tpl = new ilTemplate('tpl.recurrence_input.html', true, true, 'components/ILIAS/Calendar_');
