...
class ilCalendarUtil
{
    ...
    public static function initJSCalendar(): void
    {
        ...
        $tpl->setVariable("LOCATION_JAVASCRIPT_CALENDAR", "./components/ILIAS/Calendar_/js/calendar.js");
        $tpl->setVariable("LOCATION_JAVASCRIPT_CALENDAR_SETUP", "./components/ILIAS/Calendar_/js/calendar-setup.js");
        $tpl->parseCurrentBlock();
    ...
    public static function getZoneInfoFile($a_tz): string
    {
        ...
        return './components/ILIAS/Calendar_/zoneinfo/' . $timezone_filename;
    }
    ...
    public static function initDateTimePicker(): void
    {
        ...
        if (!self::$init_datetimepicker) {
            ...
            $tpl->addJavaScript("components/ILIAS/Form_/js/Form.js"); // see ilPropertyFormGUI
