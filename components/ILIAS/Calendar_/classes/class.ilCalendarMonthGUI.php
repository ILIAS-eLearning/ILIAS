...
class ilCalendarMonthGUI extends ilCalendarViewGUI
{
    ...
    {
        $this->tpl = new ilTemplate('tpl.month_view.html', true, true, 'components/ILIAS/Calendar_');
    ...
    protected function showEvents(ilCalendarSchedule $scheduler, ilDate $date): int
    {
        ...
        foreach ($scheduler->getByDay($date, $this->timezone) as $item) {
            ...
            $event_tpl = new ilTemplate('tpl.month_event_view.html', true, true, 'components/ILIAS/Calendar_');
            // milestone icon
