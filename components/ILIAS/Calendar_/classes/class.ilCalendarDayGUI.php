...
class ilCalendarDayGUI extends ilCalendarViewGUI
{
    ...
    protected function show(): void
    {
        ...
        $this->tpl = new ilTemplate('tpl.day_view.html', true, true, 'components/ILIAS/Calendar_');
    ...
    {
        $event_tpl = new ilTemplate('tpl.day_event_view.html', true, true, 'components/ILIAS/Calendar_');
