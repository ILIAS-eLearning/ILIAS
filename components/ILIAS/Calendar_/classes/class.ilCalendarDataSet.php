    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case "calendar":
                ...
                // be imported
                if (($a_rec["Type"] ?? 0) == 1) {
                    $usr_id = (int) $a_mapping->getMapping("components/ILIAS/User_", "usr", $a_rec["ObjId"]);
            ...
            case "cal_assignment":
                $cat_id = (int) $a_mapping->getMapping("components/ILIAS/Calendar_", "calendar", $a_rec["CatId"]);
                $entry_id = (int) $a_mapping->getMapping("components/ILIAS/Calendar_", "cal_entry", $a_rec["EntryId"]);
            ...
            case "recurrence_rule":
                $entry_id = $a_mapping->getMapping("components/ILIAS/Calendar_", "cal_entry", $a_rec["EntryId"]);
                if ($entry_id > 0) {
