...
class ilCalendarCategoryGUI
{
    ...
    protected function add(ilPropertyFormGUI $form = null): void
    {
        ...
        $ed_tpl = new ilTemplate('tpl.edit_category.html', true, true, 'components/ILIAS/Calendar_');
    ...
    protected function appendCalendarSelection(): string
    {
        ...
        $tpl = new ilTemplate('tpl.calendar_selection.html', true, true, 'components/ILIAS/Calendar_');
    ...
    {
        $tpl = new ilTemplate('tpl.cal_reference_links.html', true, true, 'components/ILIAS/Calendar_');
