...
class ilCalendarWeekGUI extends ilCalendarViewGUI
{
    ...
    public function show(): void
    {
        ...
        $this->tpl = new ilTemplate('tpl.week_view.html', true, true, 'components/ILIAS/Calendar_');
    ...
    {
        $time = '';
        $event_tpl = new ilTemplate('tpl.week_event_view.html', true, true, 'components/ILIAS/Calendar_');
