...
class ilTermsOfServiceAcceptanceHistoryTableGUI extends ilTermsOfServiceTableGUI
{
    ...
    public function __construct(
        ...
        $globalTemplate->addJavaScript('./components/ILIAS/Form_/js/Form.js');

        $this->setShowRowsSelector(true);

        $this->setRowTemplate('tpl.tos_acceptance_history_table_row.html', 'components/ILIAS/TermsOfService_');
