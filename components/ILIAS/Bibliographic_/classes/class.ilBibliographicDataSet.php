...
class ilBibliographicDataSet extends ilDataSet
{
    ...
    public function importRecord(
        ...
        switch ($a_entity) {
            case 'bibl':
                ...
                $a_mapping->addMapping('components/ILIAS/Bibliographic_', 'bibl', $a_rec['id'], $new_obj->getId());
    ...
    public function importLibraryFile(\ilImportMapping $a_mapping): void
    {
        ...
        $import_path = $this->getImportDirectory() . "/components/ILIAS/Bibliographic_/set_1/expDir_1/" . $filename;
