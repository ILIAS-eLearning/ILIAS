    ...
    public function importRecord(string $a_entity, array $a_types, array $a_rec, ilImportMapping $a_mapping, string $a_schema_version): void
    {
        switch ($a_entity) {
            case "sess":
                ...
                $a_mapping->addMapping("components/ILIAS/Session_", "sess", $a_rec["Id"], (string) $newObj->getId());
                $a_mapping->addMapping('components/ILIAS/Object_', 'objs', $a_rec['Id'], (string) $newObj->getId());
                $a_mapping->addMapping('components/ILIAS/AdvancedMetaData_', 'parent', $a_rec['Id'], (string) $newObj->getId());
            ...
            case "sess_item":
                if ($obj_id = $a_mapping->getMapping('components/ILIAS/Container_', 'objs', $a_rec['ItemId'])) {
