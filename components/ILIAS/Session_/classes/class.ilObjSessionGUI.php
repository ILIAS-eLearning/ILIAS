...
class ilObjSessionGUI extends ilObjectGUI implements ilDesktopItemHandling
{
    ...
    */
    ...
    public function editObject(): void
    {
        ...
        $this->initForm('edit');
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.sess_edit.html', 'components/ILIAS/Session_');
    ...
    public function eventsListObject(): void
    {
        ...
        $this->tpl->addBlockFile('ADM_CONTENT', 'adm_content', 'tpl.sess_list.html', 'components/ILIAS/Session_');
        ...
        $this->tpl->addBlockFile('TBL_CONTENT', 'tbl_content', 'tpl.sess_list_row.html', 'components/ILIAS/Session_');
