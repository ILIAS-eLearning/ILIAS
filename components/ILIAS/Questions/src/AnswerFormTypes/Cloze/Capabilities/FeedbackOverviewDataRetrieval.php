...
class FeedbackOverviewDataRetrieval implements DataRetrieval
{
    /**
     * @var array{
     *  string: array<\ILIAS\Questions\AnswerForm\Capabilities\Feedback\SpecificFeedback>
     * }
     */
    ...
    public function getSpecificFeedbacksForRowId(
        ...
        return array_filter(
            $feedbacks_for_gap,
            fn(SpecificFeedback $v): bool => in_array($v->getId(), $ids)
        );
    }
    ...
    private function buildTableRow(
        ...
        return $row_builder->buildDataRow(
            ...
            [
                ...
                'answer_option' => implode('<br>', $answer_options),
