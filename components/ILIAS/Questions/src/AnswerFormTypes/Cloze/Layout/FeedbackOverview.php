...
class FeedbackOverview implements DataRetrieval, Renderable
{
    private const string STEP_SAVE = 's';
    private const string STEP_ADD_FEEDBACK = 'saf';
    private const string STEP_EDIT_FEEDBACK = 'sef';
    private const string STEP_DELETE_FEEDBACK = 'df';
    private const string STEP_CONFIRM_DELETE_COMBINATION = 'cdf';
    ...
    public function doAction(): Async|self|Properties
    {
        return match ($this->environment->getStep()) {
            self::STEP_ADD_FEEDBACK => $this->processSetCombinationGapsModal(),
            self::STEP_DELETE_FEEDBACK => $this->deleteCombination(),
    ...
    private function buildSetCombinationGapsModal(): RoundTripModal
    {
        ...
        return $this->ui_factory->modal()->roundtrip(
            ...
            $this->environment
                ->withStepParameter(self::STEP_ADD_FEEDBACK)
                ->getUrlBuilder()
                ->buildURI()
                ->__toString()
