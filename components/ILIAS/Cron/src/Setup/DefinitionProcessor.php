...
class DefinitionProcessor implements \ilComponentDefinitionProcessor
{
    ...
    public function __construct(
        ...
        $this->job_repository = new JobRepositoryImpl(
            $this->db,
            $setting,
    ...
    public function beginTag(string $name, array $attributes): void
    {
        ...
        $this->job_repository->registerJob(
            $component,
            $attributes['id'],
            $attributes['class'],
    ...
    public function endTag(string $name): void
    {
        ...
        $this->job_repository->unregisterJob($this->component, $this->has_cron);
    }
}
