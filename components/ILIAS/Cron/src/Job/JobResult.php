...
class JobResult
{
    final public const int STATUS_INVALID_CONFIGURATION = 1;
    final public const int STATUS_NO_ACTION = 2;
    final public const int STATUS_OK = 3;
    final public const int STATUS_CRASHED = 4;
    final public const int STATUS_RESET = 5;
    final public const int STATUS_FAIL = 6;

    final public const string CODE_NO_RESULT = 'job_no_result';
    final public const string CODE_MANUAL_RESET = 'job_manual_reset';
    final public const string CODE_SUPPOSED_CRASH = 'job_auto_deactivation_time_limit';
