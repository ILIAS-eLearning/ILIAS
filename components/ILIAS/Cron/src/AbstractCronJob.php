...
/**
 * Default implementation for cron jobs: schedule evaluation, UI hooks, and execution contract.
 */
abstract class AbstractCronJob implements CronJob
{
    ...
    public function __construct(
        ...
        protected readonly \ILIAS\Language\Language $language,
