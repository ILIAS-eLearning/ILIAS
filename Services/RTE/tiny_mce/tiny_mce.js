...
function TinyMCE_Engine() {
	...
	this.isOpera9plus = ua.indexOf('Opera/8') == -1 && ua.indexOf('Opera/7') == -1 && ua.indexOf('Opera/6') == -1 && ua.indexOf('Opera/5') == -1 && ua.indexOf('Opera/4') == -1 && ua.indexOf('Opera/3') == -1 && ua.indexOf('Opera/2') == -1;
...
TinyMCE_Engine.prototype = {
	init : function(settings) {
		...
		// Browser check Opera
		if (this.isOpera9plus && this.settings['browsers'].indexOf('opera') == -1)
			return;
