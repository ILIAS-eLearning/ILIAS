...
<!-- END formelements -->
		...
		oninit: function(){
			...
			/**
			 * do not change anything here, if you need to get some code invoked
			 * right after all tiny instances has been initialised,
			 * feel free to add your own callback by using the following:
			 * 
			 * ilTinyMceInitCallbackRegistry.addCallback(callback)
 			 */
