...
function UploadHandler(blobInfo, success, failure, progress) {
    var xhr, formData;
    var uploadUrl = './node_modules/tinymce/plugins/ilimgupload/imgupload.php?obj_id=' + obj_id + '&obj_type='
        + obj_type + '&update=' + image_update;
...
tinymce.init({
    ...
    images_upload_url: './node_modules/tinymce/plugins/ilimgupload/imgupload.php?obj_id='
    ...
    extended_valid_elements: "form[name|id|action|method|enctype|accept-charset|onsubmit|onreset|target]," +
        "input[id|name|type|value|size|maxlength|checked|accept|s rc|width|height|disabled|readonly|tabindex|accessk " +
        "ey|onfocus|onblur|onchange|onselect],textarea[id|name|rows|cols|disabled|readonly|tabindex|acces " +
        "skey|onfocus|onblur|onchange|onselect],option[name|id|value],select[id|name|type|value|size" +
        "|maxlength|checked|accept|s rc|width|height|disabled|readonly|tabindex|accessk ey|onfocus|onblur" +
