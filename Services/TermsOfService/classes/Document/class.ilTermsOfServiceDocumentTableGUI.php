...
class ilTermsOfServiceDocumentTableGUI extends \ilTermsOfServiceTableGUI
{
	...
	public function __construct(
		...
		$this->addMultiCommand('showDocumentDeletionConfirmation', $this->lng->txt('delete'));
	...
	protected function prepareRow(array &$row)
	{
		...
		$actions->addItem(
			$this->lng->txt('delete'),
			'',
			$this->ctrl->getLinkTarget($this->getParentObject(), 'showDocumentDeletionConfirmation')
		);
