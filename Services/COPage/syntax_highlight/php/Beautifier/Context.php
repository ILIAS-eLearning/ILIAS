...
class Context
{
    ...
    public function from_language($lang, $output)
    {
        ...
        for ($i=0; $i<sizeof($lang->blockcommenton); $i++) {
            ...
            if (!isset($this->bcomatches[$bco])) {
                $this->bcomatches[$bco] = array();
            }
        ...
        $preprolength = 0;
        $this->prepro = 0;
        if (isset($lang->prepro)) {
            $this->preprolength = strlen($lang->prepro);
        }
