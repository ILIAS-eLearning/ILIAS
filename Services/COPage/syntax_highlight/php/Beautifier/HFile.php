...
class HFile
{
    ...
    public function to_perl($stub, $tofile = 1)
    {
...
";
    ...
    public function to_php($stub, $tofile = 1)
    {
        $this->used_categories = $this->_get_categories();
    ...
    public function _dump_linkscripts()
    {
        print "
...
# to put in its place. This can be used to generate links, images, etc.\n\n";
    ...
    public function _dump_perl_linkscripts()
    {
        print "
...
# to put in its place. This can be used to generate links, images, etc.\n\n";
    ...
    public function _dump_perl_defaultscripts()
    {
        print "\n# DoNothing link function\n\n";
        print "sub donothing\n{\nmy ( \$self ) = @_;\nreturn;\n}\n";
    }
    
    public function _dump_colours()
    {
        $usedcols = array();
        foreach ($this->used_categories as $c) {
    ...
    public function _dump_var($variable, $name)
    {
        print $name . "	= \"" . addslashes($variable) . "\";\n";
    }
    
    public function _dump_array($array, $name)
    {
        $first = 1;
        print $name . "	= array(";
        foreach ($array as $a) {
    ...
    public function _dump_perl_array($array, $name)
    {
        $first = 1;
        print $name . "	= [";
        foreach ($array as $a) {
    ...
    public function _dump_hash($hash, $name)
    {
        $first = 1;
        print $name . "	= array(";
    ...
    public function _dump_perl_hash($hash, $name)
    {
        $first = 1;
        print $name . "	= {";
        foreach (array_keys($hash) as $k) {
