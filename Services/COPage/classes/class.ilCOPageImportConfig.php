...
class ilCOPageImportConfig extends ilImportConfig
{
	 ...
	 */
	function setUpdateIfExists($a_val)
	{
	 ...
	 */
	function setForceLanguage($a_val)
	{
	 ...
	 */
	function setReuseOriginallyExportedMedia($a_val)
	{
	 ...
	 */
	function getReuseOriginallyExportedMedia()
	{
	 ...
	 */
	function setSkipInternalLinkResolve($a_val)
	{
	 ...
	 */
	function getSkipInternalLinkResolve()
	{
