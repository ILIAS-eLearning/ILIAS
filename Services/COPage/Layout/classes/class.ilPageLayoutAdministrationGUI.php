...
//				$this->tpl->getStandardTemplate();
				...
				$this->tabs->setBackTarget($this->lng->txt("page_layouts"),
	...
	function listLayouts()
	{
		...
		if ($this->checkPermission("sty_write_page_layout", false))
		{
			...
			$this->toolbar->addButton($this->lng->txt("sty_import_page_layout"),
	 ...
	 */
	function activate($a_activate=true)
	{
	 ...
	 */
	function addPageLayout($a_form = null)
	{
		if(!$a_form)
		{
