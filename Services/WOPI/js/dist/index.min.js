...
a.default.defaultView.addEventListener("resize",(()=>{n.default.WOPI.windowResize(d)}))},n.default.WOPI.postMessage=function(e){this.editorFrameWindow.postMessage(JSON.stringify(e),"*")},n.default.WOPI.registerListener=function(e,t){window.addEventListener("message",(i=>{const a=JSON.parse(i.data);null!==e&&a.MessageId===e&&t(a)}),!1)},n.default.WOPI.close=async function(){const e=a.default.createElement("div");e.id="c-embedded-wopi-overlay",e.style.position="fixed",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.backgroundColor="rgba(0,0,0,0.5)",this.frameholder.appendChild(e);const t=await this.save();return!this.modified||t},n.default.WOPI.save=async function(){this.postMessage({MessageId:"Action_Save",SendTime:Date.now(),Values:{DontTerminateEdit:!0,DontSaveIfUnmodified:!0,Notify:!1}});return await this.registerListener("Doc_ModifiedStatus",(()=>!0))}}(document,il);
