...
namespace ILIAS\Membership\Changelog\Infrastructure\AR;
 ...
 * Class EventAR
 *
 * @package ILIAS\Membership\Changelog\Infrastructure\AR
 *
...
class EventAR extends ActiveRecord
{
     ...
     */
    public function setEventId(EventID $event_id) : void
    {
     ...
     */
    public function setActorUserId(int $actor_user_id) : void
    {
     ...
     */
    public function setSubjectUserId(int $subject_user_id) : void
    {
     ...
     */
    public function setSubjectObjId(int $subject_obj_id) : void
    {
     ...
     */
    public function setILIASComponent(String $ilias_component) : void
    {
