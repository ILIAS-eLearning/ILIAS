...
class ilAuthContainerApache extends Auth_Container
{
     ...
     */
    public function fetchData($a_username, $password, $isChallengeResponse = false)
    {
        ...
        if (
            ...
            foreach ($list as $auth_mode) {
                ...
                } elseif (AUTH_APACHE != $auth_mode && $settings->get('apache_enable_local')) {
                    $condition = '';
        ...
        } elseif (defined('IL_CERT_SSO') && IL_CERT_SSO) {
