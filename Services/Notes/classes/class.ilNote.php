...
class ilNote
{
    ...
    */
    public function setObject($a_obj_type, $a_rep_obj_id, $a_obj_id = 0)
    {
    ...
    */
     ...
     */
    public static function _countNotesAndComments($a_rep_obj_id, $a_sub_obj_id = null)
    {
        global $DIC;
     ...
     * @return
     */
    public static function commentsActivated($a_rep_obj_id, $a_obj_id, $a_obj_type)
    {
        global $DIC;
