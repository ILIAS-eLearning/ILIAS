...
class ilNoteGUI
{
    ...
    */
    public function __construct($a_rep_obj_id = "", $a_obj_id = "", $a_obj_type = "", $a_include_subobjects = false)
    {
        global $DIC;
    ...
    public function getNoteListHTML($a_type = IL_NOTE_PRIVATE, $a_init_form = true)
    {
        ...
        */
        ...
        $notes = ilNote::_getNotesOfObject(
            ...
            (bool) $_SESSION["comments_sort_asc"]
        );

        $all_notes = ilNote::_getNotesOfObject(
            $this->rep_obj_id,
            $this->obj_id,
            $this->obj_type,
            $a_type,
    ...
    */
    public function showTargets(&$tpl, $a_rep_obj_id, $a_note_id, $a_obj_type, $a_obj_id)
    {
        $tree = $this->tree;
