...
Since each resource should also have an owner, we read the respective object owner of a forum and pass this as the resource owner. The `ResourceCollectionIdentification` is then saved in the database.
