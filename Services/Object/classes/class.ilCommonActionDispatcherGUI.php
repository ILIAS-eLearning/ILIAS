...
class ilCommonActionDispatcherGUI
{
     ...
     * @return object
     */
    public function __construct($a_node_type, $a_access_handler, $a_obj_type, $a_node_id, $a_obj_id)
    {
        global $DIC;
     ...
     * @return string
     */
    public static function buildAjaxHash($a_node_type, $a_node_id, $a_obj_type, $a_obj_id, $a_sub_type = null, $a_sub_id = null)
    {
