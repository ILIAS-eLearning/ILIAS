...
class ilObjectTileImageMigration implements Migration
{
    ...
    public function step(Environment $environment): void
    {
        ...
        $this->removeDirectoryOrInfom(\dirname($path), $next_record);
        $this->deleteTileImageInfoFromContainerSettings($next_record->id);
    }

    private function removeDirectoryOrInfom(string $directory, \stdClass $record): void
    {
        if (!is_dir($directory)) {
            return;
        }
        ...
        if (empty($files)) {
            ...
            $this->admin_interaction->inform(
                "The tile image for the object with the id $record->id was successfully migrated. "
