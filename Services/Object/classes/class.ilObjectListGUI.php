...
class ilObjectListGUI
{
    ...
    * @return void
    */
    public function enablePath($a_path, $a_start_node = null)
    {
    ...
    */
     ...
     * @return string
     */
    public function getHeaderAction(ilTemplate $a_main_tpl = null)
    {
        global $DIC;
