...
class ilCachedObjectDefinition implements Request
{
    ...
    protected function readFromDB(): void
    {
        ...
        $sql =
            ...
            . "allow_copy, rbac, il_object_def.system, sideblock, default_pos, grp, default_pres_pos, export, repository," . PHP_EOL
        ...
        $sql =
            ...
            . "translate, devmode, allow_link, allow_copy, rbac, il_object_def.system, sideblock, default_pos, grp," . PHP_EOL
