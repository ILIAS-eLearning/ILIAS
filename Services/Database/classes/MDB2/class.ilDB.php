...
abstract class ilDB extends PEAR implements ilDBInterface
{
    ...
    * Check error
    */
    public static function isDbError($a_res)
    {
    ...
    */
    public function addPrimaryKey($a_table, $a_fields)
    {
        ...
        $r = $manager->createConstraint(
            $a_table,
            $this->constraintName($a_table, $this->getPrimaryKeyIdentifier()),
            $definition
        );
    ...
    */
    ...
    public function dropUniqueConstraint($a_table, $a_name = "con")
    {
        ...
        $r = $manager->dropConstraint(
            $a_table,
            $this->constraintName($a_table, $a_name),
            false
        );
...
//
    ...
    * @return object DB
    */
    public function getRow($sql, $mode = ilDBConstants::FETCHMODE_OBJECT)
    {
        $set = $this->query($sql);
        $r = $set->fetchRow($mode);
