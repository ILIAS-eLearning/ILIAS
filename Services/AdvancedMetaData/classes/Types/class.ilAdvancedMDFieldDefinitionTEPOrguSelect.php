...
/** 
 * AMD select for TEP Org unit types at a seminar.
 * 
 ...
 */
class ilAdvancedMDFieldDefinitionTEPOrguSelect extends ilAdvancedMDFieldDefinitionSelect
{		
	//
	// generic types
	// 
	...
	{
		return self::TYPE_TEP_ORGU_SELECT;
	}
	...
	public function getOptions()
	{
		...
		$ous = ilTEP::getPossibleOrgUnitsForTEPEntries();
		return $ous["orgu_ref_ids"];
	}
