...
class ilMainMenuGUI
{
    ...
    */
    ...
    public static function getLanguageSelection($a_in_topbar = false)
    {
        global $DIC;
    ...
    */
     ...
     * @return
     */
    public function renderEntry($a_tpl, $a_id, $a_txt, $a_script, $a_target = "_top")
    {
        $lng = $this->lng;
        ...
        if ($a_id == "repository") {
            ...
            $gl->addEntry(
                $icon . " " . $a_txt . " - " . $lng->txt("rep_main_page"),
        ...
        if ($a_id == "desktop") {
            ...
            $gl->addEntry(
                ...
                "",
                "mm_pd_sel_items",
                ilHelp::getMainMenuTooltip("mm_pd_sel_items"),
                "left center",
                "right center",
                false
            );
            ...
            if ($pdItemsViewSettings->allViewsEnabled()) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_crs_grp",
                    ilHelp::getMainMenuTooltip("mm_pd_crs_grp"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if (!$ilSetting->get("disable_bookmarks")) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_bookm",
                    ilHelp::getMainMenuTooltip("mm_pd_bookm"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if (!$ilSetting->get("disable_notes") || !$ilSetting->get("disable_comments")) {
                ...
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_notes",
                    ilHelp::getMainMenuTooltip("mm_pd_notes"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if ($ilSetting->get("block_activated_news")) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_news",
                    ilHelp::getMainMenuTooltip("mm_pd_news"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if ($ilSetting->get("enable_my_staff") and ilMyStaffAccess::getInstance()->hasCurrentUserAccessToMyStaff() == true) {
                ...
                $gl->addEntry(
                    $lng->txt("my_staff"),
                    "ilias.php?baseClass=" . ilPersonalDesktopGUI::class . "&cmd=" . ilPersonalDesktopGUI::CMD_JUMP_TO_MY_STAFF,
                    "_top",
                    "",
                    "",
                    "mm_pd_mst",
                    ilHelp::getMainMenuTooltip("mm_pd_mst"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if (!$ilSetting->get("disable_personal_workspace")) {
                ...
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_wsp",
                    ilHelp::getMainMenuTooltip("mm_pd_wsp"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if ($ilSetting->get('user_portfolios')) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_port",
                    ilHelp::getMainMenuTooltip("mm_pd_port"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if ($skmg_set->get("enable_skmg")) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_skill",
                    ilHelp::getMainMenuTooltip("mm_pd_skill"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if (ilBadgeHandler::getInstance()->isActive()) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_contacts",
                    ilHelp::getMainMenuTooltip("mm_pd_badges"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if (ilObjUserTracking::_enabledLearningProgress() &&
                ...
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_lp",
                    ilHelp::getMainMenuTooltip("mm_pd_lp"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if ($settings->isEnabled()) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_cal",
                    ilHelp::getMainMenuTooltip("mm_pd_cal"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if ($this->mail) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_mail",
                    ilHelp::getMainMenuTooltip("mm_pd_mail"),
                    "left center",
                    "right center",
                    false
                );
            ...
            if (ilBuddySystem::getInstance()->isEnabled()) {
                $gl->addEntry(
                    ...
                    "",
                    "mm_pd_contacts",
                    ilHelp::getMainMenuTooltip("mm_pd_contacts"),
                    "left center",
                    "right center",
                    false
                );
    ...
    */
    public function getScriptTarget($a_script)
    {
        $script = "./" . $a_script;
     ...
     * @param
     */
    public function renderDropDown($a_tpl, $a_id)
    {
        $lng = $this->lng;
        $ilSetting = $this->settings;
     ...
     * @return
     */
    public function renderHelpButtons()
    {
        $ilHelp = $this->help;
        $lng = $this->lng;
        $ilCtrl = $this->ctrl;
     ...
     * @param bool $a_value
     */
    public function showLogoOnly($a_value)
    {
