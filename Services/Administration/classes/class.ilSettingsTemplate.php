...
class ilSettingsTemplate
{
     ...
     * @param
     */
    public function __construct($a_id = 0, $config = null)
    {
        global $DIC;
     ...
     */
    public function setSetting($a_setting, $a_value, $a_hide = false)
    {
        if ($this->getConfig()) {
     ...
     * @param string setting
     */
    public function removeSetting($a_setting)
    {
     ...
     * @return
     */
    public function addHiddenTab($a_tab_id)
    {
     ...
     */
    public function removeAllHiddenTabs()
    {
     ...
     * Insert hidden tabs
     */
    public function insertHiddenTabs()
    {
        $ilDB = $this->db;
     ...
     */
    public static function getAllSettingsTemplates($a_type, $a_include_auto_generated = false)
    {
        global $DIC;
     ...
     * @return
     */
    public static function lookupDescription($a_id)
    {
        return self::lookupProperty($a_id, 'description');
    }
    
    // begin-patch lok
    public static function translate($a_title_desc)
    {
