...
use ILIAS\MyStaff\ListStudyProgrammes\ilMStListStudyProgrammesTableGUI;

/**
 * Class ilMStListStudyProgrammesGUI
 *
 * @author            Martin Studer <ms@studer-raimann.ch>
 *
 * @ilCtrl_IsCalledBy ilMStListStudyProgrammesGUI: ilMyStaffGUI
 * @ilCtrl_Calls      ilMStListStudyProgrammesGUI: ilFormPropertyDispatchGUI
 */
class ilMStListStudyProgrammesGUI {
	...
	public function executeCommand() {
		...
		switch ($next_class) {
			case strtolower(ilFormPropertyDispatchGUI::class):
				...
				$this->table = new ilMStListStudyProgrammesTableGUI($this, self::CMD_INDEX);
	...
	public function applyFilter() {
		$this->table = new ilMStListStudyProgrammesTableGUI($this, self::CMD_APPLY_FILTER);
	...
	public function resetFilter() {
		$this->table = new ilMStListStudyProgrammesTableGUI($this, self::CMD_RESET_FILTER);
		$this->table->resetOffset();
