...
use ILIAS\MyStaff\ListCompetences\Profiles\ilMStListCompetencesProfilesTableGUI;

/**
 * Class ilMStListCompetencesProfilesGUI
 *
...
class ilMStListCompetencesProfilesGUI
{
    ...
    public function listUsers() {
        ...
        $this->table = new ilMStListCompetencesProfilesTableGUI($this, self::CMD_INDEX, $this->dic);
    ...
    public function applyFilter() {
        $this->table = new ilMStListCompetencesProfilesTableGUI($this, self::CMD_APPLY_FILTER, $this->dic);
    ...
    public function resetFilter() {
        $this->table = new ilMStListCompetencesProfilesTableGUI($this, self::CMD_RESET_FILTER, $this->dic);
        $this->table->resetOffset();
    ...
    protected function getActions()
    {
        ...
        $mst_co_usr_id = $DIC->http()->request()->getQueryParams()['mst_lprof_usr_id'];
