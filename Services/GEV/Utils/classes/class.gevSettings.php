...
class gevSettings {
	...
	const CRS_AMD_VC_LINK		= "crs_amd_webex_link";			// these are new general webinar links now
	const CRS_AMD_VC_PASSWORD	= "crs_amd_webex_password";		// these are new general webinar passwords now
	const CRS_AMD_VC_PASSWORD_TUTOR	= "crs_amd_webex_password_tutor";		// these are new general webinar tutor password
	const CRS_AMD_VC_CLASS_TYPE = "crs_amd_webex_vc_class_type"; // new type of the virtual class
	const CRS_AMD_VC_LOGIN_TUTOR = "crs_amd_webex_login_tutor"; // new type of the virtual class
