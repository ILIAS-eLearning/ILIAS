	...
	protected function getPlaceholders() {
		if ($this->placeholders == null) {
			$this->placeholders = array(
				...
				, array("Admin-Name"			, "Name des Trainingsadministrator")
				, array("Admin-Telefon"			, "Telefonnummer des Trainingsadministrators")
				, array("Admin-Email"			, "Emailadresse des Trainingsadministrators")
