	...
	protected function getPlaceholders() {
		if ($this->placeholders == null) {
			$this->placeholders = array(
				...
				, array("Webinar-Login-Tutor"		, "Am Training hinterlegtes Trainerlogin zum WebEx-Klassenraum")
				, array("Webinar-Passwort-Tutor"	, "Am Training hinterlegtes Trainerpasswort für den WebEx-Klassenraum")
