	...
	protected function getPlaceholders() {
		if ($this->placeholders == null) {
			$this->placeholders = array(
				...
				, array("WebEx-Link"				, "Am Training hinterlegter Weblink zum WebEx-Klassenraum")
				, array("WebEx-Passwort"			, "Am Training hinterlegter Weblink für den WebEx-Klassenraum")
