...
class gevFooterLinks {
	protected function footerLinks($user_id) {
		...
		return array(/*BiProgramm Agent*/		array("link" => "./Customizing/global/skin/genv/static/documents/"
					 ...
					 /*Infos Decentral*/ 		array("link" => "./static_pages.php?tpl=infpraesenz"
													 ,"desc" => "gev_footer_infos_decentral"
													 ,"display" => true
												),
					 /*Infors Webinar*/ 		array("link" => "./static_pages.php?tpl=infwebinar"
					 								 ,"desc" => "gev_footer_infos_webinar"
					 								 ,"display" => true
					 							),
					 /*AGB Agent*/ 				array("link" => "./Customizing/global/skin/genv/static/documents/"
					 ...
					 /*AGB*/					array("link" => "./static_pages.php?tpl=agb"
													 ,"desc" => "gev_footer_terms_of_use"
								 					 ,"display" => function() use ($uutils) {
																			if($uutils) {
																				if (!$uutils->hasRoleIn(array("VP"))) {
					 ...
					 /*Infos WBD registration*/ array("link" => "./static_pages.php?tpl=wbd_docs"
													 ,"desc" => "gev_footer_infos_wbd_registration"
								 					 ,"display" => true
												),
					 /*Contact*/				array("link" => "./static_pages.php?tpl=kontakt"
													 ,"desc" => "gev_footer_contact"
								 					 ,"display" => true
												),
					 /*Imprint*/				array("link" => "./static_pages.php?tpl=impressum"
													 ,"desc" => "gev_footer_imprint"
								 					 ,"display" => true
												),
					 /*Academy Benried*/		array("link" => "./static_pages.php?tpl=gszbernried"
