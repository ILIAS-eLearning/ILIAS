...
// BEGIN WebDAV: Support HTML authentication with LDAP
/** 
...
class ilAuthHTTPLDAP extends Auth_HTTP
{
	...
	public function ilAuthHTTPLDAP($options = '')
	{
		global $ilLog;
...
// END WebDAV: Support HTML authentication with LDAP
?>