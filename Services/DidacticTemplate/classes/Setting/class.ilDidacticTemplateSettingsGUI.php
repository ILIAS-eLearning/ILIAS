...
class ilDidacticTemplateSettingsGUI
{
    ...
    protected function setEditTabs(string $a_tab_active = "edit") : void
    {
        ...
        if (!$this->setting->isAutoGenerated()) {
            ...
            $this->tabs->addTab('import', $this->lng->txt('import'), $this->ctrl->getLinkTarget($this, 'showEditImportForm'));

            if (in_array($a_tab_active, array('edit', 'settings_trans'))) {
                $this->tabs->addSubTab('edit', $this->lng->txt('settings'), $this->ctrl->getLinkTarget($this, 'editTemplate'));
                $this->tabs->addSubTab('settings_trans', $this->lng->txt("obj_multilinguality"), $this->ctrl->getLinkTargetByClass(array( "ilmultilingualismgui"), 'listTranslations'));
