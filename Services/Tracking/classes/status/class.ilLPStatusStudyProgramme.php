...
class ilLPStatusStudyProgramme extends ilLPStatus
{
	...
	{
		die("ilLPStatusStudyProgramme::_getInProgress");
	...
	{		
		die("ilLPStatusStudyProgramme::_getCompleted");
		$status_info = ilLPStatusWrapper::_getStatusInfo($a_obj_id);
	...
	{		
		die("ilLPStatusStudyProgramme::_getStatusInfo");
		$status_info = array();
	...
	{
		die("ilLPStatusStudyProgramme::determineStatus");
	...
	{
		die("ilLPStatusStudyProgramme::_getObjectStatus");
		global $ilDB;
	...
	{
		die("ilLPStatusStudyProgramme::_setObjectStatus");
		global $ilDB;
