...
class ilAuthUtils
{
    ...
    public static function _getAuthModeOfUser($a_username, $a_password, $a_db_handler = '')
    {
        global $DIC;
    ...
    public static function _getAuthMode($a_auth_mode, $a_db_handler = '')
    {
        global $DIC;
    ...
    public static function _getAllAuthModes()
    {
        $modes = array(
            AUTH_LOCAL,
            AUTH_LDAP,
