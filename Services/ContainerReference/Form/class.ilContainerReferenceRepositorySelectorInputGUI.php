...
use ILIAS\ContainerReference\ilContainerReferenceRepositorySelectorExplorerGUI;

/**
 * @ilCtrl_IsCalledBy ilContainerReferenceRepositorySelectorInputGUI: ilFormPropertyDispatchGUI
 */
class ilContainerReferenceRepositorySelectorInputGUI extends ilExplorerSelectInputGUI
{
    ...
    public function __construct(
        ...
        $forwarder_class = (is_null($forwarder))
            ...
            : get_class($forwarder);
        $this->explorer_gui = new ilContainerReferenceRepositorySelectorExplorerGUI(
            [$forwarder_class, ilFormPropertyDispatchGUI::class, ilContainerReferenceRepositorySelectorInputGUI::class],
    ...
    public function getExplorerGUI(): ilContainerReferenceRepositorySelectorExplorerGUI
    {
        return $this->explorer_gui;
    }

    public function setExplorerGUI(\ILIAS\ContainerReference\ilContainerReferenceRepositorySelectorExplorerGUI $explorer): void
    {
