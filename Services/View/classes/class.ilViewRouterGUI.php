 ...
 * This service is used by views. It allows any plugin to get called by a http request without dependencies to a
        ...
        switch ($next_class) {
            default:
                ...
                if (is_file($class_file)) {
                    ...
                    ilUtil::sendFailure('View GUI-Class not found! ('.$next_class.')');
                }
                break;
        }
    }
