...
class ilLicenseOverviewTableGUI extends ilTable2GUI
{
     ...
     */
    public function __construct($a_parent_obj, $a_parent_cmd, $a_mode, ilObjectGUI $a_parent_gui)
    {
    ...
    protected function getItemHTML($item = array())
    {
        ...
        return $item_list_gui->getListItemHTML($item["ref_id"], $item["obj_id"], $item["title"], $item["description"]);
    }
