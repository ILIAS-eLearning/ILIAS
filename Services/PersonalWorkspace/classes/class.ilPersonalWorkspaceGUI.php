...
class ilPersonalWorkspaceGUI
{
    ...
    public function executeCommand() : void
    {
        ...
        if ($this->std_request->getNewType()) {
            ...
            if (strtolower($ilCtrl->getNextClass($this)) != strtolower("ilObj" . $class_name . "GUI")) { // PHP8-Review: Parameter #1 $str of function strtolower expects string, string|null given.
