...
class ilWebDAVMountInstructionsFactory {
    ...
    public function __construct(ilWebDAVMountInstructionsRepositoryImpl $a_repo,
    ...
    public function getMountInstructionsObject() : ilWebDAVBaseMountInstructions {
        ...
        {
            return new ilWebDAVObjectlessMountInstructions($this->repo,
                $uri_builder,
        ...
        {
            return new ilWebDAVObjectMountInstructions($this->repo,
                $uri_builder,
                new ilSetting('file_access'),
