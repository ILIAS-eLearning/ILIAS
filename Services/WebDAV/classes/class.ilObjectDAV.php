...
class ilObjectDAV
{
    ...
    */
     ...
     */
    public function isNullResource()
    {
     ...
     * Returns an output stream to the content.
         * @return Stream or null, if the content does not support streaming.
     */
    public function getContentOutputStream()
    {
        return null;
    }
    /**
     ...
     * @param Integer.
     */
    public function getContentOutputStreamLength()
    {
        // subclass responsibility
    }
    /**
    ...
    */
    public function isPermitted($operations, $type = '')
    {
     ...
     */
    public function getILIASFileType()
    {
        return 'file';
    }
    ...
    * @return	ilObjectDAV	returns the created object, or null if creation failed.
    */
    public function createFileFromNull($name, &$nullDAV)
    {
        global $DIC;
        $tree = $DIC['tree'];
    ...
    * @return	ilObjectDAV	returns the created object, or null if creation failed.
    */
    public function createNull($name)
    {
        global $DIC;
        $tree = $DIC['tree'];
    ...
    */
    public function addCopy(&$objDAV, $newName = null)
    {
    ...
    */
    public function addMove(&$objDAV, $newName = null)
    {
        global $DIC;
        $tree = $DIC['tree'];
        global $DIC;
    ...
    * @param    boolean
    */
    public function removeDeletedNodes($a_node_id, $a_checked, $a_delete_objects = true)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $log = $DIC['log'];
    ...
    * 				(only needed for 'create' operation'.
     ...
     * a collection..
     */
    public function childrenWithPermission($operations, $type  ='')
    {
