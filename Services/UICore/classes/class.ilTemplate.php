...
class ilTemplate extends HTML_Template_ITX
{
    ...
    */
    ...
    public $js_files = array(0 => "./Services/JavaScript/js/Basic.js");		// list of JS files that should be included
    public $js_files_vp = array("./Services/JavaScript/js/Basic.js" => true);	// version parameter flag
    public $js_files_batch = array("./Services/JavaScript/js/Basic.js" => 1);	// version parameter flag
    public $css_files = array();		// list of css files that should be included
    public $inline_css = array();
    public $admin_panel_commands = array();
    ...
    */
    ...
    public function hasMessage($a_type)
    {
    ...
    * @access	public
    */
    public function setContentType($a_content_type = "text/html")
    {
    ...
    public function fillPageFormAction()
    {
    ...
    */
    public function setContentStyleSheet($a_style)
    {
    ...
    * Fill Content Style
    */
    public function fillContentStyle()
    {
    ...
    * add ILIAS footer
    */
    public function addILIASFooter()
    {
        global $DIC;
    ...
    * @param	string
    */
    public function prepareForFormular($vars)
    {
        if (!is_array($vars)) {
            return;
        }
    ...
    * @return	boolean
    */
    public function checkTopic($a_block, $a_topic)
    {
    ...
    */
     ...
     */
    public function getTemplateIdentifier($a_tplname, $a_in_module = false)
    {
        global $DIC;
    ...
    public function setNewContentStyleSheetLocation($a_stylesheet)
    {
    ...
    */
     ...
     */
    public function setTitleColor($a_val)
    {
    ...
    */
    public function stopTitleFloating()
    {
    ...
    */
     ...
     * @return int ref id
     */
    public function getHeaderActionMenu()
    {
    ...
    */
    public function setMountWebfolderIcon($a_ref_id)
    {
    ...
    */
    public function setPageActions($a_page_actions_html)
    {
    ...
    * Show admin view button
    */
    public function setEditPageButton($a_link, $a_txt, $a_frame)
    {
    ...
    */
    public function addAdminPanelCommand($a_cmd, $a_txt, $a_arrow = false)
    {
    ...
    */
    public function fillAdminPanel()
    {
        global $DIC;
    ...
    */
    public function fillPermanentLink()
    {
    ...
    */
    ...
    public static function buildLoginTarget()
    {
        ...
        // personal workspace
        elseif ($_GET["wsp_id"] != "" && $_GET["wsp_id"] > 0) {
