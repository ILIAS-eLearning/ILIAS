...
class ilCtrl
{
    ...
    public $forward;			// forward array
    public $parent;			// parent array (reverse forward)
    public $save_parameter;	// save parameter array
    public $return;			// return commmands
    public $call_hist = array();	// calling history
    public $debug = array();
    public $calls = array();
    public $rtoken = false;
...
//			$mc_set = $ilDB->query("SELECT * FROM service_class WHERE LOWER(class) = ".
    ...
    */
     ...
     * @return	string		HTML
     */
    public function getHTML($a_gui_object)
    {
        $class = strtolower(get_class($a_gui_object));
...
//				$n_class = strtolower($mc_rec["class"]);
     ...
     */
    public function addLocation($a_title, $a_link, $a_target = "", $a_ref_id = 0)
    {
