 ...
 */
final class ilCtrlStructureReaderTest extends TestCase
{
    /**
    ...
    {
        $class_map = require __DIR__ . '/../../Data/Setup/ClassMaps/valid_class_map.php';
    ...
    {
        $class_map = require __DIR__ . '/../../Data/Setup/ClassMaps/invalid_class_map.php';
        $reader = new ilCtrlStructureReader(
            new ilCtrlArrayIterator($class_map),
            new ilCtrlStructureCidGenerator()
        );
    ...
    {
        $reader = new ilCtrlStructureReader(
            new ilCtrlDirectoryIterator(__DIR__ . '/../../Data/Setup/EmptyDirectory'),
            new ilCtrlStructureCidGenerator()
        );
