...
class ilPhantomJSRendererTest  extends PHPUnit_Framework_TestCase
{
	...
	public function testHeaderSettingsWithoutPageNumber()
	{
		...
		$this->assertSame('"{\"page_size\":\"A4\",\"zoom\":1,\"orientation\":\"Portrait\",\"margin\":\"1cm\",\"delay\":200,\"viewport\":\"\",\"header\":{\"text\":\"Hello\",\"height\":\"1cm\",\"show_pages\":false},\"footer\":null}"' ,  $transformer->invokeArgs($obj, array($config)));
	}
	...
	public function testFooterSettingsText()
	{
		...
		$this->assertSame('"{\"page_size\":\"A4\",\"zoom\":1,\"orientation\":\"Portrait\",\"margin\":\"1cm\",\"delay\":200,\"viewport\":\"\",\"header\":null,\"footer\":{\"text\":\"Hello\",\"height\":\"1cm\",\"show_pages\":true}}"' ,  $transformer->invokeArgs($obj, array($config)));
	}
	...
	public function testFooterSettingsTextWithoutPageNumber()
	{
		...
		$this->assertSame('"{\"page_size\":\"A4\",\"zoom\":1,\"orientation\":\"Portrait\",\"margin\":\"1cm\",\"delay\":200,\"viewport\":\"\",\"header\":null,\"footer\":{\"text\":\"Hello\",\"height\":\"1cm\",\"show_pages\":false}}"' ,  $transformer->invokeArgs($obj, array($config)));
	}
