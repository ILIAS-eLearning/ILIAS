...
class ilSettingsPermissionGUI
{
	 ...
	 */
	function setRoleRequiredPermissions($a_val)
	{
		if (is_array($a_val))
		{
			foreach ($a_val as $p)
	 ...
	 */
	function getRoleRequiredPermissions()
	{
	 ...
	 */
	function setRoleProhibitedPermissions($a_val)
	{
		if (is_array($a_val))
		{
			foreach ($a_val as $p)
	 ...
	 */
	function getRoleProhibitedPermissions()
	{
