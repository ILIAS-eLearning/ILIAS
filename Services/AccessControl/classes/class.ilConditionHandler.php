...
class ilConditionHandler
{
    ...
    * @static
    */
    public static function _getConditionsOfTrigger($a_trigger_obj_type, $a_trigger_id)
    {
        global $ilDB;
    ...
    */
     ...
     * @return
     */
    public static function preloadConditionsForTargetRecords($a_type, $a_obj_ids)
    {
        global $ilDB;
    ...
    */
    public static function _checkCondition($a_id, $a_usr_id = 0)
    {
    ...
    */
    ...
    public function checkCircle($a_ref_id, $a_obj_id)
    {
