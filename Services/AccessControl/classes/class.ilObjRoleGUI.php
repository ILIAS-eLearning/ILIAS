...
class ilObjRoleGUI extends ilObjectGUI
{
    ...
    */
    ...
    public function listDesktopItemsObject()
    {
        global $DIC;
    ...
    public function askDeleteDesktopItemObject()
    {
        global $DIC;
    ...
    public function deleteDesktopItemsObject()
    {
        global $DIC;
    ...
    public function selectDesktopItemObject()
    {
        global $DIC;
        ...
        $exp = new ilRoleDesktopItemSelector(
            $this->ctrl->getLinkTarget($this, 'selectDesktopItem'),
    ...
    public function assignDesktopItemObject()
    {
        global $DIC;
