...
abstract class ilPlugin
{
     ...
     */
    public function getIliasMinVersion()
    {
     ...
     */
    public function setDBVersion($a_dbversion)
    {
     ...
     * @param	int	$a_dbversion	DB Version
     */
    public function writeDBVersion($a_dbversion)
    {
        global $ilDB;
     ...
     * Get plugin directory
     */
    public static function _getDirectory($a_ctype, $a_cname, $a_slot_id, $a_pname)
    {
     ...
     */
    public static function getAvailableLangFiles($a_lang_directory)
    {
        $langs = array();
     ...
     */
    public static function hasConfigureClass($a_slot_dir, $a_name)
    {
     ...
     * @return
     */
    public static function getConfigureClassName($a_name)
    {
     ...
     */
    public static function getDBUpdateScriptName($a_ctype, $a_cname, $a_slot_name, $a_pname)
    {
     ...
     */
    public static function lookupTxt($a_mod_prefix, $a_pl_id, $a_lang_var)
    {
        global $lng;
     ...
     * @return bool
     */
    public static function langExitsById($pluginId, $langVar)
    {
        global $lng;
     ...
     * Get image path
     */
    public static function _getImagePath(
        $a_ctype,
        $a_cname,
        $a_slot_id,
        $a_pname,
     ...
     */
    public static function createPluginRecord($a_ctype, $a_cname, $a_slot_id, $a_pname)
    {
        global $ilDB;
     ...
     */
    public static function getPluginRecord($a_ctype, $a_cname, $a_slot_id, $a_pname)
    {
    ...
    private function __init()
    {
        ...
        // get id
        $this->setId($ilPluginAdmin->getId(
            $this->getComponentType(),
            $this->getComponentName(),
            $this->getSlotId(),
            $this->getPluginName()
        ...
        // get version
        $this->setVersion($ilPluginAdmin->getVersion(
            $this->getComponentType(),
            $this->getComponentName(),
            $this->getSlotId(),
            $this->getPluginName()
        ...
        $this->setIliasMinVersion($ilPluginAdmin->getIliasMinVersion(
            $this->getComponentType(),
            $this->getComponentName(),
            $this->getSlotId(),
            $this->getPluginName()
        ...
        $this->setIliasMaxVersion($ilPluginAdmin->getIliasMaxVersion(
            $this->getComponentType(),
            $this->getComponentName(),
            $this->getSlotId(),
            $this->getPluginName()
        ...
        // get slot object
        $this->setSlotObject(new ilPluginSlot(
            $this->getComponentType(),
            $this->getComponentName(),
            $this->getSlotId()
        ));
    ...
    public function update()
    {
        ...
        $ilCtrl->insertCtrlCalls(
            ...
            ilPlugin::getConfigureClassName($this->getPluginName()),
            $this->getPrefix()
        );
     ...
     * @return string[]
     */
    public static function lookupStoredData($a_ctype, $a_cname, $a_slot_id, $a_pname)
    {
        global $ilDB;
     ...
     * Lookup name for id
     */
    public static function lookupNameForId($a_ctype, $a_cname, $a_slot_id, $a_plugin_id)
    {
        global $ilDB;
     ...
     * Lookup id for name
     */
    public static function lookupIdForName($a_ctype, $a_cname, $a_slot_id, $a_plugin_name)
    {
        global $ilDB;
