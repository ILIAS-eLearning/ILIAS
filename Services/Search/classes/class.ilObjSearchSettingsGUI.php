...
class ilObjSearchSettingsGUI extends ilObjectGUI
{
    ...
    public function settingsObject() : bool
    {
    ...
    public function saveSettingsObject() : bool
    {
        ...
        $this->object->settings_obj->setHideAdvancedSearch((bool) $_POST['hide_adv_search']);
        $this->object->settings_obj->setAutoCompleteLength((int) $_POST['auto_complete_length']);
        $this->object->settings_obj->setDefaultOperator((int) $_POST['operator']);
        $this->object->settings_obj->enableLuceneItemFilter((bool) $_POST['if']);
    ...
    protected function updateSettingsObject() : bool
    {
        ...
        $settings->enableLuceneItemFilter((bool) $_POST['if']);
        $settings->setLuceneItemFilter((array) $_POST['filter']);

        $settings->setHideAdvancedSearch((bool) $_POST['hide_adv_search']);
        $settings->setAutoCompleteLength((int) $_POST['auto_complete_length']);
        $settings->showInactiveUser($_POST["inactive_user"]);
        $settings->showLimitedUser($_POST["limited_user"]);
        $settings->enableDateFilter((bool) ($_POST['cdate'] ?? false));
        $settings->enableLuceneUserSearch((bool) $_POST['user_search_enabled']);
        $settings->update();
    ...
    protected function initFormLuceneSettings() : bool
    {
