...
class ilSearch
{
    ...
    */
    ...
    public $lng;
    public $rbacsystem;
    public $user_id;				// INTEGER USED FOR SAVED RESULTS
    public $search_string;			// INPUT FROM SEARCH FORM
    public $parsed_str;			// PARSED INPUT
    public $combination;			// STRING 'and' or 'or'
    public $min_word_length = 3;	// Define minimum character length for queries
    public $search_for;			// OBJECT TYPE 'usr','grp','lm','dbk'
    public $search_in;				// STRING SEARCH IN 'content' OR 'meta'
    public $search_type;			// STRING 'new' or 'result'
    public $result;				// RESULT SET array['object_type']['counter']
    public $perform_update;		// UPDATE USER SEARCH HISTORY default is true SEE function setPerformUpdate()
    public $read_db_result;		// READ db result true/false

    public $allow_empty_search;		// ALLOW EMPTY SEARCH TERM use setEmtySearch(true | false) TO SET THIS VALUE DEFAULT (FALSE)
    /**
    * Constructor
    * @access	public
    */
    public function __construct($a_user_id = 0, $a_read = false)
    {
        global $DIC;
    ...
    // SET METHODS
    public function setSearchString($a_search_str)
    {
    ...
    public function setSearchFor($a_search_for)
    {
        $this->search_for = $a_search_for;
    }
    public function setSearchIn($a_search_in)
    {
        $this->search_in = $a_search_in;
    }
    public function setResult($a_result)
    {
    ...
    public function setPerformUpdate($a_value)
    {
        $this->perform_update = $a_value;
    }
    public function setEmptySearch($a_value)
    {
        $this->allow_empty_search = $a_value;
    }

    public function setMinWordLength($a_min_word_length)
    {
    ...
    public function getSearchInByType($a_type)
    {
    ...
    public function getResultByType($a_type)
    {
    ...
    public function __parseSearchString()
    {
    ...
    public function __updateDBResult()
    {
        global $DIC;
    ...
    public function __readDBResult()
    {
        global $DIC;
    ...
    public function __checkAccess($a_results, $a_type)
    {
        global $DIC;
    ...
    public function __validateResults()
    {
        global $DIC;
    ...
    public function __prepareWord($a_word)
    {
        $word = trim($a_word);
