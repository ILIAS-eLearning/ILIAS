...
class ilUserFilter
{
	...
	var $search_fields = array('login' => true,
							   'firstname' => true,
							   'lastname' => true);

	var $enabled_member_filter = false;
	var $possible_users = array();
	...
	function enableMemberFilter($a_status)
	{
		$this->enabled_member_filter = $a_status;
	}

	function setPossibleUsers($a_users)
	{
	...
	function storeQueryStrings($a_strings)
	{
		$_SESSION['search_usr_filter'] = $a_strings;
	}

	function getQueryString($a_field)
	{
	...
	*/
	...
	function memberFilter($a_usr_id,$entry_data)
	{
