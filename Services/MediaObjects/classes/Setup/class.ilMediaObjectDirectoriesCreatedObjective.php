...
class ilMediaObjectDirectoriesCreatedObjective implements Setup\Objective
{
    const MOBSDIR = 'mobs';
    ...
    {
        return "MediaObjects-directory is created";
    }
    ...
    protected function getDirectories(Setup\Environment $environment): array
    {
        ...
        $new_dir = $client_data_dir .'/' .self::MOBSDIR;
    ...
    public function achieve(Setup\Environment $environment) : Setup\Environment
    {
        ...
        if (! is_dir($new_dir)) {
            throw new Setup\UnachievableException("Could not create directory for MediaObjects");
        }
