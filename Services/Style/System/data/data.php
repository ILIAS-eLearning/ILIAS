<?php return array (
  ...
  array (
    ...
    array (
      ...
      1 => 'InterruptiveItemInterruptiveItem',
      2 => 'ModalRoundTripRoundtrip',
      3 => 'ModalLightboxLightbox',
      4 => 'LightboxImagePageLightboxImagePage',
      5 => 'LightboxTextPageLightboxTextPage',
    ),
    'less_variables' => 
    array (
    ),
...
Cells and its content are responsively adapted if the size of the screen is changed.',
  ...
  array (
    ...
    array (
      ...
      'composition' => 'Standard Panels consist of a title and a content section. The structure of this content might be varying from Standard Panel to Standard Panel. Standard Panels may contain Sub Panels.',
      'effect' => '',
      'rivals' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'composition' => 'Secondary Panels consist of content section and top section. The top section may contain a title, sortation and a dropdown. The content section may contain a Pagination view controller or a Section view controller.',
      'effect' => '',
      'rivals' => 
      array (
  ...
  'InterruptiveItemInterruptiveItem' => 
  array (
    'id' => 'InterruptiveItemInterruptiveItem',
  ...
  'LightboxImagePageLightboxImagePage' => 
  array (
    'id' => 'LightboxImagePageLightboxImagePage',
    ...
    'path' => 'LightboxImagePage',
  ),
  'LightboxTextPageLightboxTextPage' => 
  array (
    'id' => 'LightboxTextPageLightboxTextPage',
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Data Table lists structured data in a table view.',
      'composition' => 'The Data Table consists of a Table Title, Filter, Columns, Rows, Export, Paging, Commands on Multiple Rows, Multiple Sorting, Hide and Show Columns, Each column can be formatted using a formatter. For example with a formatter you can convert learning progress integer values to icons or you can convert an array of links to an actions menu. The default Export possibilities are CSV, XLSX, HTML and PDF',
      'effect' => 'The Data Table shows the data as requested by the user.',
      'rivals' => 
      array (
        'Presentation Table' => 'The Presentation Table lists some tabular data in a pleasant way. The user can get a quick overview over the records in the dataset, the Presentation Table only shows the most relevant fields of the records at first glance.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    array (
      ...
      'responsiveness' => 
      array (
        1 => 'The Data Table is responsive by using a small number of columns',
      ),
      'accessibility' => 
      array (
      ),
    ...
    'path' => 'src/UI/Component/Table/Data/Table',
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The main parts of a Page are the Metabar, the Mainbar providing main navigation, the logo, breadcrumbs and, of course, the pages\'s content. "Content" in this case is the part of the page that is not Mainbar, Metabar, Footer or Locator, but e.g. the Repository-Listing, an object\'s view or edit form, etc. The locator (in form of breadcrumbs) and the logo are optional.',
      'effect' => '',
      'rivals' => 
      array (
      ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Remove Glyph uses the glyphicon-plus-sign.',
  ...
  array (
    ...
    array (
      ...
      'effect' => 'Clicking this glyph will open a search dialog. Since the context for the Search Glyph primarily is the Metabar, the according search dialog will be opened as Tool in the Mainbar.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'context' => 
    array (
      0 => 'The Search Glyph appears in the Metabar.',
    ),
    'selector' => '',
    'feature_wiki_references ' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'effect' => 'When clicked, the user is provided with explanations or instructions for the usage of the current context. When used in the Metabar, the help is displayed as tool in the Sidebar.',
      'rivals' => 
      array (
      ),
    ),
