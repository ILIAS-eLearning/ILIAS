...
class ilSkinStyleContainer
{
    ...
    public function create(ilSystemStyleMessageStack $message_stack)
    {
        ...
        foreach ($this->getSkin()->getStyles() as $style) {
            $this->file_system->createResourceDirectory($this->getSystemStylesConf()->getDefaultImagesPath(),
                $this->getImagesSkinPath($style->getId()));
            $this->file_system->createResourceDirectory($this->getSystemStylesConf()->getDefaultSoundsPath(),
                $this->getSkinDirectory() . $style->getSoundDirectory());
            $this->file_system->createResourceDirectory($this->getSystemStylesConf()->getDefaultFontsPath(),
    ...
    public function updateStyle(string $style_id, ilSkinStyle $old_style)
    {
        ...
        if ($style->getImageDirectory() != $old_style->getImageDirectory()) {
            if (file_exists($this->getSkinDirectory() . $old_style->getImageDirectory())) {
                $this->file_system->changeResourceDirectory($this->getSkinDirectory(), $style->getImageDirectory(),
        ...
        if ($style->getFontDirectory() != $old_style->getFontDirectory()) {
            if (file_exists($this->getSkinDirectory() . $old_style->getFontDirectory())) {
                $this->file_system->changeResourceDirectory($this->getSkinDirectory(), $style->getFontDirectory(),
        ...
        if ($style->getSoundDirectory() != $old_style->getSoundDirectory()) {
            if (file_exists($this->getSkinDirectory() . $old_style->getSoundDirectory())) {
                $this->file_system->changeResourceDirectory($this->getSkinDirectory(), $style->getSoundDirectory(),
    ...
    public function deleteStyle(ilSkinStyle $style) : void
    {
        ...
        $this->file_system->removeResourceDirectory($this->getSkinDirectory(), $style->getImageDirectory(),
            count($this->resourcesStyleReferences($style->getImageDirectory())) > 0);
        $this->file_system->removeResourceDirectory($this->getSkinDirectory(), $style->getFontDirectory(),
            count($this->resourcesStyleReferences($style->getImageDirectory())) > 0);
        $this->file_system->removeResourceDirectory($this->getSkinDirectory(), $style->getSoundDirectory(),
            count($this->resourcesStyleReferences($style->getImageDirectory())) > 0);
