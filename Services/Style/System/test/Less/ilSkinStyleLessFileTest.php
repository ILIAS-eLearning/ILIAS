...
class ilSkinStyleLessFileTest extends ilSystemStyleBaseFSTest
{
    ...
    public function testGetRefAndCommentAsString() : void
    {
        ...
        $this->assertEquals("comment variable 11</br>Usage: variable13; variable21; ",
            $file->getRefAndCommentAsString("variable11", "Usage:"));
        $this->assertEquals("comment variable 12", $file->getRefAndCommentAsString("variable12", "Usage:"));
        $this->assertEquals("comment variable 13", $file->getRefAndCommentAsString("variable13", "Usage:"));

        $this->assertEquals("comment variable 21</br>Usage: variable23; ", $file->getRefAndCommentAsString("variable21", "Usage:"));
        $this->assertEquals("comment variable 22", $file->getRefAndCommentAsString("variable22", "Usage:"));
        $this->assertEquals("comment variable 23", $file->getRefAndCommentAsString("variable23", "Usage:"));
    }
