...
class ilObjUserFolderGUI extends ilObjectGUI
{
    ...
    */
    ...
    public function confirmaccessFreeObject()
    {
        global $DIC;
    ...
    public function confirmaccessRestrictObject()
    {
    ...
    public function getTabs()
    {
        ...
        if ($rbacsystem->checkAccess("write", $this->object->getRefId())) {
            $this->tabs_gui->addTarget(
                ...
                array('settings','generalSettings','listUserDefinedField','newAccountMail')
            );
    ...
    */
    ...
    public function usrExportX86Object()
    {
        $user_ids = $this->getActionUserIds();
        if (!$user_ids) {
            ilUtil::sendFailure($this->lng->txt('select_one'));
    ...
    public function usrExportCsvObject()
    {
        $user_ids = $this->getActionUserIds();
        if (!$user_ids) {
            ilUtil::sendFailure($this->lng->txt('select_one'));
    ...
    public function usrExportXmlObject()
    {
        $user_ids = $this->getActionUserIds();
        if (!$user_ids) {
            ilUtil::sendFailure($this->lng->txt('select_one'));
