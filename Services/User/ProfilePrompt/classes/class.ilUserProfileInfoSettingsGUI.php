...
class ilUserProfileInfoSettingsGUI
{
	...
	public function initForm()
	{
		...
		// ... only if incomplete
		$op1 = new ilRadioOption($lng->txt("user_prompt_incomplete"),
			ilProfilePromptSettings::MODE_INCOMPLETE_ONLY,$lng->txt("user_prompt_incomplete_info"));
		$radg->addOption($op1);

		// ... once after login
		$op2 = new ilRadioOption($lng->txt("user_prompt_once_after_login"),
			ilProfilePromptSettings::MODE_ONCE_AFTER_LOGIN,$lng->txt("user_prompt_once_after_login_info"));
		$radg->addOption($op2);
		...
		// ... repeatly
		$op3 = new ilRadioOption($lng->txt("user_prompt_repeat"),
			ilProfilePromptSettings::MODE_REPEAT,$lng->txt("user_prompt_repeat_info"));
		$radg->addOption($op3);
