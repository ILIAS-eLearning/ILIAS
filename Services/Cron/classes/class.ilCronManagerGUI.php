...
class ilCronManagerGUI
{
    ...
    public function initEditForm($a_job_id)
    {
        global $ilCtrl, $lng;
        ...
        if ($job->hasFlexibleSchedule()) {
            ...
            $min = new ilRadioOption(
                sprintf($lng->txt("cron_schedule_in_minutes"), "x"),
            ...
            $hr = new ilRadioOption(
                sprintf($lng->txt("cron_schedule_in_hours"), "x"),
            ...
            $dy = new ilRadioOption(
                sprintf($lng->txt("cron_schedule_in_days"), "x"),
    ...
    protected function confirm($a_action)
    {
        ...
        if (sizeof($jobs) == 1) {
            ...
            $cgui->setHeaderText(sprintf(
                $lng->txt("cron_action_" . $a_action . "_sure"),
                $title
            ));
