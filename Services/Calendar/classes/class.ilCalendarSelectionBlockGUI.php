...
class ilCalendarSelectionBlockGUI extends ilBlockGUI
{
	...
	*/
	function fillDataSection()
	{
		...
		$tpl->setVariable("SRC_ACTION", ilUtil::getImagePath("arrow_downright.png"));
