...
class ilCalendarWeekGUI extends ilCalendarViewGUI
{
    ...
    public function show() : void
    {
        ...
        $scheduler = new ilCalendarSchedule($this->seed, ilCalendarSchedule::TYPE_WEEK, $this->user_id, $this->disable_empty);
     ...
     * @return array hours
     */
    protected function parseHourInfo(array $daily_apps, ilDateTime $date, int $num_day, array $hours = null, int $morning_aggr = 0, int $evening_aggr = 0) : array
    {
        ...
        foreach ($hours as $num_hour => $hours_per_day) {
            ...
            foreach ($hours_per_day as $num_day => $hour) {
                ...
                if (!$hour['apps_num'] && !$this->no_add) {
                    ...
                    $new_app_url = $this->ctrl->getLinkTargetByClass('ilcalendarappointmentgui', 'add');
                    $this->tpl->setVariable("DAY_NEW_APP_LINK", $this->ui_renderer->render($this->ui_factory->symbol()->glyph()->add($new_app_url)));
