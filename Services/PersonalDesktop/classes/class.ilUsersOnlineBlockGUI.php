...
class ilUsersOnlineBlockGUI extends ilBlockGUI
{
    ...
    public static $block_type = "pdusers";
    ...
    */
    public function fillRow($a_set)
    {
        ...
        } elseif ($this->getCurrentDetailLevel() > 2) {
    ...
    */
    ...
    public function __showActiveChatsOfUser($a_usr_id)
    {
        return false;
    }
    
    public function __showChatInvitation($a_usr_id)
    {
        $rbacsystem = $this->rbacsystem;
        $ilUser = $this->user;
        $lng = $this->lng;
