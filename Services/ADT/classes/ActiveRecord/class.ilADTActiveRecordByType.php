...
class ilADTActiveRecordByType
{
	...
	{
		return array(
			"text" => array("Text", "Enum", "MultiEnum", "LongText", "Schedule"),
			"int" => array("Integer"),
			"float" => array("Float"),
			"date" => array("Date"),
	...
	public static function deleteByPrimary($a_table, array $a_primary, $a_type = null)
	{
		...
		else
		{
			...
			if($found)
			{
				...
				// This is a problem of the implementer!
				throw new Exception("In ilADTActiveRecordByType::deletePrimary: The type ".
									$a_type." was used, but not found in the tablesMap.");
			}
		}
	}	
