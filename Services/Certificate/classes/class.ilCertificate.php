...
class ilCertificate
{
    ...
    public function cloneCertificate($newObject)
    {
        ...
        if (@file_exists($xsl)) {
            ...
            if (@file_exists($bgimage)) {
                @copy($bgimage, $new_bgimage);
            }
            if (@file_exists($bgimagethumb)) {
                @copy($bgimagethumb, $new_bgimagethumb);
            }
        }
    ...
    */
    public function getFormFieldsFromFO()
    {
        ...
        if (((strcmp($pageheight, "29.7cm") == 0) || (strcmp($pageheight, "297mm") == 0)) && ((strcmp($pagewidth, "21cm") == 0) || (strcmp($pagewidth, "210mm") == 0))) {
            $pagesize = "a4";
        } elseif (((strcmp($pagewidth, "29.7cm") == 0) || (strcmp($pagewidth, "297mm") == 0)) && ((strcmp($pageheight, "21cm") == 0) || (strcmp($pageheight, "210mm") == 0))) {
            $pagesize = "a4landscape";
        } elseif (((strcmp($pageheight, "21cm") == 0) || (strcmp($pageheight, "210mm") == 0)) && ((strcmp($pagewidth, "14.8cm") == 0) || (strcmp($pagewidth, "148mm") == 0))) {
            $pagesize = "a5";
        ...
        } elseif (((strcmp($pageheight, "11in") == 0)) && ((strcmp($pagewidth, "8.5in") == 0))) {
            $pagesize = "letter";
        } elseif (((strcmp($pagewidth, "11in") == 0)) && ((strcmp($pageheight, "8.5in") == 0))) {
        ...
        } elseif (preg_match("/fo:region-body[^>]*margin\=\"([^\"]+)\"/", $xslfo, $matches)) {
            $marginbody = $matches[1];
            if (preg_match_all("/([^\s]+)/", $marginbody, $matches)) {
                $marginbody_top = $matches[1][0];
                $marginbody_right = $matches[1][1];
        ...
        foreach ($dirinfo as $file) {
            if (strcmp($file["type"], "file") == 0) {
                if (strpos($file["entry"], ".xml") !== false) {
                    $xmlfiles++;
                } elseif (strpos($file["entry"], ".zip") !== false) {
                } else {
                    $otherfiles++;
                }
            }
    ...
    */
     ...
     */
    public static function getCustomCertificateFields()
    {
