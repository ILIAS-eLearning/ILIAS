...
//    }
     ...
     */
    public function setParameterConstraint(string $name, bool $required = true, $maxLength = null, $messageTypes = null) : void
    {
        $name = trim($name);
        if (strlen($name) > 0) {
...
//    }
     ...
     */
    private function checkValue($value, $values, $reason) : bool
    {
