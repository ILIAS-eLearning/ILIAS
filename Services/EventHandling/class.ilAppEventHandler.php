...
*
* The location must be <component>/classes/class.il<comp_name>EventListener.php,
* e.g. ./Services/News/classes/class.ilNewsEventListener.php
*
* The class name must be il<comp_name>EventListener.
*
