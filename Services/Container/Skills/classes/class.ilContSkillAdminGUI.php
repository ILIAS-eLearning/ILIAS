...
class ilContSkillAdminGUI
{
	 ...
	 */
	function getPathString($a_skill_id, $a_tref_id = 0)
	{
	 ...
	 * @param
	 */
	function saveCompetenceAssignment()
	{
		$ctrl = $this->ctrl;
		$lng = $this->lng;
	 ...
	 */
	function deassignCompetencesConfirm()
	{
		$ctrl = $this->ctrl;
		$lng = $this->lng;
		$tpl = $this->tpl;
	...
	function listCompetences()
	{
		...
		$toolbar->addButton($lng->txt("cont_add_skill"),
	 ...
	 * Confirm
	 */
	function confirmRemoveSelectedSkill()
	{
		$lng = $this->lng;
		$ctrl = $this->ctrl;
		$tpl = $this->tpl;
