...
class ilContainerGUI extends ilObjectGUI implements ilDesktopItemHandling
{
    ...
    * show permanent link
    */
    public function showPermanentLink(&$tpl)
    {
        $GLOBALS["tpl"]->setPermanentLink(
            $this->object->getType(),
            $this->object->getRefId(),
            "",
            "_top"
    ...
    *
    */
    public function showCustomIconsEditing($a_input_colspan = 1, ilPropertyFormGUI $a_form = null, $a_as_section = true)
    {
        $ilSetting = $this->settings;
        if ($ilSetting->get("custom_icons")) {
            if ($a_form) {
