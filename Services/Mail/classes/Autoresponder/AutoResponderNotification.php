...
{
    /** @var ilMailOptions $sender_mail_options */
    private $sender_mail_options;
    /** @var DateTimeImmutable $next_auto_responder_datetime */
    private $next_auto_responder_datetime;
