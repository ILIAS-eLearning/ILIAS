...
abstract class ilMailNotification
{
    ...
    protected array $lang_modules = array();
    ...
    protected array $additional_info = array();
     ...
     * @return string
     */
    protected function createPermanentLink(array $a_params = array(), string $a_append = ''): ?string
    {
