il.Classification = {		
	...
	toggle: function(para) {
		...
		let args = {el_id: this.ajax_block_id, content_url: this.ajax_content_url, content_id: this.ajax_content_id};
	...
	toggleReload: function(html, args) {
	...
	toggleReloadRender: function(html, args) {
		if(html !== "")
		{
