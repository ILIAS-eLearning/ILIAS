...
class ilWACCheckingInstanceTest extends PHPUnit_Framework_TestCase {
	...
	public function tetDeliver() {
		...
		$image = vfs\vfsStream::newFile('data/trunk/mobs/mm_123/dummy.png')->at($this->root)->setContent($base64);
		...
		$this->assertEquals(0, $ilUser->getId());
