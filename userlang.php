...
$tpl->setVariable("LANG_OPTIONS",TUtil::formSelect($lng->userLang,"lang_key",$languages));
$tpl->parseCurrentBlock();

$tpl->setCurrentBlock("syslang");
$tpl->setVariable("TXT_CHANGE_LANG", $lng->txt("change_language"));
$tpl->setVariable("TXT_CHANGE_LANG2", $lng->txt("choose_language"));
$tpl->setVariable("SUBMIT", $lng->txt("submit"));
$tpl->setVariable("FORMACTION","adm_languages.php?cmd=setuserlang");
