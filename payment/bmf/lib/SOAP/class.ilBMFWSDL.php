...
class ilBMFWSDL extends ilBMFBase
{
     ...
     * @var string
     */
    var $wsdlParserClass = 'ilBMFWSDL_Parser';
     ...
     * @access public
     */
    function ilBMFWSDL($wsdl_uri    = false,
                       $proxy       = array(),
...
class ilBMFWSDL_Cache extends ilBMFBase
{
     ...
     * @access public
     */
    function ilBMFWSDL_Cache($cacheUse = WSDL_CACHE_USE,
                             $cacheMaxAge = WSDL_CACHE_MAX_AGE)
    {
