...
$ilLog = $log;
$DIC["ilLog"] = function ($c) {
    return $GLOBALS["ilLog"];
};
$DIC["ilLoggerFactory"] = function ($c) use ($loggerFactory) {
...
$DIC["ilCtrlStructureReader"] = function ($c) {
    return $GLOBALS["ilCtrlStructureReader"];
};

require_once "./Services/Utilities/classes/class.ilBenchmark.php";
$ilBench = new ilBenchmark();
$GLOBALS['ilBench'] = $ilBench;
$DIC["ilBench"] = function ($c) {
    return $GLOBALS["ilBench"];
};
...
$DIC["ilIliasIniFile"] = function ($c) {
    return $GLOBALS["ilIliasIniFile"];
};

$DIC["ilClientIniFile"] = function ($c) {
    return $GLOBALS["ilClientIniFile"];
};
