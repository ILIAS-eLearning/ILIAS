...
* *webservices* (type: object)
	...
	"webservices" : {
		...
		"soap_wsdl_path" : "https://test7.ilias.de/public/server.php?wsdl",
  ...
  * *soap_wsdl_path* (type: string) path to the ilias wsdl file, default is `http:///public/server.php?wsdl`
