...
`php setup/setup.php achieve ilUICoreSetupAgent::reloadCtrlStructure` to reload the
control structure. The agent might need to a config file to work, which may be added
as last parameter: `php setup/setup.php achieve ilUICoreSetupAgent::reloadCtrlStructure config.json`
