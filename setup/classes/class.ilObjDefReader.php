		...
		else
		{
			...
			switch ($a_name)
			{
				case 'object':
					...
					$ilDB->manipulateF("INSERT INTO il_object_def (id, class_name," . $ilDB->quoteIdentifier('component') . ",location,".
						"checkbox,inherit,translate,devmode,allow_link,allow_copy,rbac,default_pos,".
						"default_pres_pos,sideblock,grp," . $ilDB->quoteIdentifier('system') . "," . $ilDB->quoteIdentifier('export') . ",repository,workspace,administration,".
