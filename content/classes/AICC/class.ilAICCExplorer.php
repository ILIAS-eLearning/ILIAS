...
class ilAICCExplorer extends ilExplorer
{
...
/**
	...
	*/
	function formatObject($a_node_id,$a_option)
	{
		...
		$tpl = new ilTemplate("tpl.aicc_tree.html", true, true, true);
		...
		if ($this->isClickable($a_option["type"], $a_node_id))	// output link
		{
			...
			if ($frame_target != "")
			{
				...
				else
				{
					...
					$tpl->setVariable("ONCLICK", " onclick=\"parent.APIFRAME.setupApi();parent.APIFRAME.API.IliasLaunchAICC('".$a_node_id."');return false;\"");
				}
