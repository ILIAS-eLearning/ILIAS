        ...
        <xsl:for-each select="Bibliography/BibItem">
          <xsl:if test="position() = $target_id">
            <xsl:if test="count(Author) &gt; 0">
              <tr>
                <td class="option" colspan="2" align="left"><div align="left">Author(s)</div></td>
            ...
            <xsl:if test="count(CrossRef) &gt; 0">
              <tr>
                <td class="option" colspan="2" align="left"><div align="left">Cross reference</div></td>
            ...
            <xsl:if test="count(HowPublished) &gt; 0">
              <tr>
                <td class="option" colspan="2" align="left"><div align="left">How published</div></td>
                <td class="option_value"><xsl:call-template name="how_published" /></td>
              </tr>                
            </xsl:if>
            <xsl:if test="count(WherePublished) &gt; 0">
              <tr>
                <td class="option" colspan="2" align="left"><div align="left">Where published</div></td>
            ...
            <xsl:if test="count(Series) &gt; 0">
              ...
              <xsl:if test="count(Series/SeriesTitle) &gt; 0">
                <tr>
                  ...
                  <td class="sub_option"><div align="left">Series title</div></td>
              ...
              <xsl:if test="count(Series/SeriesEditor) &gt; 0">
                <tr>
                  ...
                  <td class="sub_option"><div align="left">Series editor</div></td>
              ...
              <xsl:if test="count(Series/SeriesVolume) &gt; 0">
                <tr>
                  ...
                  <td class="sub_option"><div align="left">Series volume</div></td>
