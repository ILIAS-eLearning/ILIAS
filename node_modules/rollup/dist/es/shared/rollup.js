...
class ChildScope extends Scope {
    ...
    addUsedOutsideNames(usedNames, format, exportNamesByVariable) {
    ...
    deconflict(format, exportNamesByVariable) {
...
function deconflictChunk(modules, dependencies, imports, usedNames, format, interop, preserveModules, chunkByModule, syntheticExports, exportNamesByVariable) {
    for (const module of modules) {
        module.scope.addUsedOutsideNames(usedNames, format, exportNamesByVariable);
    }
    deconflictTopLevelVariables(usedNames, modules);
    DECONFLICT_IMPORTED_VARIABLES_BY_FORMAT[format](usedNames, imports, dependencies, interop, preserveModules, chunkByModule, syntheticExports);
    for (const module of modules) {
        module.scope.deconflict(format, exportNamesByVariable);
    }
}
function deconflictImportsEsm(usedNames, imports, dependencies, interop, preserveModules, _chunkByModule, syntheticExports) {
...
function deconflictImportsOther(usedNames, imports, dependencies, interop, preserveModules, chunkByModule) {
    for (const chunkOrExternalModule of dependencies) {
        chunkOrExternalModule.variableName = getSafeName(chunkOrExternalModule.variableName, usedNames);
    }
    for (const variable of imports) {
...
class Chunk$1 {
        ...
        for (const dep of this.dependencies) {
            ...
            dependencies.set(dep, {
                ...
                globalName: (dep instanceof ExternalModule &&
                    ...
                    getGlobalName(dep, options.globals, exportsNames || exportsDefault, this.inputOptions.onwarn)),
                id: undefined,
    ...
    setIdentifierRenderResolutions(options) {
        ...
        deconflictChunk(this.orderedModules, this.dependencies, this.imports, usedNames, options.format, options.interop, this.outputOptions.preserveModules, this.chunkByModule, syntheticExports, this.exportNamesByVariable);
    }
...
var acornNumericSeparator = function(Parser) {
  const acorn = Parser.acorn || require$$0;
