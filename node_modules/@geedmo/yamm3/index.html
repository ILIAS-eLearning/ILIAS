  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapse-1">
          <ul class="nav navbar-nav">
            <!-- Classic list -->
            <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">List<b class="caret"></b></a>
            ...
            <!-- Accordion demo -->
            <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Accordion<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li>
                  <div class="yamm-content">
                    <div class="row">
            ...
            <!-- Classic dropdown -->
            <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Classic<b class="caret"></b></a>
            ...
            <!-- Pictures -->
            <li class="dropdown yamm-fw"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Pictures<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li>
                  <div class="yamm-content">
                    <div class="row">
                      <div class="col-xs-6 col-sm-2"><a class="thumbnail" href="#"><img alt="150x190" src="demo/img/190.jpg"></a></div>
                      <div class="col-xs-6 col-sm-2"><a class="thumbnail" href="#"><img alt="150x190" src="demo/img/190.jpg"></a></div>
                      <div class="col-xs-6 col-sm-2"><a class="thumbnail" href="#"><img alt="150x190" src="demo/img/190.jpg"></a></div>
                      <div class="col-xs-6 col-sm-2"><a class="thumbnail" href="#"><img alt="150x190" src="demo/img/190.jpg"></a></div>
                      <div class="col-xs-6 col-sm-2"><a class="thumbnail" href="#"><img alt="150x190" src="demo/img/190.jpg"></a></div>
    ...
    <div class="jumbotron intro">
      <div class="container">
        ...
        <p>This project is currently hosted on Github and is the sequel to Bootstrap2 Yamm <small><sup><a class="text-muted" href="http://geedmo.github.com/yamm" title="Yamm for Bootstrap 2" target="_blank"><em class="glyphicon glyphicon-new-window"></em></a></sup></small></p><br>
        <p><a class="btn btn-default btn-lg" href="https://github.com/geedmo/yamm3">View on Github</a> <a class="btn btn-primary btn-lg" href="https://github.com/geedmo/yamm3/archive/master.zip">Download</a></p>
      </div>
    </div>
    <div class="container">
      <div class="row">
...
<li>
<p>Reuse navbar markup and add class <code>.yamm</code> at the top.</p>
</li>
<li>
<p>Then add your markup into the <code>.dropdown-menu</code></p>
</li>
<li>
<p>Optionally use <code>.yamm-content</code> to wrap content with padding.</p>
</li>
</ol>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <div class="navbar navbar-default yamm">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#navbar-collapse-grid"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="#">Yamm Megamenu</a>
          </div>
          <div class="navbar-collapse collapse" id="navbar-collapse-grid">
            <ul class="nav navbar-nav">
              <!-- Grid 12 Menu -->
              <li class="dropdown yamm-fw"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Grid<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li class="grid-demo">
                    <div class="row">
              ...
              <!--With Offsets 
              -->
              <li class="dropdown yamm-fw"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Offset<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li class="grid-demo">
                    <div class="row">
              ...
              <!--Aside Menu 
              -->
              <li class="dropdown yamm-fw"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Aside<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li class="grid-demo">
                    <div class="row">
              ...
              <!--Nesting Menu 
              -->
              <li class="dropdown yamm-fw"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Nesting<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li class="grid-demo">
                    <div class="row">
...
&lt;/nav&gt;</pre>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <div class="navbar navbar-default yamm">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#navbar-collapse-2"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="#">Yamm Megamenu</a>
          </div>
          <div class="navbar-collapse collapse" id="navbar-collapse-2">
            <ul class="nav navbar-nav">
              <!-- Media Example -->
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Media<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                    <div class="yamm-content">
                      <ul class="media-list">
                        <li class="media"><a class="pull-right" href="#"><img class="media-object" src="demo/img/64x64.gif" alt="64x64"></a>
              ...
              <!-- Tables -->
              <li class="dropdown yamm-fullwidth"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Tables<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                    <div class="yamm-content">
              ...
              <!-- Thumbnails demo -->
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Thumbnails<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                    <div class="yamm-content">
                      <div class="row">
                        <div class="col-sm-4">
                          <div class="thumbnail"><img alt="260x130" src="demo/img/260.jpg">
                            <div class="caption">
                              ...
                              <p><a class="btn btn-primary" href="#">Action</a> <a class="btn btn-default" href="#">Action</a></p>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-4">
            ...
            <ul class="nav navbar-nav navbar-right">
              <!-- Forms -->
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Forms<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                    <div class="yamm-content">
                      <form action="send.php">
                        ...
                        <div class="form-group">
                          <input class="form-control" id="inputEmail" type="password" placeholder="Email">
                        </div>
                        <div class="form-group">
  ...
  e.stopPropagation()
      ...
      <footer>
        ...
        <div class="row">
          <div class="col-sm-4">
            <p>MIT &copy; Geedmo 2019</p>
          </div>
          <div class="col-sm-8">
            <div class="social">
              <ul class="list-inline text-right">
                <li>
                  <iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=geedmo&amp;repo=yamm3&amp;type=watch&amp;count=true" allowtransparency="true" frameborder="0" scrolling="0" width="100px" height="20px"></iframe>
                </li>
                <li>
                  <iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=geedmo&amp;repo=yamm3&amp;type=fork&amp;count=true" allowtransparency="true" frameborder="0" scrolling="0" width="98px" height="20px"></iframe>
                </li>
                <li><a class="twitter-share-button" href="https://twitter.com/share" data-lang="en">Tweet</a></li>
              </ul>
            </div>
          </div>
        </div>
