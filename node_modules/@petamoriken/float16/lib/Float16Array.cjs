...
function isFloat16Array(target) {
  return (0, _primordials.WeakMapPrototypeHas)(float16bitsArrays, target) || !(0, _primordials.ArrayBufferIsView)(target) && hasFloat16ArrayBrand(target);
}
...
function assertSpeciesTypedArray(target, count) {
  ...
  const isTargetTypedArray = (0, _is.isTypedArray)(target);
  ...
  if ((0, _is.isBigIntTypedArray)(target)) {
...
const TypedArrayPrototypeGetterKeys = new _primordials.NativeSet();
...
for (const key of (0, _primordials.ReflectOwnKeys)(_primordials.TypedArrayPrototype)) {
  ...
  if ((0, _primordials.ObjectHasOwn)(descriptor, "get")) {
    (0, _primordials.SetPrototypeAdd)(TypedArrayPrototypeGetterKeys, key);
  }
}
...
const handler = (0, _primordials.ObjectFreeze)({
  get(target, key, receiver) {
    ...
    if ((0, _primordials.SetPrototypeHas)(TypedArrayPrototypeGetterKeys, key) && (0, _primordials.ObjectPrototypeIsPrototypeOf)(_primordials.TypedArrayPrototype, target)) {
...
class Float16Array {
  constructor(input, _byteOffset, _length) {
    ...
    if (isFloat16Array(input)) {
      ...
      if ((0, _is.isTypedArray)(input)) {
        ...
        if ((0, _is.isBigIntTypedArray)(input)) {
          throw (0, _primordials.NativeTypeError)(_messages.CANNOT_MIX_BIGINT_AND_OTHER_TYPES);
        }
  ...
  static from(src, ...opts) {
    ...
    if (!(0, _primordials.ReflectHas)(Constructor, brand)) {
    ...
    if (Constructor === Float16Array) {
      ...
      return new Float16Array((0, _primordials.TypedArrayPrototypeGetBuffer)((0, _primordials.Uint16ArrayFrom)(src, function (val, ...args) {
        return (0, _converter.roundToFloat16Bits)((0, _primordials.ReflectApply)(mapFunc, this, [val, ...(0, _arrayIterator.toSafe)(args)]));
      }, thisArg)));
    }
    ...
    if (iterator != null) {
      if ((0, _is.isOrdinaryArray)(src)) {
        list = src;
        length = src.length;
      } else if ((0, _is.isOrdinaryTypedArray)(src)) {
        list = src;
  ...
  values() {
    assertFloat16Array(this);
    const float16bitsArray = getFloat16BitsArray(this);
    return (0, _arrayIterator.wrapGenerator)(function* () {
  ...
  fill(value, ...opts) {
    assertFloat16Array(this);
    const float16bitsArray = getFloat16BitsArray(this);
    (0, _primordials.TypedArrayPrototypeFill)(float16bitsArray, (0, _converter.roundToFloat16Bits)(value), ...(0, _arrayIterator.toSafe)(opts));
    return this;
  }
  ...
  copyWithin(target, start, ...opts) {
    assertFloat16Array(this);
    const float16bitsArray = getFloat16BitsArray(this);
    (0, _primordials.TypedArrayPrototypeCopyWithin)(float16bitsArray, target, start, ...(0, _arrayIterator.toSafe)(opts));
    return this;
  }
  ...
  slice(...opts) {
    ...
    if (Constructor === Float16Array) {
      const uint16 = new _primordials.NativeUint16Array((0, _primordials.TypedArrayPrototypeGetBuffer)(float16bitsArray), (0, _primordials.TypedArrayPrototypeGetByteOffset)(float16bitsArray), (0, _primordials.TypedArrayPrototypeGetLength)(float16bitsArray));
      return new Float16Array((0, _primordials.TypedArrayPrototypeGetBuffer)((0, _primordials.TypedArrayPrototypeSlice)(uint16, ...(0, _arrayIterator.toSafe)(opts))));
    }
  ...
  subarray(...opts) {
    ...
    const Constructor = (0, _spec.SpeciesConstructor)(float16bitsArray, Float16Array);
    const uint16 = new _primordials.NativeUint16Array((0, _primordials.TypedArrayPrototypeGetBuffer)(float16bitsArray), (0, _primordials.TypedArrayPrototypeGetByteOffset)(float16bitsArray), (0, _primordials.TypedArrayPrototypeGetLength)(float16bitsArray));
    const uint16Subarray = (0, _primordials.TypedArrayPrototypeSubarray)(uint16, ...(0, _arrayIterator.toSafe)(opts));
  ...
  join(...opts) {
    ...
    return (0, _primordials.ArrayPrototypeJoin)(array, ...(0, _arrayIterator.toSafe)(opts));
  }
  ...
  toLocaleString(...opts) {
    ...
    const float16bitsArray = getFloat16BitsArray(this);
    const array = copyToArray(float16bitsArray);
    return (0, _primordials.ArrayPrototypeToLocaleString)(array, ...(0, _arrayIterator.toSafe)(opts));
  }
...
(0, _primordials.ObjectDefineProperty)(Float16Array, brand, {});
