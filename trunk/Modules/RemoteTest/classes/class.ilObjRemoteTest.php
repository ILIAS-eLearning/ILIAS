...
{
	const DB_TABLE_NAME = "rtst_settings";
	...
	{		
		...
		$a_fields["availability_start"] = array("integer", $this->getStartingTime());
		$a_fields["availability_end"] = array("integer", $this->getEndingTime());			
	}
