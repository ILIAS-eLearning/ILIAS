...
*/
class assImagemapQuestionGUITest extends PHPUnit_Framework_TestCase
{
	...
	public function test_instantiateObject_shouldReturnInstance()
	{
		...
		$instance = new assImagemapQuestionGUI();

		$this->assertInstanceOf('assImagemapQuestionGUI', $instance);
	}
}
