...
if (!isset($_SERVER['PHP_AUTH_PW']) || !isset($_SERVER['PHP_AUTH_USER'])) {
    ...
    if ($_GET["user_id"] != "" && ilObjUser::_getFeedPass($_GET["user_id"]) != "" &&
       (md5($_SERVER['PHP_AUTH_PW']) == ilObjUser::_getFeedPass($_GET["user_id"]) &&
        ...
        include_once("./components/ILIAS/Feeds_/classes/class.ilUserFeedWriter.php");
        ...
        include_once("./components/ILIAS/Feeds_/classes/class.ilObjectFeedWriter.php");
        ...
        include_once("./components/ILIAS/Feeds_/classes/class.ilFeedItem.php");
        include_once("./components/ILIAS/Feeds_/classes/class.ilFeedWriter.php");
