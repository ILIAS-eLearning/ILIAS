...
class ilSoapExerciseAdministration extends ilSoapAdministration
{
     ...
     */
    public function addExercise($sid, $target_id, $exercise_xml)
    {
        $this->initAuth($sid);
        $this->initIlias();
     ...
     */
    public function updateExercise($sid, $ref_id, $exercise_xml)
    {
        $this->initAuth($sid);
        $this->initIlias();
    ...
    public function getExerciseXML($sid, $ref_id, $attachFileContentsMode)
    {
        $this->initAuth($sid);
        $this->initIlias();
